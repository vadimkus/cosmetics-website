...
export const SEO_LANDING_PAGES: SeoLandingPage[] = [
  ...
  },
  {
    ...
    featuredProducts: [
      ...
      { name: 'Skin Caring BB Cushion SPF 50+', href: '/products/41', image: '/images/cushion/main.jpeg', imageAlt: 'GENOSYS Skin Caring BB Cushion SPF 50+', description: 'Portable coverage for touch-ups and visible redness.' },
