...
/**
 * Gift write-off @ buyPrice — PDRN mask pack for Leo Beauty Club (Anastasiya).
 *
 *   54467 Skin Reboot PDRN mask Pack ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-leo-beauty-pdrn-gift-writeoff-20260701.js
 *   node --import dotenv/config scripts/moysklad-create-leo-beauty-pdrn-gift-writeoff-20260701.js --commit
 */
...
const MARKER = `LEO-BEAUTY-PDRN-GIFT-ANASTASIYA-${uaeToday()}`

const LINES = [['54467', 1, 'Skin Reboot PDRN mask Pack (30 sheets)']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Leo Beauty Club — PDRN pack gift write-off (Anastasiya)')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Promotional present — warehouse write-off at buyPrice.',
      '54467 Skin Reboot PDRN mask Pack x1 → Leo Beauty Club owner Anastasiya.',
    ].join(' | '),
