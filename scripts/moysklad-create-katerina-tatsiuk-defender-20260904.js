...
/**
 * Katerina Tatsiuk — paid retail repeat of INV 04525.
 *
 *   54461 Skin Defender Lip & Eye Makeup Remover 200ml ×1 @ 290
 *   Excellent Delivery Dubai ×1 @ 45
 *   Total: 335.00 AED paid
 *
 *   node --import dotenv/config scripts/moysklad-create-katerina-tatsiuk-defender-20260904.js
 *   node --import dotenv/config scripts/moysklad-create-katerina-tatsiuk-defender-20260904.js --commit
 */
...
const AGENT_ID = 'ef231c13-9410-11ee-0a80-111f00096678'
...
const CUSTOMER = {
  name: 'Katerina Tatsiuk',
  phone: '050 451 17 21',
  city: 'Dubai',
  street: 'Tiara Residence, Ruby, app 1204',
}

const ORDER = {
  name: `GENCardM${uaeShortDate()}KATT`,
  marker: `KATERINA-TATSIUK-DEFENDER-REPEAT-04525-${uaeToday()}`,
}

const PRODUCT_LINES = [['54461', 1, 290]]
...
async function exportInvoicePdf(invoiceId, invoiceName) {
  ...
  const out = path.join(ORDERS_DIR, `GENOSYS_Katerina_Tatsiuk_${safe}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Katerina Tatsiuk — Defender 200ml + delivery 45, paid')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      'Repeat of INV 04525. 54461 Defender x1 @290; delivery Dubai 45. Paid.',
