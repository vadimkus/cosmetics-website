# Lodyana Spa — Hair Stamp + Hair Solution SO (2026-08-23)
...
|------|---------|----:|----------:|-----:|
| 00141 | Hair Stamp for HairGen Booster (8pcs) | 1 | 230 | 230 |
| 00048 | HR³ Matrix Hair Solution Professional Box (8pcs) | 1 | 370 | 370 |
| 00090 | Delivery Abu Dhabi | 1 | 70 | 70 |
| | | | | **670** |

Amended 23 Aug: removed **00074** stamp 0.25mm @100; added **00048** Hair Solution box @ MoySklad оптовая 370.

Earlier: first posted Hair Stamp at stale CSV **370**, then amended to MoySklad оптовая **230**.

- SO id: `90bfd901-9eec-11f1-0a80-1eb700920c73`
- INV id: `3a0b1200-9f26-11f1-0a80-136000a0b084`
