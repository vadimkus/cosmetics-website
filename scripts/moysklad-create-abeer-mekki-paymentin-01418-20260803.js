...
/**
 * Abeer Mekki — paymentin for commissioner report 01418 (6,057 AED) + mark Paid.
 *
 *   node --import dotenv/config scripts/moysklad-create-abeer-mekki-paymentin-01418-20260803.js
 *   node --import dotenv/config scripts/moysklad-create-abeer-mekki-paymentin-01418-20260803.js --commit
 */
...
const CONTRACT_ID = 'a5ab62b9-f5d1-11f0-0a80-1085000693a6' // Agreement 31
const BANK_ACCOUNT_ID = 'e1852e1c-33c5-11ea-0a80-043f000b2739'
const REPORT_ID = '575c8bc4-8cd8-11f1-0a80-1158001a26b5'
const REPORT_NAME = '01418'
const EXPECTED_SUM_MINOR = 605700 // 6,057.00
const STATE_REPORT_PAID_ID = 'fd15289c-c3c4-11eb-0a80-065200268290'
const MARKER = `ABEER-MEKKI-CONSIGNMENT-PAYMENT-${REPORT_NAME}-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Abeer Mekki — paymentin @ consignment report 01418')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'ABEER MEKKI — July 2026 consignment sales (10% Al Ain) — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
