 ...
 *
 * CPIP-160626-081300 (DM GME 260616 shipment)
 *
 *   node --import dotenv/config scripts/moysklad-create-dm-import-fee-paymentout-20260616.js
 *   node --import dotenv/config scripts/moysklad-create-dm-import-fee-paymentout-20260616.js --commit
 */
...
const CPIP = 'CPIP-160626-081300'
const DESCRIPTION = `DM Import Fee 70 AED — ${CPIP}`
...
async function ensureNoDuplicate() {
  ...
  const byDesc = await api(
    'GET',
    `/entity/paymentout?search=${encodeURIComponent(CPIP)}&limit=5`
  )
