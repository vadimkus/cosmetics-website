...
/**
 * Miss Aryna Drabysheuskaya (0521175210) — retail order + invoice.
 *
 * Lines: Snow O₂ Cleanser 180ml (00021) ×1 @ 330 AED retail,
 *        Excellent Delivery Dubai ×1 @ 45 AED.
 *
 *   node --import dotenv/config scripts/moysklad-create-aryna-drabusheuskaya-order-invoice-20260521.js
 *   node --import dotenv/config scripts/moysklad-create-aryna-drabusheuskaya-order-invoice-20260521.js --commit
 */
...
const ORDER = {
  ...
  moment: uaeMomentNow(),
  marker: `Aryna Drabusheuskaya 0521175210 Snow O2 cleanser retail delivery ${uaeToday()}`,
}

const PRODUCT_LINES = [
  ['00021', 1, 330], // Snow O₂ Cleanser 180ml — genosys.ae retail
]
...
async function main() {
  console.log('====================================================================')
  console.log('  Aryna Drabusheuskaya — order + invoice')
  console.log('====================================================================')
  ...
  console.log()
  console.log(`    00021 Snow O₂ Cleanser 180ml x1 @ 330.00 AED`)
  console.log(`    Excellent Delivery Dubai x1 @ 45.00 AED`)
  ...
  const orderPayload = {
    name: ORDER.name,
    moment: ORDER.moment,
    description: [ORDER.marker, 'Retail Snow O2 cleanser 330 AED + Dubai delivery 45 AED'].join(' | '),
