...
/**
 * FaceFIT SALON L.L.C — paymentin @ shipment 06564 / invoice 04837.
 * Order GENCardM260718FFIT → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-facefit-paymentin-04837-20260718.js
 *   node --import dotenv/config scripts/moysklad-create-facefit-paymentin-04837-20260718.js --commit
 */
...
const MARKER = 'FACEFIT-PAYMENTIN-04837-2026-07-18'

const PAYMENT = {
  amountMinor: 129000,
  invoiceName: '04837',
  invoiceId: '9afb349e-82a2-11f1-0a80-1005003bfc54',
  shipmentName: '06564',
  shipmentId: '9be7e3bb-82a2-11f1-0a80-1408003d221d',
  orderName: 'GENCardM260718FFIT',
  orderId: '9a8d2c03-82a2-11f1-0a80-1408003d21fb',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  FaceFIT SALON — paymentin @ 04837 / 06564')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'FaceFIT salon — sea algae, collagen, blemish balm, snow booster, snow cleanser; delivery free.',
    ].join(' | '),
    operations: [
      {
        meta: {
