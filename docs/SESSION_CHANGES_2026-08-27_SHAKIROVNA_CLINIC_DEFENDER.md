...
| SHIP | **06750** |
| Total | **145.00 AED** |
| Address | One by Omniyat, Al Asayel Street - Business Bay, Dubai (Legal_TAX `addInfo` empty) |

| Code | Product | Qty | Clinic AED | Line |
|---|---|---:|---:|---:|
| 54461 | Skin Defender Lip & Eye Makeup Remover 200ml | 1 | 145 | 145 |
| 00089 | Delivery Dubai | 1 | 45 @ 100% | 0 |
| | | | **Total** | **145** |

Regular clinic sale — not on agreement **26**.

PDF: `~/Desktop/orders/GENOSYS_Shakirovna_Esthetic_Clinic_04982.pdf`
