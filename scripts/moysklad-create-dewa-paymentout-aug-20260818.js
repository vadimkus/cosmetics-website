...
/**
 * DEWA — August 2026 bill, paid 2026-08-18 00:38 UAE.
 * Amount: 2,044.78 AED | Acct 2049209886 | Txn NPIB00000000000011240330
 *
 *   node --import dotenv/config scripts/moysklad-create-dewa-paymentout-aug-20260818.js
 *   node --import dotenv/config scripts/moysklad-create-dewa-paymentout-aug-20260818.js --commit
 */
...
const SUM_MINOR = 204478 // 2,044.78 AED
const BILL_PERIOD = 'August 2026'
const TXN = 'NPIB00000000000011240330'
const PARTNER_TXN = '622920089860'
const ACCOUNT = '2049209886'
const MARKER = `DEWA-AUG-2026-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  DEWA — August 2026 bill (paymentout)')
  console.log('====================================================================')
  console.log(`  Mode : ${COMMIT ? 'COMMIT' : 'DRY RUN'}`)
  console.log(`  Sum  : ${money(SUM_MINOR)} AED`)
  console.log(`  Acct : ${ACCOUNT}`)
  console.log(`  Txn  : ${TXN}`)
  console.log(`  Partner: ${PARTNER_TXN}`)
  ...
  const created = await api('POST', '/entity/paymentout', {
    ...
    description: [
      ...
      `Paid 18 Aug 2026 00:38 | Acct ${ACCOUNT} | VADIM SAGATDINOV`,
      `Txn ${TXN} | Partner ${PARTNER_TXN}`,
      MARKER,
    ].join(' | '),
  })
