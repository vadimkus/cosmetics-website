...
/**
 * Sales bonus payout to Vadim Sagatdinov — 3,200.00 AED (July 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-3200-20260720.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-3200-20260720.js --commit
 */
...
const SUM_MINOR = 320000 // 3,200.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-JULY-3200-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (July 2026) — 3,200 AED')
  console.log('====================================================================')
