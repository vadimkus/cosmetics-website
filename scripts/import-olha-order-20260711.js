/**
 * Add a one-off paid order to the website DB for Olha Kravchuk
 * (oli.kravchuk95@gmail.com) as DELIVERED + PAID, and award GENOSYS Rewards
 * points (REWARDS track).
 *
 *   SKIN DEFENDER LIP & EYE MAKEUP REMOVER  290
 ...
 *
 * Dry-run:  node scripts/import-olha-order-20260711.js
 * Commit:   node scripts/import-olha-order-20260711.js --commit
 *
...
const EMAIL = 'oli.kravchuk95@gmail.com'
const ORDER_NUMBER = 'MSK-OLHA-110726'
const ORDER_DATE = new Date('2026-07-11T08:00:00.000Z')
...
const SHIPPING = 45
const LINES = [
  { productId: '11', name: 'Genosys Skin Defender Lip & Eye Makeup Remover', retail: 290, qty: 1 },
...
async function main() {
  ...
  const order = existing || await prisma.order.create({
    data: {
      ...
      customerPhone: user.phone || '+971556910355',
      customerEmirate: 'Dubai',
      customerAddress: user.address || 'Al Jaddaf, O Ten by Aqua Properties, 1004, Dubai',
