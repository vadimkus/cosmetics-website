...
/**
 * Sales bonus payout to Vadim Sagatdinov — 785.00 AED (August 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-785-20260817.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-785-20260817.js --commit
 */
...
const SUM_MINOR = 78500 // 785.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-AUG-78500-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (August 2026) — 785.00 AED')
  console.log('====================================================================')
