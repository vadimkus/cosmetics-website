...
/**
 * Push PWA blog post directly to database using Prisma
 * Run: node scripts/push-pwa-blog-post.js
 */
...
<div class="blog-post-content">
  ...
  <div class="image-section">
    <img src="/images/pwa/pwa-device-selection.png" alt="Установка GENOSYS PWA - Выбор устройства" style="max-width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);" />
  </div>
...
<div class="blog-post-content" dir="rtl">
  ...
  <div class="image-section">
    <img src="/images/pwa/pwa-device-selection.png" alt="تثبيت GENOSYS PWA - اختيار الجهاز" style="max-width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);" />
  </div>
  ...
  published: true,
  tags: JSON.stringify(["pwa", "app", "installation", "mobile", "ios", "android", "progressive-web-app", "how-to"])
}

async function createBlogPost() {
  try {
    console.log('🚀 Creating PWA blog post directly in database...')
    ...
    if (existing) {
      ...
      console.log('')
      console.log('To update instead, delete the existing post first.')
      return
    }
    ...
    if (error.code === 'P2002') {
      console.log('💡 A post with this slug already exists')
    }
  } finally {
