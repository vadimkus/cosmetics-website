 ...
 *   00035 Intensive Problem Control Cream 50g ×1 @ 145
 *   Delivery Dubai ×1 @ 45, 100% off
 *   Total: 310.00 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-snow-pc-cream-20260901.js
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-snow-pc-cream-20260901.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}SHKSPC`,
  marker: `ADMIN-SHAKIROVNA-SNOW-PC-CREAM-${uaeToday()}`,
}
...
const EXPECTED_SUM_MINOR = 31000
...
async function main() {
  console.log('====================================================================')
  console.log('  Admin Shakirovna — Snow O2 180 + PC Cream 50g, delivery free')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00021 Snow O2 180ml x1 @165; 00035 PC Cream 50g x1 @145; delivery free. Clinic list. Unpaid.',
