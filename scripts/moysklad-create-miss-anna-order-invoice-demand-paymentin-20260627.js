...
/**
 * Miss Anna (existing) — full retail cycle:
 *   order → invoice → shipment → paymentin → invoice PDF
 *
 * Same items as 2026-06-13 order:
 *   Beige BB cushion (00144) ×1 @ 300 AED retail
 *   Excellent Delivery Dubai ×1 @ 45 AED
 *
 * Counterparty: 98a6f84e-46ea-11f1-0a80-03cb00049ccc
 * Phone updated to +971505051583 (per latest invoice screenshot 2026-06-27).
 * Address unchanged: Al Qusais industrial area 5, BlueDiamond building 704, Dubai.
 *
 *   node --import dotenv/config scripts/moysklad-create-miss-anna-order-invoice-demand-paymentin-20260627.js
 *   node --import dotenv/config scripts/moysklad-create-miss-anna-order-invoice-demand-paymentin-20260627.js --commit
 */
...
const AGENT_ID = '98a6f84e-46ea-11f1-0a80-03cb00049ccc' // Miss Anna
...
async function loadAndUpdateCounterparty() {
  ...
  if (!COMMIT) {
    console.log('  DRY RUN: would update counterparty phone')
    return agent
  }
  ...
  console.log('  Counterparty phone updated.')
  return updated
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Anna — SO → invoice → shipment → paymentin')
  console.log('====================================================================')
