...
/**
 * Tatiana Aniskina — paymentin for commissioner report 01420 (185 AED) + mark Paid.
 *
 *   node --import dotenv/config scripts/moysklad-create-tatiana-aniskina-paymentin-01420-20260802.js
 *   node --import dotenv/config scripts/moysklad-create-tatiana-aniskina-paymentin-01420-20260802.js --commit
 */
...
const REPORT_ID = '30f9a899-8dbb-11f1-0a80-1158003fae04'
const REPORT_NAME = '01420'
...
async function main() {
  console.log('====================================================================')
  console.log('  Tatiana Aniskina — paymentin @ report 01420')
  console.log('====================================================================')
  ...
  if (report.name !== REPORT_NAME) throw new Error(`Unexpected report name ${report.name}`)
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Tatiana Aniskina Nail Master — Eye Contour Cream 00055 — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
