...
/**
 * Warehouse write-off @ buyPrice — Snow O₂ cleanser 180ml + Microbiome mist.
 *
 *   00021 Snow O₂ Cleanser 180ml ×1
 *   00188 Microbiome Energy Infusing Mist 80ml ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-inventory-writeoff-cleanser-mist-20260630.js
...
const MARKER = `INVENTORY-WRITE-OFF-CLEANSER-MIST-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Inventory write-off — cleanser 180ml + mist')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'Snow O₂ Cleanser 180ml 00021 x1, Microbiome Energy Infusing Mist 80ml 00188 x1.',
    ].join(' | '),
