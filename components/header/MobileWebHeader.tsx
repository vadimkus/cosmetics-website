            ...
            <nav className="p-4">
              <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                ...
                <a
                  ...
                  className={`col-span-2 flex items-center gap-2.5 py-2.5 px-3 my-1 bg-gray-900 text-white rounded-xl transition-colors active:bg-gray-800 ${isRTL ? 'flex-row-reverse' : ''}`}
                  onClick={() => setShowMobileMenu(false)}
                >
