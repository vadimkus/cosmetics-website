/**
 * Update only product 58's main image while preserving its existing gallery
 * string byte-for-byte. Also repoint historical order and blog references.
 *
 * Dry run:
 *   npx tsx --env-file=.env.local scripts/update-product-58-main-image.ts
 * Apply:
 *   npx tsx --env-file=.env.local scripts/update-product-58-main-image.ts --apply
 */
/* eslint-disable no-console */
import { prisma } from '../lib/prisma'

const PRODUCT_NUMBER = '58'
const OLD_MAIN = '/images/beauty_boxes/Anti_aging_box.jpeg'
const NEW_MAIN = '/images/bbox_age/main.jpg'
