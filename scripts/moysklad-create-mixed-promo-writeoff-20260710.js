...
/**
 * Warehouse write-off @ buyPrice (2026-07-10):
 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-mixed-promo-writeoff-20260710.js
 *   node --import dotenv/config scripts/moysklad-create-mixed-promo-writeoff-20260710.js --commit
 */
...
const MARKER = `MIXED-PROMO-WRITE-OFF-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Warehouse write-off — hydrocool, PDRN 5000, post cream, peptide')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00013 hydrocool mask 1kg x1, 54475 PDRN homecare 5000 x1, 54465 post cream 100g x1, 00012 peptide mask x10.',
    ].join(' | '),
