        ...
        <div className="space-y-3 md:space-y-0 md:grid md:grid-cols-3 md:gap-8 mb-4 md:mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-3 md:p-6">
            ...
            <div className="space-y-0.5 md:space-y-2 text-gray-600 text-xs md:text-base">
              ...
              <div><span className="font-semibold text-gray-800">{locale === 'ru' ? 'TDRA NOC:' : locale === 'ar' ? 'شهادة TDRA:' : 'TDRA NOC:'}</span> <PDFLinkButton href="/documents/TDRA_NOC.pdf" filename="GENOSYS-TDRA-NOC.pdf" download="GENOSYS-TDRA-NOC.pdf" className="text-primary-600 hover:text-primary-700 underline">{locale === 'ru' ? 'Сертификат' : locale === 'ar' ? 'الشهادة' : 'Certificate'}</PDFLinkButton></div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-3 md:p-6">
            ...
            <div className="space-y-0.5 md:space-y-2 text-gray-600 text-xs md:text-base">
              ...
              <div><span className="font-semibold text-gray-800">{t('about.certification')}:</span> {t('about.dubaiMunicipality')}</div>
