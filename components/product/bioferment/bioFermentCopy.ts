...
const AR: BioFermentCopy = {
  ...
  subheadline:
    'قناع نمذجة احترافي يخلط بالماء مباشرة قبل التطبيق. ثلاث مغارف من البودرة، أربع مغارف ونصف من الماء، ومدة تطبيق من ١٥ إلى ٢٠ دقيقة.',
  heroBullets: [
  ...
  stats: [
    { value: '٤٠ غ', label: 'كمية البودرة لكل جلسة كاملة' },
  ...
  proof: {
    eyebrow: 'حدود الدليل',
    title: 'الأرقام التسويقية ليست تقريراً سريرياً.',
    intro:
      'يعرض الملف التسويقي أرقاماً للترطيب وحالات للتبريد، لكن تقرير الدراسة الكامل غير متاح ولا يحدد طريقة القياس أو توقيته أو حجم العينة أو المقارنة.',
    chartTitle: 'بيانات غير منشورة للبيع',
    beforeLabel: 'قبل',
    afterLabel: 'بعد',
    headline: { value: '—', label: 'لا ننشر نسبة ترطيب من دون تعريف نقطة القياس والبسط والمقام' },
    cooling: { value: '—', label: 'لا ننشر مقدار تبريد مستنداً إلى حالات مصورة فقط' },
    attribution: 'المصدر المتاح عرض تسويقي من DTS MG، وليس تقرير دراسة كامل.',
    note:
      'لذلك تعتمد صفحة العربية على المقادير وتعليمات الاستخدام والصيغة الكمية والاختبار الجلدي المطبوع على العبوة فقط.',
  },
  howTo: {
...
const RU: BioFermentCopy = {
  ...
  subheadline:
    'Профессиональная моделирующая маска, которую смешивают непосредственно перед нанесением: три мерные ложки пудры, четыре с половиной ложки воды и 15–20 минут.',
  heroBullets: [
  ...
  stats: [
    { value: '40 г', label: 'Количество пудры на полную процедуру' },
  ...
  proof: {
    ...
    title: 'Маркетинговые цифры — ещё не клинический отчёт.',
    intro:
      'В презентации приведены показатели увлажнения и отдельные примеры охлаждения, но полного отчёта с методом, временем измерения, выборкой и сравнением в архиве нет.',
    chartTitle: 'Данные не используются в продаже',
    beforeLabel: 'До',
    afterLabel: 'После',
    headline: { value: '—', label: 'Не публикуем процент без определения показателя и способа расчёта' },
    cooling: { value: '—', label: 'Не публикуем величину охлаждения по двум иллюстративным примерам' },
    attribution: 'Доступный источник — маркетинговая презентация DTS MG, а не полный отчёт исследования.',
    note:
      'Поэтому русская страница опирается только на подтверждённые дозировки, инструкцию, количественную формулу и маркировку дерматологического тестирования.',
  },
  howTo: {
