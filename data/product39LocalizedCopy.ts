...
export const PRODUCT_39_AR_DESCRIPTION =
  'واقي شمس كوري (sun cream) يومي للإمارات بحماية SPF 50+ PA++++، خفيف على البشرة في حر دبي. حماية واسعة الطيف موثقة: بلغ عامل الحماية SPF المقاس على البشرة 65.9، وسجل عامل الحماية من UVA نتيجتي 23.13 و24.3. تحمل العبوة تصنيف SPF 50+ PA++++. تشكل ستة مرشحات للأشعة فوق البنفسجية 17.10% من التركيبة، ويكملها النياسيناميد 2% والأدينوزين 0.04%. لا تحتوي التركيبة على الأوكسي بنزون أو الأوكتينوكسات، ولا تدّعي مقاومة الماء. 50 غ.'
