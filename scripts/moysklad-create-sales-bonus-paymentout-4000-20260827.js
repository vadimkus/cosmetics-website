...
/**
 * Sales bonus payout to Vadim Sagatdinov — 4,000.00 AED (27 Aug 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-4000-20260827.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-4000-20260827.js --commit
 */
...
const SUM_MINOR = 400000
const MARKER = `SALES-BONUS-SAGATDINOV-400000-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov — 4,000.00 AED')
  console.log('====================================================================')
