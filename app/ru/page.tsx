...
export const metadata: Metadata = {
  ...
  description: 'Официальный дистрибьютор профессиональной корейской дерматокосметики GENOSYS в ОАЭ. Роллеры для микронидлинга, профессиональные средства для ухода и домашние протоколы. Бесплатная доставка при заказе свыше 1000 дирхамов. Дубай, Абу-Даби, Шарджа.',
  keywords: [
    'GENOSYS ОАЭ',
    'Корейская дерматокосметика Дубай',
    'Профессиональный уход за кожей ОАЭ',
    'Роллеры для микронидлинга Дубай',
    ...
    'Косметологические средства ОАЭ',
  ...
  openGraph: {
    title: 'GENOSYS | Официальный дистрибьютор корейской дерматокосметики в ОАЭ',
    description: 'Официальный дистрибьютор профессиональной корейской дерматокосметики GENOSYS в ОАЭ. Роллеры для микронидлинга, профессиональные средства для ухода и домашние протоколы. Бесплатная доставка при заказе свыше 1000 дирхамов.',
    type: 'website',
