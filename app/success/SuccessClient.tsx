                ...
                {(() => {
                  ...
                  return (
                    <div className="space-y-2 text-sm">
                      ...
                      {hasLoyaltyDiscount && (
                        <div className={`flex justify-between text-blue-600 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                          <span>
                            ★ GENOSYS Rewards ({orderData.loyaltyPointsRedeemed.toLocaleString()} {t('rewards.points')})
                          </span>
                          <span>-{orderData.loyaltyDiscountAmount.toFixed(2)} AED</span>
                        </div>
                      )}
                      <div className={`flex justify-between ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
