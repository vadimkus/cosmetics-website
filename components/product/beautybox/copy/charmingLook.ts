...
const AR: BeautyBoxCopy = {
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        productNumber: '41',
        quantity: 1,
        step: 'الخطوة 3 - تغطية وحماية وعلاج',
        body:
          'تغطية وحماية من الشمس وعناية بالبشرة في ضغطة واحدة من الإسفنجة، وكوريا ترخّصه للثلاثة معاً كمستحضر ثلاثي الوظيفة. خمسة فلاتر ترفعه إلى ⁦SPF50+ PA++++⁩، ونياسيناميد 2% وأدينوزين 0.04% يتوليان التفتيح والعمل على التجاعيد، وتحتهما تسعة ببتيدات وغلوتاثيون وحمض بولي غلوتاميك. بدرجات Ivory أو Beige أو Camel، وعبوة التعبئة الثانية موجودة في الصندوق أصلاً.',
    ...
    cards: [
      {
        ...
        body:
          'ثاني أكسيد التيتانيوم 9%، إيثيل هكسيل ميثوكسي سينامات 7%، إيثيل هكسيل ساليسيلات 4.5%، أوكتوكريلين وأكسيد الزنك 2% لكلٍّ منهما. ربع التركيبة فلاتر شمسية، ولهذا تستطيع خطوة مكياج أن تحمل ترخيصاً للحماية من الأشعة.',
      },
      {
        value: '2%',
  ...
  suited: {
    ...
    forList: [
      ...
      'كان الاحمرار أو الحبوب أو تفاوت اللون هو ما تريدين تغطيته ومعالجته في الوقت نفسه',
  ...
  details: {
    ...
    rows: [
      ...
      { label: 'نوع البشرة', value: 'كل أنواع البشرة. الكوشن مُعدّ للاستخدام بعد الجلسات الاحترافية، فيناسب البشرة السريعة الاحمرار' },
...
const RU: BeautyBoxCopy = {
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          'Покрытие, защита от солнца и уход за кожей в одно нажатие спонжа — и Корея лицензирует его сразу по всем трём как средство тройного действия. Пять фильтров дают SPF50+ PA++++, ниацинамид 2% и аденозин 0,04% отвечают за тон и за морщины, а под ними девять пептидов, глутатион и полиглутаминовая кислота. Оттенки Ivory, Beige и Camel, а второй рефилл 15 г уже лежит в коробке.',
    ...
    cards: [
      {
        ...
        body:
          'Диоксид титана 9%, этилгексилметоксициннамат 7%, этилгексилсалицилат 4,5%, октокрилен и оксид цинка по 2%. Четверть формулы — солнечные фильтры, поэтому шаг макияжа и может нести регистрацию защиты от УФ.',
      },
      {
        value: '2%',
  ...
  suited: {
    ...
    forList: [
      ...
      'Покраснения, высыпания или неровный тон — это то, что нужно закрыть и одновременно поработать с этим',
  ...
  details: {
    ...
    rows: [
      ...
      { label: 'Тип кожи', value: 'Все типы. Кушон создан для использования после процедур, поэтому подходит легко краснеющей коже' },
...
export const CHARMING_LOOK_COPY: BeautyBoxLocaleCopy = { en: EN, ar: AR, ru: RU }
