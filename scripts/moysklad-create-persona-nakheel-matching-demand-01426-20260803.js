...
/**
 * Persona Nakheel Mall — matching demand into agreement 00078 for sales report 01426.
 * Same lines / 3,585 AED. Stock note PDF → ~/Desktop/orders/
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-nakheel-matching-demand-01426-20260803.js
 *   node --import dotenv/config scripts/moysklad-create-persona-nakheel-matching-demand-01426-20260803.js --commit
 */
...
const MARKER = `Persona Nakheel Mall matching replenishment for 01426 ${uaeToday()}`
const EXPECTED_SUM_MINOR = 358500

/** Same as sales report 01426 */
const LINES = [
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Nakheel Mall — matching demand for report 01426')
  console.log('====================================================================')
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      'Matching replenishment for consignment sales report 01426 — same lines.',
