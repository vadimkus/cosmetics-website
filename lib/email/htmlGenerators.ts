 ...
 * Functions that generate order-related HTML emails (COD, Stripe)
 */
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          <tr>
            ...
            <td style="vertical-align: top;">
              ...
              ${badges.length > 0
                ? `<div style="margin-top: 4px; text-align: ${textAlign};">${badges.join('')}</div>`
                : totalDiscountPct > 0
              ...
              ${(() => {
                ...
                <td style="padding-top: 24px;">
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', Roboto, sans-serif;">
                    ...
                    <tr>
                      <td style="padding: 8px 0; font-size: 15px; color: #0071e3; font-weight: 500; text-align: ${textAlign};">★ GENOSYS Rewards (${(order.loyaltyPointsRedeemed || 0).toLocaleString('en-US')} pts)</td>
