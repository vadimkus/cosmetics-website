...
export const PRODUCT_QUICK_FACTS_CATALOG: Record<string, LocalizedQuickFact[]> = {
  ...
  '31': [
    t('Niacinamide measured at 2.04%', 'The finished cream confirms the 2% active at its intended concentration.', 'Ниацинамид · измерено 2,04%', 'Готовый крем подтверждает заявленную рабочую концентрацию 2%.', 'نياسيناميد · المحتوى المقاس 2.04%', 'يؤكد قياس الكريم النهائي وجود المكوّن بالتركيز الفعال المحدد 2%.'),
    t('Macadamia oil 13%', 'The second ingredient after water gives the cream its rich, softening texture.', 'Масло макадамии · 13%', 'Второй ингредиент после воды создаёт насыщенную смягчающую текстуру.', 'زيت المكاداميا · 13%', 'المكوّن الثاني بعد الماء يمنح الكريم قوامه الغني والملطف.'),
    t('−29.742% / 2 weeks', 'Skin surface melanin changed from 3.443 to 2.419 in the two-week evaluation.', '−29,742% за две недели', 'Показатель поверхностного меланина снизился с 3,443 до 2,419.', '−29.742% خلال أسبوعين', 'انخفض مؤشر الميلانين السطحي من 3.443 إلى 2.419.'),
    t('Orange from astaxanthin', 'No artificial colour added; the shade may shift slightly after contact with air.', 'Оранжевый оттенок от астаксантина', 'Искусственный краситель не добавлен; от воздуха оттенок может немного измениться.', 'لون برتقالي من الأستازانتين', 'من دون صبغة صناعية؛ وقد يتغير اللون قليلاً عند التعرض للهواء.'),
    t('95% noticed more even tone', 'The result comes from a satisfaction panel of 21 women aged 20 to 59.', '95% отметили более ровный тон', 'Результат опроса 21 участницы в возрасте от 20 до 59 лет.', '95% لاحظن لوناً أكثر تجانساً', 'نتيجة استبيان شمل 21 مشاركة بين 20 و59 عاماً.'),
    t('50g and 230g', 'Home and professional tubes with the same formula.', '50 г и 230 г', 'Домашний и профессиональный форматы с одной формулой.', '50 غ و230 غ', 'حجمان منزلي ومهني بالتركيبة نفسها.'),
  ],
  '32': [
  ...
  '25': [
    t('Post-treatment comfort', 'Leave-on cream for intact skin after professional procedures.', 'Комфорт после процедур', 'Несмываемый крем для целой кожи после профессиональных процедур.', 'راحة بعد الإجراءات', 'كريم يُترك على البشرة السليمة بعد الإجراءات الاحترافية.'),
    t('18.39% hydration base', 'Butylene glycol 12% and glycerin 6.39% support moisture and comfort.', 'Увлажняющая база 18,39%', 'Бутиленгликоль 12% и глицерин 6,39% поддерживают влагу и комфорт.', 'قاعدة ترطيب 18.39%', 'بيوتيلين غلايكول 12% وغليسرين 6.39% لدعم الترطيب والراحة.'),
    t('Three calming ingredients', 'Licorice derivative, skullcap extract and allantoin at 0.2% each.', 'Три успокаивающих компонента', 'Производное солодки, экстракт шлемника и аллантоин — по 0,2% каждого.', 'ثلاثة مكوّنات مهدئة', 'مشتق عرق السوس ومستخلص السكوتيلاريا والألانتوين بتركيز 0.2% لكل منها.'),
    t('Gentle active-free step', 'No retinoids, acids, arbutin, adenosine or UV filters.', 'Деликатный этап без активов', 'Без ретиноидов, кислот, арбутина, аденозина и UV-фильтров.', 'خطوة لطيفة بلا مكوّنات قوية', 'من دون ريتينويدات أو أحماض أو أربوتين أو أدينوزين أو فلاتر UV.'),
    t('Practitioner-led timing', 'Begin only when your practitioner confirms the skin is intact.', 'Срок определяет специалист', 'Начинайте только после подтверждения специалиста, что кожа целая.', 'موعد يحدده المختص', 'يبدأ الاستخدام فقط بعد تأكيد المختص أن سطح البشرة سليم.'),
    t('Repeat as needed', 'Use morning and evening, then reapply when dryness or tightness returns.', 'Повторяйте по потребности', 'Используйте утром и вечером и повторяйте при сухости или стянутости.', 'يُعاد عند الحاجة', 'يُستخدم صباحاً ومساءً ويُعاد عند عودة الجفاف أو الشد.'),
  ],
  '38': [
