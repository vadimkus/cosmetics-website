...
/**
 * Training + personal use — warehouse write-off @ buyPrice (2026-07-26):
 *   54484 Cerabarrier Biome Gel Cleanser 200ml ×1
 *   00052 HR³ Scalp & Hair Shampoo 300ml ×1
 *   00189 Skin Rescue Overnight Cream Mask 100g ×1
 *   54458 Moisture Replenishing Hyaluron Cream 50g ×1
 *   00051 HR³ Hair Tonic 70ml ×1
 *   54475 BIO-MESO PDRN Homecare Ampoule 5000 ×3
 *   00020 SWS vial 2ml ×10
 *   00015 SRS vial 2ml ×10
 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-training-personal-writeoff-20260726.js
 *   node --import dotenv/config scripts/moysklad-create-training-personal-writeoff-20260726.js --commit
 */
...
const MARKER = `TRAINING-${uaeToday()}`
...
const LINES = [
  ...
  ['00051', 1, 'HR³ Hair Tonic 70ml'],
  ['54475', 3, 'BIO-MESO PDRN Homecare Ampoule 5000'],
  ['00020', 10, 'SWS vial 2ml'],
  ['00015', 10, 'SRS vial 2ml'],
...
async function main() {
  console.log('====================================================================')
  console.log('  Training (+ personal use) — stock write-off @ buyPrice')
  console.log('====================================================================')
  console.log(`  Mode: ${COMMIT ? 'COMMIT' : 'DRY RUN'}`)
  console.log(`  Reason: Training`)
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Reason: Training (+ personal use for training).',
      'Cerabarrier200, shampoo, overnight, hyaluron cream50, hair tonic, meso PDRN5000 x3, SWS x10, SRS x10, collagen x10, sea algae x10, hyaluron serum.',
    ].join(' | '),
