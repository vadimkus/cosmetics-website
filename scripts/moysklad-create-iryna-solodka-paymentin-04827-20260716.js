...
/**
 * Miss Irina Solodkaya (Iryna Solodka) — paymentin @ shipment 06550 / invoice 04827.
 * Order GENCardM2607165770 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-iryna-solodka-paymentin-04827-20260716.js
 *   node --import dotenv/config scripts/moysklad-create-iryna-solodka-paymentin-04827-20260716.js --commit
 */
...
const AGENT_ID = 'fe9bcf0c-ab69-11ed-0a80-0cad00322ed0'
const STATE_ORDER_DELIVERED_ID = 'e1a0ae5f-33c5-11ea-0a80-043f000b275e'

const MARKER = 'IRYNA-SOLODKA-PAYMENTIN-04827-2026-07-16'

const PAYMENT = {
  amountMinor: 85500,
  invoiceName: '04827',
  invoiceId: '38011d04-80ed-11f1-0a80-04d10013eea3',
  shipmentName: '06550',
  shipmentId: '38cb8db5-80ed-11f1-0a80-082000140959',
  orderName: 'GENCardM2607165770',
  orderId: '37b7953a-80ed-11f1-0a80-173400148844',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Irina Solodkaya — paymentin @ 04827 / 06550')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Clinic order paid — cleanser, cushion x2, problem cream, PDRN mask, delivery.',
    ].join(' | '),
    operations: [
      {
        meta: {
