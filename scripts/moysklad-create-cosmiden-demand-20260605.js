...
/**
 * Cosmiden — отгрузка (demand) under commission agreement **15**.
 *
 *   node --import dotenv/config scripts/moysklad-create-cosmiden-demand-20260605.js
 *   node --import dotenv/config scripts/moysklad-create-cosmiden-demand-20260605.js --commit
 */
...
const DEMAND = {
  ...
  marker: `Cosmiden consignment replenishment sea algae collagen masks ${uaeToday(RUN_AT)}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Cosmiden — отгрузка (agreement 15)')
  console.log('====================================================================')
  ...
  const payload = {
    ...
    description: [
      DEMAND.marker,
      'Agreement 15 replenishment: Soothing Bomb Sea Algae Mask 23g x10, Collagen Mask 23g x10.',
    ].join('\n'),
