 ...
 *   54472 Revita Glow BB #01 Bright ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-mist-bb-writeoff-20260622.js
 *   node --import dotenv/config scripts/moysklad-create-presents-mist-bb-writeoff-20260622.js --commit
 */
...
const MARKER = `PRESENTS-WRITE-OFF-MIST-BB-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents write-off — mist + Revita Glow BB Bright')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00188 Microbiome Mist x1, 54472 Revita Glow BB Bright x1.',
    ].join(' | '),
