...
/**
 * Miss Ezgi Birdal — retail SO → invoice → shipment → paymentin + landscape print.
 *
 *   00122 Multi-Vita Radiance Cream 50g ×1 @ 290 AED retail
 *   Excellent Delivery Dubai ×1 @ 45 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-ezgi-birdal-radiance-order-paymentin-20260711.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}5756`,
  moment: uaeMomentNow(),
  marker: `EZGI-BIRDAL-RADIANCE-CREAM-RETAIL-${uaeToday()}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Ezgi Birdal — radiance cream retail + paymentin + print')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00122 Multi-Vita Radiance Cream 50g x1 @ 290 AED retail; delivery 45 AED.',
