...
const AR: MesopeciaKitCopy = {
  eyebrow: 'طقم ميزوبيشيا إتش آر³ ماتريكس · مقشّر 100 مل · محلول 4 مل × 6 · رولر 0.5 مم',
  headline: 'سائلان يمكنك شراؤهما أصلاً، والرولر بنصف مليمتر الذي يحوّلهما إلى بروتوكول.',
  subheadline:
    'العبوة في هذا الصندوق هي مقشّر فروة الرأس إتش آر³ ماتريكس α، والأمبولات هي Hair Solution α، ولكلٍّ منهما صفحته هنا بتركيبته الكاملة. وما يضيفه الطقم هو الرولر وترتيب الخطوات: نظّفي الفروة، افتحي الطريق، ثم أدخلي المحلول خلفه. تسجّل كوريا المقشّر كمنعش لفروة الرأس والمحلول لإمداد التغذية وتكييف الشعر — ولا أحد منهما مسجّل لعلاج تساقط الشعر، مهما قالت العلبة، وثمّة قسم أدناه عن ذلك.',
  heroBullets: [
  ...
  whatItIs: {
    ...
    title: 'هذا منتجان يمكنك شراؤهما أصلاً، مع رولر.',
    body:
      'ليس للطقم تركيبة خاصة به، والقراءة الصريحة لهذه الصفحة أن كل ما هو كيميائي فيه موجود على صفحتين أخريين. فالمقشّر هو المنتج 46 والمحلول هو المنتج 45، بالتراكيز نفسها ومن الدفعات نفسها وبالشهادات والاحتياطات نفسها. وما تقرّرينه هنا هو ما إذا كنت تريدين أداة الوضع والدورة الأقصر — لا ما إذا كنت تريدين منتجاً مختلفاً.',
    items: [
      'ثلث المقشّر كحول مُمَوَّه. يزيل دهن الفروة بسرعة، وهو ليس مقشّراً لطيفاً',
      'عوامل النمو الأربعة في المحلول تبلغ مجتمعة 1.2 جزء من المليون؛ والحامل هو ما يقوم بالإيصال',
    ...
    detail:
      'ويستحق أن يُقال بوضوح، لأن وصفنا نحن لهذا الطقم كان يقول غير ذلك حتى اليوم. فقد ادّعى أن المجموعة تثبّط إنزيماً لكبح هرمون، وتعزّز نموّ أوعية دموية جديدة، وتحفّز نموّ الشعر وتمنع تساقطه. تلك ادّعاءات دواء بوصفة طبية. وقد رُفعت عن السائلين حين قوبل كلٌّ منهما بملفّه، وكان الطقم قد احتفظ بها جميعاً بهدوء.',
    carton:
      'ونعرف تماماً من أين جاءت، لأن العلبة تقولها هي الأخرى. بالإنجليزية، على العلبة التي ستصلك: «نظام مبتكر لعلاج الشعر وفروة الرأس صُمّم لمنع تساقط الشعر وتعزيز إعادة نموّه واستعادته عبر تثبيط الأسباب الجذرية للتساقط». واللوحة الروسية تذهب أبعد وتسمّي الطقم كلّه طقماً لمكافحة تساقط الشعر. ونحن لا نحمل شيئاً من ذلك. فما سجّلته كوريا لهذين السائلين هو منعش لفروة الرأس ومكيّف للشعر، وتثبيط الأسباب الجذرية للتساقط شيء تفعله الأدوية. فإن كان تساقط الشعر هو ما تواجهينه، فراجعي طبيباً بشأنه — ثم استعملي هذا، إن شئت، إلى جانب ما يصفه لك.',
  },
  ...
  contents: {
    ...
    intro:
      'السائلان هما ما كنت ستشترينه على أي حال لو كنت تفعلين هذا في المنزل. والرولر هو سبب وجود الصندوق.',
    items: [
      {
        name: 'HR³ MATRIX Scalp Peeling α',
        dose: '100 ml',
        body: 'كحول مُمَوَّه بنسبة 33.600% مع بروبيلين جليكول بنسبة 11.994%، يقطع دهن الفروة وتراكم المنتجات في ثوانٍ حتى يلتقي الرولر ببشرة نظيفة. ويحمل أيضاً 1.7% من عوامل التبريد بين المنثول والمنثيل لاكتات، وهو الأعلى في أي منتج جينوسيس. يُفرك بعود قطني ولا يُشطف.',
      },
      {
        name: 'HR³ MATRIX Hair Solution α',
        dose: '4 ml × 6',
  ...
  arithmetic: {
    eyebrow: 'الحساب',
    title: 'كم يكلّفك الرولر فعلاً، محسوباً من القطع',
    intro:
      'الطقم ليس خصم باقة، ومن الأفضل أن تسمعي ذلك منّا بدل أن تحسبيه في البيت. وهذا الصندوق نفسه مسعّراً بما تكلّفه محتوياته منفردة.',
    rows: [
    ...
    body:
      'ويترتّب على ذلك أمران. إن كنت تحتاجين أداة الوضع، فـ255 درهماً هو ما تكلّفك هنا، وهذه الطريقة الوحيدة للحصول على هذا الرولر تحديداً — وللمقارنة، رولر الوخز الدقيق 0.25 مم الذي نبيعه وحده سعره 230 درهماً، لكنه إبرة أقصر مُعدّة للوجه، فاقرئيه كمقارنة سعر لا كبديل. أما إن كان ما تريدينه فعلاً دورة كاملة، فاشتري المقشّر وعلبة Hair Solution المنفردة على حدة: ذلك 1,030 درهماً لثماني أمبولات بدل ست — مال أقل ومنتج أكثر ممّا في الطقم، بلا رولر. ولا إجابة منهما خاطئة. الأمر كلّه يعود إلى ما إذا كان لديك أصلاً ما تستعملينه للوخز.',
  },
  ...
  howTo: {
    ...
    steps: [
      {
        title: 'افركي المقشّر',
        body: 'اسكبي قليلاً من مقشّر الفروة α، وبلّلي عوداً قطنياً جيداً، وافركيه على منطقة المعالجة — وكلمة العلبة نفسها هي «بقوة»، وهي تعنيها. ولا يُشطف. توقّعي إحساساً شديد البرودة، وتوقّعي لسعاً في أي موضع تكون فيه البشرة مجروحة.',
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'لهما عمل مختلف. فهذا الطقم جلسة تُجرى من حين إلى آخر؛ أما شامبو MEDI α وتونر الشعر α فهما ما تستعملينه بينها، ولا يحتاج أيٌّ منهما رولر. وإن كنت تشترين المجموعة كاملة، فالقراءة المعقولة أن هذا هو العلاج وأولئك هما الروتين حوله.',
      },
    ],
  },
...
const RU: MesopeciaKitCopy = {
  eyebrow: 'HR³ MATRIX набор Mesopecia · Пилинг 100 мл · Раствор 4 мл × 6 · Роллер 0,5 мм',
  headline: 'Две жидкости, которые можно купить и так, и роллер в полмиллиметра, который делает из них протокол.',
  subheadline:
    'Флакон в этой коробке — HR³ MATRIX пилинг для кожи головы α, ампулы — HR³ MATRIX Hair Solution α, и у каждого здесь своя страница с полной формулой. Набор добавляет роллер и порядок действий: очистить кожу головы, открыть путь, ввести раствор следом. Корея регистрирует пилинг как средство для освежения кожи головы, а раствор — для питания и кондиционирования волос. Ни то, ни другое не зарегистрировано для лечения выпадения волос, что бы ни было написано на коробке, и ниже об этом есть отдельный раздел.',
  heroBullets: [
  ...
  whatItIs: {
    ...
    title: 'Это два продукта, которые можно купить и так, плюс роллер.',
    body:
      'У набора нет собственной формулы, и честное прочтение этой страницы такое: всё химическое в нём живёт на двух других страницах. Пилинг — это продукт 46, раствор — продукт 45, в тех же концентрациях, из тех же партий, с теми же сертификатами и теми же мерами предосторожности. Здесь вы решаете, нужен ли вам аппликатор и более короткий курс, — а не хотите ли вы другой продукт.',
    items: [
      'Треть пилинга — денатурированный спирт. Он быстро обезжиривает кожу головы и не является мягким отшелушивающим средством',
      'Четыре фактора роста в растворе дают вместе 1,2 части на миллион; доставляет их носитель',
    ...
    detail:
      'Стоит сказать прямо, потому что наше собственное описание этого набора до сегодняшнего дня говорило иное. Оно утверждало, что набор подавляет фермент, чтобы снизить гормон, стимулирует рост новых сосудов, стимулирует рост волос и предотвращает их выпадение. Это заявления рецептурного препарата. Они были сняты с обеих жидкостей, когда каждую сверили с её документами, и набор тихо сохранил их все.',
    carton:
      'И мы точно знаем, откуда они взялись, потому что коробка говорит то же самое. По-английски, на упаковке, которую вы получите: «инновационная система ухода за волосами и кожей головы, созданная, чтобы предотвращать выпадение волос и способствовать их повторному росту и восстановлению, подавляя фундаментальные причины выпадения». Русская панель идёт дальше и называет весь набор набором для борьбы с выпадением волос. Мы не несём ничего из этого. Корея зарегистрировала эти две жидкости как средство для освежения кожи головы и кондиционер для волос, а подавление фундаментальных причин выпадения — это то, что делают лекарства. Если вы столкнулись с выпадением волос, это разговор с врачом, а потом, если захотите, используйте это рядом с тем, что он назначит.',
  },
  ...
  contents: {
    ...
    intro:
      'Две жидкости — это то, что вы купили бы в любом случае, если бы делали это дома. Роллер — причина, по которой коробка существует.',
    items: [
      {
        name: 'HR³ MATRIX Scalp Peeling α',
        dose: '100 мл',
        body: 'Денатурированный спирт 33,600% с пропиленгликолем 11,994% срезает кожное сало и остатки средств за секунды, чтобы роллер встретил чистую кожу. Он также несёт 1,7% охлаждающих агентов между ментолом и ментил лактатом — больше, чем любой продукт GENOSYS. Втирается ватной палочкой и не смывается.',
      },
      {
        name: 'HR³ MATRIX Hair Solution α',
        dose: '4 мл × 6',
  ...
  arithmetic: {
    eyebrow: 'Арифметика',
    title: 'Во сколько на самом деле обходится роллер, если считать по частям',
    intro:
      'Набор не является скидкой за комплект, и лучше услышать это от нас, чем считать дома. Вот та же коробка, оценённая по стоимости её содержимого по отдельности.',
    rows: [
    ...
    body:
      'Отсюда следует два вывода. Если вам нужен аппликатор, 255 AED — во столько он вам здесь обходится, и другого способа получить именно этот роллер нет; для масштаба, Microneedle Roller 0,25 мм, который мы продаём отдельно, стоит 230 AED, но это более короткая игла для лица, так что это сравнение цены, а не замена. Но если вам на самом деле нужен полный курс, купите пилинг и отдельную упаковку Hair Solution: это 1 030 AED за восемь ампул вместо шести — меньше денег и больше продукта, чем в наборе, но без роллера. Ни один из ответов не является неправильным. Всё сводится к тому, есть ли у вас уже чем работать с иглами.',
  },
    ...
    steps: [
      {
        ...
        body: 'Отлейте немного пилинга α, как следует пропитайте ватную палочку и втирайте её в обрабатываемую зону — слово самой коробки здесь «энергично», и она это всерьёз. Не смывается. Ожидайте сильного холода и щипания везде, где кожа повреждена.',
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'У них другая работа. Этот набор — процедура, которую делают время от времени; шампунь MEDI α и тоник для волос α — то, чем вы пользуетесь между ними, и ни одному из них роллер не нужен. Если вы берёте всю линию, разумное прочтение такое: это процедура, а те два — уход вокруг неё.',
      },
    ],
  },
...
export const MESOPECIA_KIT_COPY: Record<Locale, MesopeciaKitCopy> = { en: EN, ar: AR, ru: RU }
