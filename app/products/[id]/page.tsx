          ...
          <div className="space-y-6">
            <div>
              ...
              {(() => {
                ...
                // Use product.size field if available
                if (product.size) {
                  return (
                    <div className="mb-4">
                      <div className="inline-flex items-center bg-blue-50 text-blue-800 px-3 py-2 rounded-lg border border-blue-200">
                        ...
                        <span className="font-semibold text-sm">Size: {product.size}</span>
                      </div>
                    </div>
                  );
                }
                ...
                // Fallback: try to extract size from description
                ...
                {product.id === '1' ? (
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 SKIN DEFENDER LIP & EYE MAKEUP REMOVER Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">0.7 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 EPI TURNOVER BOOSTING PEELING GEL Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">3.8 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 INTENSIVE PROBLEM CONTROL TONER Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">1.0 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 MOISTURE REPLENISHING HYALURON SERUM Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">1.9 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 MULTI VITA RADIANCE SERUM Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">1.5 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 EyeCell EYE PEPTIDE GEL PATCH Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">1.4 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 ULTRA SHIELD SUN CREAM Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">0.6 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 HR³ MATRIX HAIR TONIC α Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">1.9 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 HR³ MATRIX SCALP SHAMPOO α Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">2.3 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 HR³ MATRIX HAIR SOLUTION α Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">2.3 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 HR³ MATRIX SCALP PEELING α Documentation</h4>
                      <p className="text-xs text-gray-500 mb-3">2.1 MB</p>
                      <a 
                  ...
                  <>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-800 mb-2">📄 HAIR GENTRON Documentation</h4>
                  ...
                  <>
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Product Details</h3>
                    <p className="text-gray-600 mb-4">
                      This powder mask, infused with fermented energy and growth factors, provides rapid soothing and deep nourishment to skin weakened by external stressors.
                    </p>
                    
                    <h4 className="font-semibold text-gray-800 mb-2">Key Benefits:</h4>
                    <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
                      <li>Moisture-locking top-quality diatomaceous earth base mask</li>
                      <li>Powerful anti-aging mask</li>
                      <li>Hydrating effect</li>
