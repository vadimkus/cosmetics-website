...
/**
 * IULIA BEAUTY SALON LLC — Отгрузка (demand) under commission contract **28**.
 *
 * Lines from delivery note (each qty 1):
 * - Snow O₂ Cleanser 180ml
 * - Skin Rescue Overnight Cream Mask 100g
 * - Moisture Replenishing Hyaluron Cream 50g
 * - Multi Vita Radiance Serum 30ml
 *
 * Dry-run:
 *   set -a; source .env; set +a
 *   node scripts/moysklad-create-iulia-beauty-demand-20260516.js
 *
 * Commit:
 *   node scripts/moysklad-create-iulia-beauty-demand-20260516.js --commit
 */
...
const COMMON = {
  date: '2026-05-16',
  moment: '2026-05-16 20:10:00',
  organizationId: 'e18525a4-33c5-11ea-0a80-043f000b2738',
  storeId: 'e186d449-33c5-11ea-0a80-043f000b273a',
  agentId: '96500719-c90e-11f0-0a80-19c8002d2932',
  contractId: 'f2dad83f-c91f-11f0-0a80-09d3003136c5',
}
...
const DEMAND = {
  ...
  marker:
    'IULIA BEAUTY SALON LLC City Walk — отгрузка по накладной screenshot 2026-05-16 (4 lines x1)',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  MoySklad Отгрузка — IULIA BEAUTY SALON LLC / contract 28')
  console.log('====================================================================')
  ...
  const payload = {
    ...
    description: [
      DEMAND.marker,
      'Customer: IULIA BEAUTY SALON LLC — City Walk building 16, Dubai.',
      'Agreement: 28 (commission).',
    ].join('\n'),
