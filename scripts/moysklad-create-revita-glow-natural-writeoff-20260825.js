...
/**
 * Warehouse write-off @ buyPrice (2026-08-25):
 *   54473 Revita Glow BB #02 Natural 50g ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-revita-glow-natural-writeoff-20260825.js
 *   node --import dotenv/config scripts/moysklad-create-revita-glow-natural-writeoff-20260825.js --commit
 */
...
const MARKER = `WRITE-OFF-REVITA-GLOW-NATURAL-54473-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Write-off — Revita Glow BB Natural 54473 ×1')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    applicable: true,
    moment: uaeMomentNow(),
    description: [MARKER, 'Warehouse write-off at buyPrice.', 'Revita Glow BB #02 Natural 54473 x1.'].join(' | '),
