...
/**
 * Sales bonus payout to Vadim Sagatdinov — 7,600.00 AED (July 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-7600-20260807.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-7600-20260807.js --commit
 */
...
const SUM_MINOR = 760000 // 7,600.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-JULY-7600-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (July 2026) — 7,600 AED')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentout', {
    ...
    sum: SUM_MINOR,
    paymentPurpose: `Sales bonus July 2026 ${money(SUM_MINOR)} AED — Sagatdinov [${MARKER}]`,
    description: `Sales bonus>>July 2026 — Sagatdinov | ${MARKER}`,
  })
