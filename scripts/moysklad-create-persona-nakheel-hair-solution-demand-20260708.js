 ...
 *
 *   00048 HR³ Matrix Hair Solution Professional Box (8pcs) ×7
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-nakheel-hair-solution-demand-20260708.js --commit
 */
...
const MARKER = `Persona Nakheel Mall hair solution replenishment ${uaeToday()}`
const LINES = [['00048', 7, 'HR³ Matrix Hair Solution Professional Box (8pcs)']]
const EXPECTED_SUM_MINOR = 259000
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Nakheel Mall — hair solution consignment note (00078)')
  console.log('====================================================================')
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      'HR³ Matrix Hair Solution Professional Box 00048 ×7.',
    ].join('\n'),
