...
/**
 * Promotional presents write-off @ buyPrice:
 *   00188 Microbiome Mist ×1
 *   00195 Hyaluron Serum 30ml ×1
 *   54458 Hyaluron Cream 50g ×1
 *   54467 Skin Reboot PDRN mask Pack ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-hyaluron-pdrn-writeoff-20260622.js
 *   node --import dotenv/config scripts/moysklad-create-presents-hyaluron-pdrn-writeoff-20260622.js --commit
 */
...
const MARKER = `PRESENTS-WRITE-OFF-HYALURON-PDRN-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents write-off — mist / hyaluron / PDRN mask')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00188 Mist x1, 00195 Hyaluron Serum x1, 54458 Hyaluron Cream 50g x1, 54467 PDRN mask pack x1.',
    ].join(' | '),
