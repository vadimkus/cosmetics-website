 ...
 *   00015 Skin Renewal Peeling System (SRS) 1 Vial 2ml ×10
 *
 *   node --import dotenv/config scripts/moysklad-create-sara-srs-present-writeoff-20260720.js
 *   node --import dotenv/config scripts/moysklad-create-sara-srs-present-writeoff-20260720.js --commit
 */
...
const MARKER = `PRESENT-SARA-SRS-x10-${uaeToday()}`

const LINES = [['00015', 10, 'Skin Renewal Peeling System (SRS) 1 Vial 2ml']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Present to Sara — SRS ×10 write-off @ buyPrice')
  console.log('====================================================================')
  ...
  console.log(`\n  Total buy cost: ${money(totalMinor)} AED | 10 pcs`)
