...
/**
 * Sales bonus payout to Vadim Sagatdinov — 200.00 AED (August 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-200-20260823.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-200-20260823.js --commit
 */
...
const MARKER = `SALES-BONUS-SAGATDINOV-AUG-20000-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (August 2026) — 200.00 AED')
  console.log('====================================================================')
