...
/**
 * Promotional present write-off @ buyPrice — Revita Glow BB #02 Natural 50g ×1.
 *
 *   node --import dotenv/config scripts/moysklad-create-revita-glow-natural-present-writeoff-20260703.js
 *   node --import dotenv/config scripts/moysklad-create-revita-glow-natural-present-writeoff-20260703.js --commit
 */
...
const MARKER = `PRESENT-REVITA-GLOW-NATURAL-${uaeToday()}`

const LINES = [['54473', 1, 'Revita Glow BB Cream #02 Natural 50g']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Present write-off — Revita Glow BB Natural 54473 ×1')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '54473 Revita Glow BB Cream #02 Natural 50g x1.',
    ].join(' | '),
