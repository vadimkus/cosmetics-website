...
/**
 * Sales bonus payout to Vadim Sagatdinov — 2,350.00 AED (August 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-2350-20260809.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-2350-20260809.js --commit
 */
...
const SUM_MINOR = 235000 // 2,350.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-AUG-2350-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (August 2026) — 2,350 AED')
  console.log('====================================================================')
