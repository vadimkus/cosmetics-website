      ...
      <div className={`container mx-auto px-4 max-w-2xl ${isMobile ? 'py-6' : ''}`}>
        ...
        <div className="mt-8 rounded-[24px] border border-[var(--cera-line)] bg-[var(--cera-cream-deep)] p-5 text-center">
          ...
          <button
            ...
            className={`inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--brand-whatsapp-deep)] text-white rounded-full hover:bg-[var(--brand-whatsapp-hover)] transition-colors font-medium ${isRTL ? 'flex-row-reverse' : ''}`}
          >
