...
/**
 * Salik — road toll 100 AED via DubaiPay (02 Jul 2026, Apple Pay).
 *
 *   node --import dotenv/config scripts/moysklad-create-salik-paymentout-20260702.js
 *   node --import dotenv/config scripts/moysklad-create-salik-paymentout-20260702.js --commit
 */
...
const PAY_DATE = '2026-07-02'
const PAY_MOMENT = '2026-07-02 06:42:00'
const SUM_MINOR = 10000 // 100.00 AED
const SP_TXN = '138906046'
const DUBAIPAY_TXN = '660003069217928'
const MARKER = `SALIK-DUBAIPAY-${SP_TXN}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Salik — road toll (paymentout, DubaiPay receipt)')
  console.log('====================================================================')
  console.log(`  Mode : ${COMMIT ? 'COMMIT' : 'DRY RUN'}`)
  console.log(`  Date : ${PAY_DATE} (${PAY_MOMENT})`)
  console.log(`  Sum  : ${money(SUM_MINOR)} AED`)
  console.log(`  SP txn: ${SP_TXN} | DubaiPay: ${DUBAIPAY_TXN}`)
