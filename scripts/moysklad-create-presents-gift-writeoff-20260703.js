 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-gift-writeoff-20260703.js
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents write-off — EZ mask, PDRN, SWS, radiance, masks')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'EZ mask 00011 x1, PDRN Expert 54470 x2, PDRN Homecare 54475 x2, SWS vials 00020 x10, Radiance cream 00122 x1, Radiance serum 00194 x1, Collagen 00063 x10, Sea Algae 00140 x10.',
    ].join(' | '),
