...
/**
 * Sales bonus payout to Vadim Sagatdinov — 5,339.80 AED (August 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-5339-20260811.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-5339-20260811.js --commit
 */
...
const SUM_MINOR = 533980 // 5,339.80 AED
const MARKER = `SALES-BONUS-SAGATDINOV-AUG-533980-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (August 2026) — 5,339.80 AED')
  console.log('====================================================================')
