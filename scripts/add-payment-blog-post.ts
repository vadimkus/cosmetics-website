...
/**
 * Script to add a new blog post about Stripe payment options via API
 * Run with: npx tsx scripts/add-payment-blog-post.ts
 */
...
const blogPostData = {
  ...
  <div class="mb-8">
    <h3 class="text-2xl font-semibold mb-4">🛍️ How to Use the New Payment Options</h3>
    <div class="bg-gray-50 p-6 rounded-lg">
      <ol class="space-y-2">
        <li><strong class="text-red-600">1. Shop:</strong> Add your favorite GENOSYS products to cart</li>
        <li><strong class="text-red-600">2. Checkout:</strong> Proceed to our enhanced checkout page</li>
        <li><strong class="text-red-600">3. Choose:</strong> Select your preferred payment method (Apple Pay, Google Pay, Link, or card)</li>
        <li><strong class="text-red-600">4. Pay:</strong> Complete your secure payment in seconds</li>
        <li><strong class="text-red-600">5. Enjoy:</strong> Receive confirmation and track your order</li>
      </ol>
    </div>
  </div>
  ...
  contentRu: `<div class="max-w-4xl mx-auto">
  <div class="mb-8">
  ...
  <div class="mb-8">
    <h3 class="text-2xl font-semibold mb-4">✨ Почему это важно для вас</h3>
    <div class="bg-red-50 p-6 rounded-lg">
      <ul class="space-y-3">
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">🔒</span><span><strong>Повышенная безопасность:</strong> Все платежи обрабатываются через ведущую в отрасли инфраструктуру безопасности Stripe</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">⚡</span><span><strong>Более быстрая оплата:</strong> Завершите покупку за секунды с сохранёнными способами оплаты</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">🌍</span><span><strong>Глобальная поддержка:</strong> Безупречно работает для клиентов ОАЭ, ССАГПЗ и международных покупателей</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">📱</span><span><strong>Оптимизация для мобильных:</strong> Идеальный опыт оплаты на любом устройстве</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">🛡️</span><span><strong>Защита от мошенничества:</strong> Передовое обнаружение мошенничества обеспечивает безопасность ваших платежей</span></li>
      </ul>
    </div>
  </div>

  <div class="mb-8">
    <h3 class="text-2xl font-semibold mb-4">🛍️ Как использовать новые способы оплаты</h3>
    <div class="bg-gray-50 p-6 rounded-lg">
      <ol class="space-y-2">
        <li><strong class="text-red-600">1. Покупки:</strong> Добавьте ваши любимые продукты GENOSYS в корзину</li>
        <li><strong class="text-red-600">2. Оформление:</strong> Перейдите на нашу улучшенную страницу оплаты</li>
        <li><strong class="text-red-600">3. Выбор:</strong> Выберите предпочитаемый способ оплаты (Apple Pay, Google Pay, Link или карта)</li>
        <li><strong class="text-red-600">4. Оплата:</strong> Завершите безопасную оплату за секунды</li>
        <li><strong class="text-red-600">5. Наслаждайтесь:</strong> Получите подтверждение и отслеживайте ваш заказ</li>
      </ol>
    </div>
  </div>
  ...
  contentAr: `<div class="max-w-4xl mx-auto" dir="rtl">
  <div class="mb-8">
  ...
  <div class="mb-8">
    <h3 class="text-2xl font-semibold mb-4">✨ لماذا هذا مهم لك</h3>
    <div class="bg-red-50 p-6 rounded-lg">
      <ul class="space-y-3">
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">🔒</span><span><strong>أمان معزز:</strong> جميع المدفوعات تتم معالجتها من خلال البنية التحتية الأمنية الرائدة في الصناعة من Stripe</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">⚡</span><span><strong>خروج أسرع:</strong> أكمل مشترياتك في ثوانٍ مع طرق الدفع المحفوظة</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">🌍</span><span><strong>دعم عالمي:</strong> يعمل بسلاسة عبر دولة الإمارات ودول مجلس التعاون الخليجي والعملاء الدوليين</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">📱</span><span><strong>محسن للهواتف المحمولة:</strong> تجربة دفع مثالية على أي جهاز</span></li>
        <li class="flex items-start gap-3"><span class="text-red-600 font-semibold">🛡️</span><span><strong>حماية من الاحتيال:</strong> اكتشاف متقدم للاحتيال يحافظ على أمان مدفوعاتك</span></li>
      </ul>
    </div>
  </div>

  <div class="mb-8">
    <h3 class="text-2xl font-semibold mb-4">🛍️ كيفية استخدام خيارات الدفع الجديدة</h3>
    <div class="bg-gray-50 p-6 rounded-lg">
      <ol class="space-y-2">
        <li><strong class="text-red-600">1. تسوق:</strong> أضف منتجات GENOSYS المفضلة لديك إلى السلة</li>
        <li><strong class="text-red-600">2. الخروج:</strong> انتقل إلى صفحة الدفع المحسنة لدينا</li>
        <li><strong class="text-red-600">3. اختر:</strong> حدد طريقة الدفع المفضلة لديك (Apple Pay، Google Pay، Link، أو البطاقة)</li>
        <li><strong class="text-red-600">4. ادفع:</strong> أكمل دفعتك الآمنة في ثوانٍ</li>
        <li><strong class="text-red-600">5. استمتع:</strong> احصل على التأكيد وتتبع طلبك</li>
      </ol>
    </div>
  </div>
...
async function addBlogPost() {
  try {
    console.log('🚀 Creating new blog post about payment options via API...')
    
    // Use the production API
    const response = await fetch('https://genosys.ae/api/blog/posts', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        // For development/testing, we'll create a simple version without auth first
      },
...
export { addBlogPost, blogPostData }