...
/**
 * Script to create blog post directly in database using provided credentials
 */

// Set the environment variables for Prisma before importing
...
async function createBlogPost() {
  try {
    ...
    if (existingPost) {
      ...
      console.log('')
      console.log('📱 URLs:')
      console.log(`🇬🇧 English: https://genosys.ae/blog/${existingPost.slug}`)
      console.log(`🇷🇺 Russian: https://genosys.ae/ru/blog/${existingPost.slug}`)
      console.log(`🇸🇦 Arabic: https://genosys.ae/ar/blog/${existingPost.slug}`)
      return existingPost
    }
