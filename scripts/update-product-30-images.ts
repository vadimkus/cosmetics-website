/**
 * Update product 30 (INTENSIVE PROBLEM CONTROL CREAM) to the
 * public/images/problem_cream/ set (main + s1–s6).
 *
 * Dry run:
 *   npx tsx --env-file=.env.local scripts/update-product-30-images.ts
 * Apply:
 *   npx tsx --env-file=.env.local scripts/update-product-30-images.ts --apply
 */
import { prisma } from '../lib/prisma'

const NEW_MAIN = '/images/problem_cream/main.jpeg'
const NEW_GALLERY = [
  '/images/problem_cream/s1.jpeg',
  '/images/problem_cream/s2.jpeg',
  '/images/problem_cream/s3.jpeg',
  '/images/problem_cream/s4.jpeg',
  '/images/problem_cream/s5.jpeg',
  '/images/problem_cream/s6.jpeg',
]
const REPLACEMENTS: Array<[string, string]> = [
  ['/images/PRB.jpg', NEW_MAIN],
  ['/images/Second/problem_duo.jpg', NEW_GALLERY[0]],
]
...
async function main() {
  const product = await prisma.product.findFirst({
    where: { OR: [{ id: '30' }, { productNumber: '30' }] },
