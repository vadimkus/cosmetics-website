...
/**
 * Milena JBR — paymentin for invoice 04924 / shipment 06676 / SO GENCardM260812MILJCAM5.
 * Completes chain: SO → INV → SHIP → payment in → order Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-milena-jbr-04924-paymentin-20260812.js
 *   node --import dotenv/config scripts/moysklad-create-milena-jbr-04924-paymentin-20260812.js --commit
 */
...
const AGENT_ID = 'b16bd870-da6d-11f0-0a80-1902000d2f93' // Milena JBR
const STATE_ORDER_DELIVERED_ID = 'e1a0ae5f-33c5-11ea-0a80-043f000b275e'
const MARKER = 'MILENA-JBR-PAYMENTIN-04924-2026-08-12'
...
const DOCS = {
  ...
  invoiceName: '04924',
  demandId: '842b61f3-963f-11f1-0a80-1cea00268345',
  demandName: '06676',
  amountMinor: 75000,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Milena JBR — paymentin @ 04924 / 06676')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Camel cushion x5 @ 150 — completes SO→INV→SHIP→paymentin.',
    ].join(' | '),
    operations: [
      {
        meta: {
