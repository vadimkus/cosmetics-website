...
/**
 * Miss Irina Mirdif — 10% off products; delivery unchanged (45 AED).
 * Chain: GENCardM2608160063 / inv 04934 / ship 06688 (unpaid).
 * 1,110 (was 50%) → 1,962 (1,917 products + 45 delivery).
 *
 *   node --import dotenv/config scripts/moysklad-fix-miss-irina-mirdif-10pct-discount-20260816.js
 *   node --import dotenv/config scripts/moysklad-fix-miss-irina-mirdif-10pct-discount-20260816.js --commit
 */
...
const PRODUCT_DISCOUNT = 10
const DELIVERY_DISCOUNT = 0
const EXPECTED_SUM_MINOR = 196200 // 1917 + 45
const MARKER = `MISS-IRINA-MIRDIF-10PCT-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Irina Mirdif — 10% off products (delivery full 45)')
  ...
  await api('PUT', `/entity/customerorder/${ORDER_ID}`, {
    ...
    description: [
      ...
      `[${MARKER}] 10% off products (was 50%); delivery 45 full. Total 1962 unpaid.`,
    ]
      .filter(Boolean)
      .join(' | '),
  })
