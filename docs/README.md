...
|----------|----------|-------------|
| 🔴 **Mobile commerce** | [Mobile-web product option sheet parity](./SESSION_CHANGES_2026-08-08_MOBILE_WEB_PRODUCT_OPTIONS.md) | Brings native-style explicit size/shade selection to mobile web/PWA product cards with a responsive desktop dialog, live variant/VIP pricing, OOS and quantity handling, EN/RU/AR + RTL, accessibility, cart identity safety, and a live 13-product audit. |
