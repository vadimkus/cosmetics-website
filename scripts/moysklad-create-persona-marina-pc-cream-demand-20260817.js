 ...
 *   Total: 355 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-marina-pc-cream-demand-20260817.js
 *   node --import dotenv/config scripts/moysklad-create-persona-marina-pc-cream-demand-20260817.js --commit
 */
...
const MARKER = `Persona Marina PC cream 250+50 replenishment ${uaeToday()}`
const EXPECTED_SUM_MINOR = 35500

/** [code, qty, clinicAed, label] */
const LINES = [
  ['00036', 1, 210, 'Intensive Problem Control Cream 250g'],
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Marina — PC cream 250g + 50g into agreement 00024')
  console.log('====================================================================')
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      '00036 Problem Control Cream 250g ×1 @210; 00035 Problem Control Cream 50g ×1 @145.',
      'Consignment replenishment. No SO / invoice / payment.',
    ].join('\n'),
