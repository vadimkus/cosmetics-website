 ...
 *   00140 Soothing Bomb Sea Algae Mask ×2 @ 18
 *   00063 Intensive Repair Collagen Mask ×3 @ 18
 *   54457 Ultra Shield Sun Cream SPF50 ×1 @ 125
 *   Delivery Dubai ×1 @ 45
 *   Total: 365 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-order-invoice-demand-20260721.js
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-order-invoice-demand-20260721.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}VBSO`,
  marker: `Valeriya Borscheva SPF40 sea-algae collagen SPF50 delivery ${uaeToday()}`,
}
...
const EXPECTED_SUM_MINOR = 36500
...
async function main() {
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00041 SPF40 x1; 00140 sea algae x2; 00063 collagen x3; 54457 SPF50 x1 @ clinic; delivery 45 AED.',
