...
/**
 * Present to Hortman — warehouse write-off @ buyPrice:
 *   54467 Skin Reboot PDRN mask Pack ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-hortman-present-pdrn-mask-writeoff-20260810.js
 *   node --import dotenv/config scripts/moysklad-create-hortman-present-pdrn-mask-writeoff-20260810.js --commit
 */
...
const MARKER = `PRESENT-HORTMAN-PDRN-MASK-54467-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Present Hortman — PDRN mask box ×1 write-off')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Present to Hortman Clinics 2 (Jumeirah) — PDRN mask box x1 @ buyPrice.',
    ].join(' | '),
