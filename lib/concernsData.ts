      ...
      ru: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              detail: 'Распределите Multi Functional Anti-Wrinkle Cream по лицу, чтобы сохранить влагу, затем нанесите ND Cell на шею и декольте восходящими движениями. Сквалан 5% и аденозин 0,04% обеспечивают этой тонкой зоне питательный комфорт.',
              products: [
                { name: 'MULTI FUNCTIONAL ANTI-WRINKLE CREAM', url: '/products/32', price: '290 AED' },
                { name: 'ND Cell ANTI-WRINKLE CREAM', url: '/products/23', price: '370 AED' },
              ],
