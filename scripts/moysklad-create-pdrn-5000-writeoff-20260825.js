 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-pdrn-5000-writeoff-20260825.js
 *   node --import dotenv/config scripts/moysklad-create-pdrn-5000-writeoff-20260825.js --commit
 */
...
const MARKER = `WRITE-OFF-PDRN-5000-54475-${uaeToday()}`

const LINES = [['54475', 1, 'BIO-MESO PDRN Homecare Ampoule 5000']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Write-off — PDRN 5000 54475 ×1')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    applicable: true,
    moment: uaeMomentNow(),
    description: [MARKER, 'Warehouse write-off at buyPrice.', 'PDRN Homecare 5000 54475 x1.'].join(' | '),
