 ...
 *
 * Lines:
 *   EyeCell Eye Peptide Gel Patch box (00053) x2 @ MoySklad salePrice
 *   Intensive Repair Collagen Mask 23g (00063) x3 @ MoySklad salePrice
 *   Excellent Delivery Dubai x1 @ 45 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-family-class-poly-clinic-order-invoice-demand-20260608.js
 *   node --import dotenv/config scripts/moysklad-create-family-class-poly-clinic-order-invoice-demand-20260608.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}52411`,
  moment: uaeMomentNow(),
  marker: `Family Class Poly Clinic patches collagen delivery ${uaeToday()}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  FAMILY CLASS POLY CLINIC — SO + invoice + shipment')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      'Eye patch box 00053 x2, collagen mask 00063 x3, delivery 45 AED. Chain: invoice → shipment.',
    ].join(' | '),
