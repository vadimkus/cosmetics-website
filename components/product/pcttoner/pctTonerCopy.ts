/**
 * Bespoke copy for the INTENSIVE PROBLEM CONTROL TONER page (product 15).
 *
 ...
 *
 *   Intertek/Problem Control Toner/Formula-GENOSYS INTENSIVE PROBLEM
 *   CONTROL TONER.xlsx (same PDF in both Intertek folders)
 *       Finished concentrations. Signed DTS MG, Narae Han. Every
 *       percentage on this page comes from here.
 *   Artwork-GENOSYS INTENSIVE PROBLEM CONTROL TONER(200ml).pdf
 *   Artwork-GENOSYS INTENSIVE PROBLEM CONTROL TONER(500ml).pdf
 *       Function: Oil control. Front sentence: helps remove excess oil
 *       and sebum for blemish-prone skin while adding quick hydration.
 *       Application: apply or spray sufficiently morning and evening.
 *       200 ml only: 360° spray, upside down for the back.
 *       Dermatologically tested. Precautions: external use, eyes/mucous,
 *       cool rinse, cool/dry, children, stop if irritation.
 *       Korean panel names a patented sebum ingredient. The English
 *       carton does not. Do not lead with patented.
 *   COA-GENOSYS INTENSIVE PROBLEM CONTROL TONER.pdf
 *       Transparent liquid, light yellow. pH 4.81 inside 4.30-5.50
 *       (10% sol). About three years unopened. Lot omitted on the page.
 *       Lab on the COA is not printed here. DTS MG only.
 *   public/documents/PPT/GENOSYS INTENSIVE PROBLEM CONTROL TONER.pdf
 *       DTS MG deck. Allowed quantified lines: about 50% sebum decrease
 *       after 4 weeks; non-comedogenic, tested by QACS Ltd. How-to:
 *       cotton wipe; optional cotton-pad mask 5-10 min; 200 ml 360°
 *       for back and neck. Anti Sebum P = the four extracts. SNOW ICE
 *       = the three cooling amides + caprylic/capric triglyceride.
 *
 * No safety assessment is on file for this formula.
 *
 * THE FORMULA, as finished concentrations that matter on this page:
 *
 *   Aqua                                           83.6535%
 *   Butylene Glycol                                 5.42327%
 *   Glycerin                                        4.975%
 *   Dipropylene Glycol                              3.000%
 *   1,2-Hexanediol                                  1.050%
 *   Pentylene Glycol                                0.600%
 *   Zinc PCA                                        0.500%
 *   Octyldodeceth-16                                0.300%
 *   Trehalose / Panthenol / Allantoin               0.100% each
 *   Methyl Diisopropyl Propionamide                 0.050008%
 *   Ethylhexylglycerin                              0.04995%
 *   Tea tree leaf oil                               0.015%
 *   Tea tree extract                                0.013%
 *   Anti Sebum P four extracts                      0.00125% each (0.005%)
 *   Salicylic Acid                                  0.001%
 *   Sodium Hyaluronate                              0.0005%
 *   Tannic Acid                                     0.00005%
 *   Menthyl Lactate / Ethyl Menthane Carboxamide    0.000014% / 0.000013%
 *
 * Humectant total (BG + glycerin + DPG): about 13.4%. That is the
 * carton "quick hydration". Zinc PCA 0.5% is the named active at a
 * real dose. Everything else sits under that.
 *
 * THE DISTINCTIVE FACT, which is why this page exists.
 *
 * This is an oil-control toner for blemish-prone skin. You apply or
 * spray it morning and evening. It takes excess oil and sebum, then
 * puts water back. Zinc PCA at 0.5% is the figure on the card. The
 * 200 ml bottle is the 360° spray that works upside down on the back.
 * This is not a BHA toner (salicylic acid is 0.001%). This is not
 ...
 *   Excess oil and sebum + quick hydration         artwork front
 *   Blemish-prone skin                             artwork front
 *   Apply or spray sufficiently AM/PM              artwork application
 *   360° spray, upside down for the back           200 ml artwork
 *   Dermatologically tested                        artwork
 *   Zinc PCA 0.5% and every percentage above       Formula
 *   About 50% sebum / 4 weeks                      DTS MG deck
 *   Non-comedogenic, QACS Ltd.                     DTS MG deck
 *   Cotton wipe + optional 5-10 min pads           DTS MG how-to
 *   pH 4.81, specification 4.30 to 5.50            COA
 *   Transparent liquid, light yellow               COA
 *   Three years unopened                           COA dates, no lot
 *   12 months after opening                        500 ml bottle PAO
 *   Made in Korea by DTS MG                        formula / artwork
 *
 * DELIBERATE OMISSIONS - do not add these without a document:
 *   - COPPER TRIPEPTIDE-1 as an ingredient. Not on the registered
 *     Formula INCI. Deck 68.2% / 79.96% figures sit next to a premix
 ...
 *   - ALL SKIN TYPES / SENSITIVE. The carton is blemish-prone.
 *   - ACNE AS A DRUG / ANTIMICROBIAL AS MEDICINE. Function is oil
 *     control. Blemish-prone is the audience, not a treatment claim.
 *   - pH REBALANCE as the purpose. Sodium citrate is a pH adjuster.
 *     The carton function is oil control.
 *   - FRAGRANCE-FREE. Tea tree leaf oil 0.015% plus cooling amides.
 *   - LOT CODES. Never print MG001.
