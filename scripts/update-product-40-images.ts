/**
 * Update product 40 (MULTI SUN CREAM SPF 40) to the new
 * public/images/sun/ set (main + s1–s6).
 *
 * Dry run:
 *   npx tsx --env-file=.env.local scripts/update-product-40-images.ts
 * Apply:
...
const NEW_MAIN = '/images/sun/main.jpeg'
const NEW_GALLERY = [
  '/images/sun/s1.jpeg',
  '/images/sun/s2.jpeg',
  '/images/sun/s3.jpeg',
...
const OLD_IMAGES = [
  '/images/SSUN.jpg',
  'https://genosys.ae/images/SSUN.jpg',
  'https://www.genosys.ae/images/SSUN.jpg',
  '/images/Second/40big.jpg',
  'https://genosys.ae/images/Second/40big.jpg',
  'https://www.genosys.ae/images/Second/40big.jpg',
]

async function main() {
  const p = await prisma.product.findFirst({
    where: { OR: [{ id: '40' }, { productNumber: '40' }] },
  ...
  if (dryRun) {
    ...
    console.log('orderItems for product 40 total:', byProduct)
    return
  }
