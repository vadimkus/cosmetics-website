...
/**
 * Dr. Valeria Borscheva — paymentin @ shipment 06551 / invoice 04828.
 * Order GENCardM2607169446 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-paymentin-04828-20260716.js
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-paymentin-04828-20260716.js --commit
 */
...
const MARKER = 'BORSCHEVA-PAYMENTIN-04828-2026-07-16'

const PAYMENT = {
  amountMinor: 37200,
  invoiceName: '04828',
  invoiceId: '6067985f-80ee-11f1-0a80-15c00013b505',
  shipmentName: '06551',
  shipmentId: '611f8ddb-80ee-11f1-0a80-1b5900149534',
  orderName: 'GENCardM2607169446',
  orderId: '602b5898-80ee-11f1-0a80-0820001445c2',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Dr. Valeria Borscheva — paymentin @ 04828 / 06551')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Clinic order paid — SPF40, sea algae x3, collagen, cushion beige, delivery.',
    ].join(' | '),
    operations: [
      {
        meta: {
