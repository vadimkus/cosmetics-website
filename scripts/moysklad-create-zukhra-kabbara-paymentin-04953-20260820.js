...
/**
 * Miss Zukhra Kabbara — paymentin @ shipment 06713 / invoice 04953.
 * 705 AED. Order GENCardM2608203505 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-zukhra-kabbara-paymentin-04953-20260820.js
 *   node --import dotenv/config scripts/moysklad-create-zukhra-kabbara-paymentin-04953-20260820.js --commit
 */
...
const MARKER = 'ZUKHRA-KABBARA-PAYMENTIN-04953-2026-08-20'

const PAYMENT = {
  amountMinor: 70500,
  invoiceName: '04953',
  invoiceId: '1ee164f7-9c64-11f1-0a80-084e001760b0',
  shipmentName: '06713',
  shipmentId: '2022eddc-9c64-11f1-0a80-09fc0018c27e',
  orderName: 'GENCardM2608203505',
  orderId: '1e781459-9c64-11f1-0a80-09fc0018c1e4',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Zukhra Kabbara — paymentin @ 04953 / 06713')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Clinic order paid — CERABARRIER 200, eye cream, barrier cream, SPF40. Delivery free.',
    ].join(' | '),
    operations: [
      {
        meta: {
