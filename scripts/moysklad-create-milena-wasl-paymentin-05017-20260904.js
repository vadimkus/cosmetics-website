...
/**
 * Milena Al Wasl — paymentin @ shipment 06803 / invoice 05017.
 * 1,500 AED. Order GENCardM260903MILW → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-milena-wasl-paymentin-05017-20260904.js
 *   node --import dotenv/config scripts/moysklad-create-milena-wasl-paymentin-05017-20260904.js --commit
 */
...
const AGENT_ID = '10d5bed0-c15e-11f0-0a80-1aae00102afc'
const STATE_ORDER_DELIVERED_ID = 'e1a0ae5f-33c5-11ea-0a80-043f000b275e'

const MARKER = `MILENA-WASL-PAYMENTIN-05017-${uaeToday()}`

const PAYMENT = {
  amountMinor: 150000,
  invoiceName: '05017',
  invoiceId: '1f58c710-a799-11f1-0a80-143f002a7356',
  shipmentName: '06803',
  shipmentId: '2022c7b1-a799-11f1-0a80-0bf6002a50f2',
  orderName: 'GENCardM260903MILW',
  orderId: '1f01052b-a799-11f1-0a80-0e60002c5cd1',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Milena Wasl — paymentin @ 05017 / 06803')
  console.log('====================================================================')
  ...
  if (!/milena aesthetic clinic/i.test(order.agent?.name || '')) {
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      `Order ${PAYMENT.orderName} — 1,500 AED.`,
    ].join(' | '),
    operations: [
      {
        meta: {
