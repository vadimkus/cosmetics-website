...
/**
 * Sales bonus payout to Vadim Sagatdinov — 1,000.00 AED (28 Aug 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-1000-20260828.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-1000-20260828.js --commit
 */
...
const SUM_MINOR = 100000
const MARKER = `SALES-BONUS-SAGATDINOV-100000-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov — 1,000.00 AED')
  console.log('====================================================================')
