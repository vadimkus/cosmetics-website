...
const AR: BioMesoCopy = {
  ...
  howTo: {
    ...
    steps: [
      ...
      {
        title: 'أنهي العناية بحذر',
        body: 'اتبعي العناية الختامية الموصى بها للأمبولة. لا تفترضي أن قناعاً ورقياً منفصلاً مناسب مباشرة بعد علاج الـ spicules ما لم تنص عبوته أو يوصِ المختص بذلك.',
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'الـ 60000 أمبولة احترافية تحتوي على Hydrolyzed Sponge بنسبة 5.72022% وSodium DNA بتركيز 1,120 جزءاً في المليون. الرقم 60000 لتركيز المركب كاملاً، وليس جرعة PDRN. أما هذه العبوة 5000 فهي منتج عناية منزلية مستقل؛ ولا تفرض العبوتان نظاماً ثنائياً إلزامياً.',
      },
      {
...
const RU: BioMesoCopy = {
  ...
  howTo: {
    ...
    steps: [
      ...
      {
        title: 'Осторожно завершите уход',
        body: 'Следуйте завершающему уходу, рекомендованному для ампулы. Не считайте отдельную тканевую маску подходящей сразу после процедуры со спикулами, если это не указано на её упаковке или специалистом.',
      },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: '60000 - профессиональная ампула с Hydrolyzed Sponge 5,72022% и Sodium DNA 1 120 ppm. Число 60000 относится ко всему комплексу, а не к дозе PDRN. Эта ампула 5000 - самостоятельный домашний продукт; упаковки не устанавливают обязательную двухступенчатую систему.',
      },
      {
...
const AUDITED_AR: BioMesoCopy = {
  ...AR,
  headline: 'تركيبة دقيقة لعناية منزلية أسبوعية.',
  subheadline:
    'أمبولة منزلية بحجم 50 ml تجمع مركب BIO-MESO™ PDRN بتركيز 5,000 جزء في المليون مع Sodium DNA بتركيز 1,010 أجزاء في المليون، وHydrolyzed Sponge بنسبة 0.476685%، ونياسيناميد 2%، وبانثينول 1%، وأدينوزين 0.04%.',
  heroBullets: [
    'يشير 5000 إلى المركب الكامل، وليس إلى جرعة PDRN',
    'Sodium DNA ‏0.101% / 1,010 جزء في المليون',
    'Hydrolyzed Sponge ‏0.476685%',
    'تستخدم مرة أسبوعياً مساءً وفق دليل التدريب',
  ],
  badges: ['صنع في كوريا', '50 ml · صلاحية 12 شهراً بعد الفتح', 'مستحضر كوري ثنائي الوظيفة', 'الموزع الرسمي في الإمارات'],
  stats: [
    { value: '5,000ppm', label: 'مركب BIO-MESO™ PDRN الكامل' },
    { value: '1,010ppm', label: 'Sodium DNA من حليب السلمون' },
    { value: '0.476685%', label: 'Hydrolyzed Sponge' },
    { value: '2% + 0.04%', label: 'نياسيناميد + أدينوزين' },
  ],
  science: {
    eyebrow: 'ما الذي تؤكده المصادر',
    title: 'تركيبة بوظائف واضحة',
    intro:
      'تفصل التركيبة الكمية بين تركيز المركب الكامل وتركيز كل مكوّن رئيسي. ولا تتوفر دراسة فعالية خاصة بهذه الأمبولة، لذلك نلتزم بالوظائف المسجلة والمكوّنات المثبتة.',
    cards: [
      {
        title: 'Hydrolyzed Sponge · 0.476685%',
        body: 'مادة من إسفنج المياه العذبة. توثق التركيبة وجودها ونسبتها من دون إسناد نتائج مستقلة غير مقاسة إليها.',
      },
      {
        title: 'Sodium DNA · 1,010 ppm',
        body: 'مكوّن مصدره حليب السلمون ومدرج بنسبة 0.101%. الرقم 5,000 جزء في المليون لا يصف جرعة Sodium DNA وحده.',
      },
      {
        title: 'نياسيناميد · 2%',
        body: 'المكوّن الوظيفي المرتبط بتسجيل المنتج للمساعدة على تحسين مظهر تجانس اللون.',
      },
      {
        title: 'أدينوزين · 0.04%',
        body: 'المكوّن الوظيفي المرتبط بتسجيل المنتج للعناية بمظهر التجاعيد.',
      },
    ],
    figureAlt: 'تركيبة BIO-MESO PDRN Homecare 5000 وتركيزاتها الموثقة',
  },
  timeline: {
    eyebrow: 'ما الذي قد تشعرين به',
    title: 'استجابة تختلف من بشرة إلى أخرى',
    intro:
      'يذكر دليل التدريب احتمال استمرار الإحساس بالوخز خلال التطبيق ولمدة يومين إلى ثلاثة أيام بعده. وقد يظهر احمرار أو جفاف أو تقشر مؤقت، لكن لا يوجد جدول ثابت من ستة أيام لكل مستخدمة.',
    days: [
      { day: 'مساء التطبيق', title: 'وخز متوقع', body: 'قد تشعرين بوخز أثناء الضغط والتمرير. لا تستخدمي قوة زائدة.' },
      { day: 'اليومان التاليان', title: 'روتين بسيط', body: 'قد يستمر الإحساس بالوخز. تجنبي الأحماض والريتينويدات والمقشرات والأجهزة المهيجة.' },
      { day: 'عند الجفاف', title: 'لا تنزعي القشور', body: 'إذا ظهر جفاف أو تقشر، اتركيه يزول تلقائياً واستخدمي عناية لطيفة.' },
      { day: 'في الصباح', title: 'واقي الشمس', body: 'اختمي روتين الصباح بواقي الشمس، خصوصاً عند وجود احمرار أو جفاف.' },
    ],
    note: 'أوقفي الاستخدام وراجعي الطبيب عند احمرار أو تورم أو تهيج شديد أو مستمر.',
  },
  complex: {
    eyebrow: 'داخل الأمبولة',
    title: 'ماذا يعني الرقم 5000',
    body:
      'يشير الرقم إلى تركيز مركب BIO-MESO™ PDRN الكامل. أما Sodium DNA نفسه فمحدد بوضوح عند 1,010 أجزاء في المليون.',
    points: [
      {
        title: 'بانثينول · 1%',
        body: 'يعادل 10,000 جزء في المليون في التركيبة الكمية المسجلة.',
      },
      {
        title: 'تسعة ببتيدات',
        body: 'تشمل sh-Oligopeptide-1 وثمانية ببتيدات أخرى. وجودها مثبت، لكن تراكيزها ضئيلة ولا توجد نتيجة مستقلة مثبتة لها في هذه الأمبولة.',
      },
      {
        title: 'خمسة سيراميدات',
        body: 'Ceramide NP وEOP وAS وAP وNS موجودة بتراكيز ضئيلة؛ لا ننسب إليها نتيجة مستقلة غير مقاسة.',
      },
      {
        title: 'كولاجين وإيلاستين',
        body: 'موجودان في قائمة INCI بتراكيز ضئيلة. وجودهما لا يثبت ارتفاع مستواهما في البشرة.',
      },
    ],
  },
  howTo: {
    eyebrow: 'طريقة الاستخدام',
    title: 'أربع خطوات موثقة',
    frequency: 'مرة أسبوعياً · مساءً',
    steps: [
      { title: 'نظفي البشرة', body: 'استخدمي المنتج مساءً على بشرة نظيفة، مع تجنب محيط العينين والشفتين.' },
      { title: 'ضعي نحو 3 ml', body: 'وزعي نحو 3 ml بالتساوي على الوجه.' },
      { title: 'اضغطي ومرري', body: 'اضغطي بلطف بالراحتين أو الأصابع، ثم دلكي بحركة تمرير لنحو 30 ثانية.' },
      { title: 'ضعي القناع', body: 'ضعي Skin Reboot PDRN Mask مباشرة بعد الأمبولة لمدة 10-15 دقيقة، ثم أكملي العناية.' },
    ],
    note: 'لا تجمعي الأمبولة مع رولر الوخز أو الأحماض أو الريتينويدات أو المقشرات أو الأجهزة المهيجة في الجلسة نفسها.',
  },
  actives: {
    eyebrow: 'التركيبة',
    title: 'التركيز قبل الوعد',
    intro:
      'نعرض المكوّنات المثبتة ونسبها حيث تتوفر. وجود الببتيدات وEGF والكولاجين والإيلاستين والسيراميدات لا يُقدّم كدليل على نتيجة مستقلة.',
    fullInci: 'قائمة المكوّنات الكاملة (INCI)',
    fullInciNote: 'القائمة بالترتيب المطبوع على العبوة.',
  },
  lab: {
    eyebrow: 'ضبط الجودة',
    title: 'مصنوع ومختبر في كوريا',
    intro: 'تؤكد شهادة تحليل الدفعة الهوية والحجم والرقم الهيدروجيني والفحوص الميكروبية.',
    rows: [
      { label: 'القوام', value: 'لوشن أبيض معتم' },
      { label: 'الحجم الاسمي', value: '50 ml' },
      { label: 'الرقم الهيدروجيني المقاس', value: '6.77 ضمن مواصفة 5.60-7.60' },
      { label: 'الفحوص الميكروبية', value: 'لم تُكتشف E. coli أو P. aeruginosa أو S. aureus أو C. albicans' },
      { label: 'الصلاحية بعد الفتح', value: '12 شهراً' },
    ],
    disclaimer: 'هذه مواصفات جودة للدفعة، وليست دراسة فعالية سريرية. لا تتوفر دراسة فعالية خاصة بالمنتج 65.',
  },
  safety: {
    eyebrow: 'قبل الاستخدام',
    title: 'متى يجب تجنبه',
    points: [
      'للاستخدام الخارجي فقط. تجنبي محيط العينين والشفتين، واشطفي بالماء البارد عند الملامسة.',
      'لا يستخدم مع حب الشباب البثري أو الوردية النشطة أو العدوى أو الجروح المفتوحة أو فرط الحساسية الشديد.',
      'تجنبيه بعد إجراء جلدي حديث أو مع حروق الشمس أو التسمير الحديث أو أمراض المناعة الذاتية الجلدية.',
      'خلال الحمل أو الرضاعة، استشيري الطبيب قبل الاستخدام.',
    ],
    note: 'يحفظ في مكان بارد وجاف بعيداً عن الشمس المباشرة ومتناول الأطفال. يستخدم خلال 12 شهراً من الفتح.',
  },
  routine: {
    ...AR.routine,
    intro: 'نظفي البشرة، ثم استخدمي الأمبولة، وضعي Skin Reboot PDRN Mask لمدة 10-15 دقيقة، ثم أكملي العناية اللطيفة.',
  },
  faq: {
    eyebrow: 'أسئلة',
    title: 'معلومات مهمة',
    items: [
      { q: 'كم مرة أستخدمها؟', a: 'يوصي دليل التدريب باستخدامها مرة واحدة أسبوعياً مساءً. لا تضاعفي التكرار إذا لم يظهر تقشر.' },
      { q: 'هل الوخز طبيعي؟', a: 'قد يظهر وخز أثناء الاستخدام ولمدة يومين إلى ثلاثة أيام بعده. أوقفي الاستخدام عند احمرار أو تورم أو تهيج شديد أو مستمر.' },
      { q: 'هل أستخدم رولر معها؟', a: 'لا. استخدمي الأمبولة وحدها ولا تجمعيها مع رولر الوخز أو أي جهاز مهيج في الجلسة نفسها.' },
      { q: 'ماذا يعني 5000؟', a: 'يشير إلى مركب BIO-MESO™ PDRN الكامل بتركيز 5,000 جزء في المليون. Sodium DNA وحده موجود بنسبة 0.101% / 1,010 جزء في المليون.' },
      { q: 'هل التقشر مضمون؟', a: 'لا. قد يظهر جفاف أو تقشر مؤقت، لكن الاستجابة تختلف ولا يوجد جدول ثابت لستة أيام لكل بشرة.' },
      { q: 'هل توجد دراسة فعالية لهذه الأمبولة؟', a: 'لا تتوفر دراسة فعالية خاصة بالمنتج 65. لذلك لا نعرض نسب تحسن أو ننسب نتائج مستقلة للمكوّنات الأثرية.' },
    ],
  },
  details: {
    ...AR.details,
    rows: [
      { label: 'الشكل', value: 'أمبولة للعناية المنزلية' },
      { label: 'الحجم', value: '50 ml' },
      { label: 'الرمز المرجعي', value: 'GCAP01' },
      { label: 'المركب', value: 'BIO-MESO™ PDRN بتركيز 5,000 جزء في المليون' },
      { label: 'التكرار', value: 'مرة أسبوعياً مساءً وفق دليل التدريب' },
      { label: 'الصلاحية بعد الفتح', value: '12 شهراً' },
      { label: 'بلد المنشأ', value: 'كوريا الجنوبية' },
    ],
  },
...
const AUDITED_RU: BioMesoCopy = {
  ...RU,
  headline: 'Точная формула для еженедельного домашнего ухода.',
  subheadline:
    'Домашняя ампула объёмом 50 ml: комплекс BIO-MESO™ PDRN 5 000 ppm, Sodium DNA 1 010 ppm, Hydrolyzed Sponge 0,476685%, ниацинамид 2%, пантенол 1% и аденозин 0,04%.',
  heroBullets: [
    '5000 - концентрация полного комплекса, а не доза PDRN',
    'Sodium DNA 0,101% / 1 010 ppm',
    'Hydrolyzed Sponge 0,476685%',
    'Раз в неделю вечером по учебному протоколу',
  ],
  badges: ['Сделано в Корее', '50 ml · 12 месяцев после вскрытия', 'Корейское двойное функциональное средство', 'Официальный дистрибьютор в ОАЭ'],
  stats: [
    { value: '5 000ppm', label: 'Полный комплекс BIO-MESO™ PDRN' },
    { value: '1 010ppm', label: 'Sodium DNA из молок лосося' },
    { value: '0,476685%', label: 'Hydrolyzed Sponge' },
    { value: '2% + 0,04%', label: 'Ниацинамид + аденозин' },
  ],
  science: {
    eyebrow: 'Что подтверждают источники',
    title: 'Формула с понятными функциями',
    intro:
      'Количественная формула разделяет концентрацию полного комплекса и дозы ключевых компонентов. Отдельного исследования эффективности этой ампулы нет, поэтому здесь только зарегистрированные функции и подтверждённый состав.',
    cards: [
      {
        title: 'Hydrolyzed Sponge · 0,476685%',
        body: 'Материал из пресноводной губки. Формула подтверждает присутствие и точную долю, но не отдельный измеренный результат этого компонента.',
      },
      {
        title: 'Sodium DNA · 1 010 ppm',
        body: 'Компонент из молок лосося содержится в концентрации 0,101%. Число 5 000 ppm не означает дозу одного Sodium DNA.',
      },
      {
        title: 'Ниацинамид · 2%',
        body: 'Функциональный компонент, связанный с корейской регистрацией средства для осветляющего ухода.',
      },
      {
        title: 'Аденозин · 0,04%',
        body: 'Функциональный компонент, связанный с корейской регистрацией ухода за видимыми морщинами.',
      },
    ],
    figureAlt: 'Формула BIO-MESO PDRN Homecare 5000 и её подтверждённые концентрации',
  },
  timeline: {
    eyebrow: 'Возможные ощущения',
    title: 'Реакция кожи индивидуальна',
    intro:
      'Учебный материал предупреждает о покалывании во время применения и в течение двух-трёх дней после него. Возможны временные покраснение, сухость или шелушение, но фиксированного шестидневного сценария для каждого пользователя нет.',
    days: [
      { day: 'Вечер применения', title: 'Ожидаемое покалывание', body: 'Во время прижатия и роллинга может ощущаться покалывание. Не усиливайте давление.' },
      { day: 'Следующие два дня', title: 'Простой уход', body: 'Покалывание может сохраняться. Исключите кислоты, ретиноиды, пилинги и раздражающие аппаратные процедуры.' },
      { day: 'При сухости', title: 'Не сдирайте шелушение', body: 'Если появилась сухость или шелушение, дайте коже восстановиться самостоятельно и используйте мягкий уход.' },
      { day: 'Утром', title: 'Солнцезащита', body: 'Завершайте утренний уход солнцезащитным средством, особенно при покраснении или сухости.' },
    ],
    note: 'При выраженном или сохраняющемся покраснении, отёке либо раздражении прекратите применение и обратитесь к врачу.',
  },
  complex: {
    eyebrow: 'Внутри ампулы',
    title: 'Что означает число 5000',
    body:
      'Это концентрация полного комплекса BIO-MESO™ PDRN. Сам Sodium DNA указан отдельно и составляет 1 010 ppm.',
    points: [
      {
        title: 'Пантенол · 1%',
        body: 'Это 10 000 ppm в зарегистрированной количественной формуле.',
      },
      {
        title: 'Девять пептидов',
        body: 'В составе sh-Oligopeptide-1 и ещё восемь пептидов. Они присутствуют в следовых концентрациях, а отдельный результат для этой ампулы не установлен.',
      },
      {
        title: 'Пять церамидов',
        body: 'Ceramide NP, EOP, AS, AP и NS присутствуют в следовых концентрациях; отдельный измеренный результат им не приписывается.',
      },
      {
        title: 'Коллаген и эластин',
        body: 'Присутствуют в INCI в следовых концентрациях. Их наличие не доказывает повышения их уровня в коже.',
      },
    ],
  },
  howTo: {
    eyebrow: 'Способ применения',
    title: 'Четыре шага по протоколу',
    frequency: 'Раз в неделю · вечером',
    steps: [
      { title: 'Очистите кожу', body: 'Используйте средство вечером на чистой коже, избегая области вокруг глаз и губ.' },
      { title: 'Нанесите около 3 ml', body: 'Равномерно распределите по лицу около 3 ml ампулы.' },
      { title: 'Прижмите и выполните роллинг', body: 'Мягко прижмите ладонями или пальцами, затем массируйте роллинг-движениями около 30 секунд.' },
      { title: 'Нанесите маску', body: 'Сразу после ампулы нанесите Skin Reboot PDRN Mask на 10-15 минут, затем завершите мягкий уход.' },
    ],
    note: 'Не сочетайте ампулу с микроигольчатым роллером, кислотами, ретиноидами, пилингами или раздражающими аппаратными процедурами в один сеанс.',
  },
  actives: {
    eyebrow: 'Формула',
    title: 'Сначала концентрация, потом обещание',
    intro:
      'Показываем подтверждённые компоненты и их дозы там, где они известны. Присутствие пептидов, EGF, коллагена, эластина и церамидов не подаётся как доказательство отдельного результата.',
    fullInci: 'Полный список ингредиентов (INCI)',
    fullInciNote: 'Список в том же порядке, что напечатан на упаковке.',
  },
  lab: {
    eyebrow: 'Контроль качества',
    title: 'Сделано и протестировано в Корее',
    intro: 'Сертификат анализа партии подтверждает идентичность, объём, pH и микробиологические показатели.',
    rows: [
      { label: 'Текстура', value: 'Белый непрозрачный лосьон' },
      { label: 'Номинальный объём', value: '50 ml' },
      { label: 'Измеренный pH', value: '6,77 при спецификации 5,60-7,60' },
      { label: 'Микробиология', value: 'E. coli, P. aeruginosa, S. aureus и C. albicans не обнаружены' },
      { label: 'Срок после вскрытия', value: '12 месяцев' },
    ],
    disclaimer: 'Это показатели качества партии, а не клиническая эффективность. Отдельного исследования эффективности продукта 65 нет.',
  },
  safety: {
    eyebrow: 'Перед применением',
    title: 'Когда средство не подходит',
    points: [
      'Только для наружного применения. Избегайте области вокруг глаз и губ; при попадании промойте прохладной водой.',
      'Не используйте при гнойничковом акне, активной розацеа, инфекции, открытых ранах или выраженной чувствительности.',
      'Не применяйте после недавней процедуры, при солнечном ожоге, свежем загаре или аутоиммунном заболевании кожи.',
      'При беременности или грудном вскармливании сначала проконсультируйтесь с врачом.',
    ],
    note: 'Храните в прохладном сухом месте вдали от прямого солнца и детей. Используйте в течение 12 месяцев после вскрытия.',
  },
  routine: {
    ...RU.routine,
    intro: 'Очистите кожу, нанесите ампулу, затем Skin Reboot PDRN Mask на 10-15 минут и завершите мягкий уход.',
  },
  faq: {
    eyebrow: 'Вопросы',
    title: 'Что важно знать',
    items: [
      { q: 'Как часто использовать?', a: 'Учебный протокол рекомендует один раз в неделю вечером. Не увеличивайте частоту, если шелушения нет.' },
      { q: 'Покалывание нормально?', a: 'Оно возможно во время применения и в течение двух-трёх дней после него. При выраженном или сохраняющемся покраснении, отёке либо раздражении прекратите применение.' },
      { q: 'Можно ли использовать роллер?', a: 'Нет. Используйте ампулу самостоятельно и не сочетайте её с микроигольчатым роллером или другим раздражающим устройством в один сеанс.' },
      { q: 'Что означает 5000?', a: 'Это концентрация полного комплекса BIO-MESO™ PDRN: 5 000 ppm. Сам Sodium DNA содержится в концентрации 0,101% / 1 010 ppm.' },
      { q: 'Шелушение будет обязательно?', a: 'Нет. Возможны временные сухость или шелушение, но реакция индивидуальна, и фиксированного шестидневного сценария нет.' },
      { q: 'Есть ли исследование эффективности?', a: 'Отдельного исследования эффективности продукта 65 нет. Поэтому здесь нет процентов улучшения или самостоятельных обещаний для следовых компонентов.' },
    ],
  },
  details: {
    ...RU.details,
    rows: [
      { label: 'Формат', value: 'Ампула для домашнего ухода' },
      { label: 'Объём', value: '50 ml' },
      { label: 'Артикул', value: 'GCAP01' },
      { label: 'Комплекс', value: 'BIO-MESO™ PDRN 5 000 ppm' },
      { label: 'Частота', value: 'Раз в неделю вечером по учебному протоколу' },
      { label: 'Срок после вскрытия', value: '12 месяцев' },
      { label: 'Происхождение', value: 'Южная Корея' },
    ],
  },
...
const BY_LOCALE: Record<BioMesoLocale, BioMesoCopy> = { en: EN, ar: AUDITED_AR, ru: AUDITED_RU }
