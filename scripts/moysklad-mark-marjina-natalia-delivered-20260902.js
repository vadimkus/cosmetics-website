...
/**
 * 2 Sep — mark two paid website SOs Доставлен in MoySklad only.
 *
 *   Marjina Alihanova GENCardM2609018903 — 1,071.00
 *   Natalia Goncharova GENCardW2609011986 — 1,077.01
 *
 *   node --import dotenv/config scripts/moysklad-mark-marjina-natalia-delivered-20260902.js
 *   node --import dotenv/config scripts/moysklad-mark-marjina-natalia-delivered-20260902.js --commit
 */
...
const ORDERS = [
  {
    name: 'GENCardM2609018903',
    customer: 'Marjina Alihanova',
    id: 'ecb08b2f-a601-11f1-0a80-091b003b7120',
    expectedMinor: 107100,
  },
  {
    name: 'GENCardW2609011986',
    customer: 'Natalia Goncharova',
    id: '7e2a91eb-a5eb-11f1-0a80-0bea0032b20d',
    expectedMinor: 107701,
  },
]
...
async function main() {
  console.log('====================================================================')
  console.log('  Mark Marjina + Natalia Доставлен — MoySklad only')
  console.log('====================================================================')
