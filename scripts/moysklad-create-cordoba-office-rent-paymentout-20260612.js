...
/**
 * Cordoba Residence — monthly office rent paymentout (same as prior months).
 *
 * Template: paymentout 00601 (2026-05-20) — 14 208.30 AED, expense "Office monthly rent".
 *
 *   node --import dotenv/config scripts/moysklad-create-cordoba-office-rent-paymentout-20260612.js
 *   node --import dotenv/config scripts/moysklad-create-cordoba-office-rent-paymentout-20260612.js --commit
 */
...
async function ensureNoDuplicate() {
  ...
  if (monthDup) {
    throw new Error(`June rent already posted (${monthDup.name}, ${monthDup.moment}, id=${monthDup.id})`)
  }
}
