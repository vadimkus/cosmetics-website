...
/**
 * Final script to create the blog post using raw SQL approach
...
const blogPostData = {
  ...
  published: true,
  tags: '["payments", "stripe", "apple-pay", "google-pay", "checkout", "ecommerce", "security", "technology"]'
}
...
async function createBlogPost() {
  try {
    ...
    const existingCheck = await client.query(
      'SELECT id, slug FROM blog_posts WHERE slug = $1',
      [blogPostData.slug]
    )
    ...
    if (existingCheck.rows.length > 0) {
      ...
      console.log('')
      console.log('📱 URLs:')
      console.log(`🇬🇧 English: https://genosys.ae/blog/${existing.slug}`)
      console.log(`🇷🇺 Russian: https://genosys.ae/ru/blog/${existing.slug}`)
      console.log(`🇸🇦 Arabic: https://genosys.ae/ar/blog/${existing.slug}`)
      return existing
    }
    ...
    const insertQuery = `
      INSERT INTO blog_posts (
        ...
        "titleRu", "excerptRu", "contentRu", views
      ) VALUES (
        gen_random_uuid(), $1, $2, $3, $4, $5, $6, NOW(), NOW(), NOW(), $7, $8, $9, $10, $11, $12, $13, 0
      ) RETURNING id, slug
    `
    ...
    const values = [
      ...
      blogPostData.published,
      blogPostData.tags,
      blogPostData.titleAr,
      blogPostData.excerptAr,
      blogPostData.contentAr,
      blogPostData.titleRu,
      blogPostData.excerptRu,
      blogPostData.contentRu
    ]
