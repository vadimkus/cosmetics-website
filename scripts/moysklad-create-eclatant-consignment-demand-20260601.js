...
/**
 * ECLATANT&CO — consignment Отгрузка under agreement 18.
 *
 * Snow O2 Cleanser, Snow Booster Toner, Cushions Ivory/Beige,
 * Ultra Shield SPF50, Post Cream 20g, Eye Peptide Gel Patch — all ×2.
 *
 *   node --import dotenv/config scripts/moysklad-create-eclatant-consignment-demand-20260601.js
...
async function main() {
  ...
  console.log('\n  Lines (×2 each, clinic salePrice VAT incl.):')
  ...
  const created = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      'Snow cleanser/toner, cushions Ivory+Beige, SPF50, post cream 20g, eye patches — all x2.',
    ].join('\n'),
