 ...
 *   Order comment: Abu Dhabi Branch
 *   State: Доставлен - Ждем оплату
 *   Invoice Legal_TAX PDF → ~/Desktop/orders/
 *
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-abu-dhabi-20260805.js
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-abu-dhabi-20260805.js --commit
 */
...
async function main() {
  ...
  const outPath = path.join(ordersDir, `GENOSYS_Brau_Ladies_Abu_Dhabi_Branch_${safeInv}.pdf`)
