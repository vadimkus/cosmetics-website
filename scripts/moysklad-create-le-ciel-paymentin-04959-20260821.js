...
/**
 * Le Ciel — paymentin @ shipment 06721 / invoice 04959.
 * 345 AED. Order GENCardM260821CIELBG2 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-le-ciel-paymentin-04959-20260821.js
 *   node --import dotenv/config scripts/moysklad-create-le-ciel-paymentin-04959-20260821.js --commit
 */
...
const MARKER = 'LE-CIEL-PAYMENTIN-04959-2026-08-21'

const PAYMENT = {
  amountMinor: 34500,
  invoiceName: '04959',
  invoiceId: 'bcef7aef-9d34-11f1-0a80-1606001e4eb9',
  shipmentName: '06721',
  shipmentId: 'be4f15b6-9d34-11f1-0a80-1a67001ea361',
  orderName: 'GENCardM260821CIELBG2',
  orderId: 'bc703a8f-9d34-11f1-0a80-197a001df84b',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Le Ciel — paymentin @ 04959 / 06721')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Clinic order paid — beige cushion x2 @150, delivery 45.',
    ].join(' | '),
    operations: [
      {
        meta: {
