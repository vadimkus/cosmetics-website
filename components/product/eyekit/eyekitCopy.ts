...
const AR: EyeKitCopy = {
    ...
    items: [
      {
        ...
        productNumber: '17',
        quantity: 1,
        step: 'الخطوة 1 · الطبقة الأولى',
        body: 'السيروم المكثّف الذي يُترك. التجاعيد العميقة والهالات وانتفاخ العين. أربوتين 2% هو الرقم الذي يستحق بطاقة. أدينوزين 0.04% زوج العناية بالتجاعيد. ثم تمرّرين الرولر.',
        facts: ['10 مل', 'أربوتين 2%', 'أدينوزين 0.04%', 'يُترك'],
      },
      {
        id: 'roller',
        title: 'GENOSYS EYE ROLLER',
      ...
      },
      {
        ...
        quantity: 1,
        step: 'الخطوة 3 · الختم',
        body: 'الكريم اليومي بعد رفع اللصقات. نفس الزوج الوظيفي الكوري في السيروم: أربوتين 2% وأدينوزين 0.04%. فيه زيت الفول السوداني وإستر ريتينيل بالميتات. زيت قشر البرتقال والليمونين موجودان، فليس خالياً من العطر.',
  ...
  evidence: {
    ...
    cards: [
      {
        ...
        body: 'أربوتين 2% وأدينوزين 0.04%. الزوج الوظيفي الكوري على المستحضرين اللذين يُتركان. الببتيدات عند أثر تجميلي. هالوكسيل اسم خليط جاهز، لا المحرّك.',
      },
      {
        value: '2% + 0.04%',
        title: 'اللصقات',
    ...
    footnote:
      'لا توجد دراسة فعالية على مستوى الطقم. لا تقرئي "10 Years Back" على العبوات كنتيجة مقيسة. هذا ليس طقم ببتيد ولا قصة بديل للبوتوكس.',
  },
  suited: {
    eyebrow: 'لمن هو',
    ...
    alternatives: [
      { productNumber: '17', label: 'سيروم محيط العين' },
      { productNumber: '24', label: 'كريم محيط العين' },
...
const RU: EyeKitCopy = {
    ...
    items: [
      {
        ...
        productNumber: '17',
        quantity: 1,
        step: 'Шаг 1 · Первый слой',
        body: 'Интенсивная сыворотка, которую оставляют. Глубокие морщины, тёмные круги и припухлость. Арбутин 2% это цифра для карточки. Аденозин 0,04% пара для морщин. Затем роллер.',
        facts: ['10 мл', 'Арбутин 2%', 'Аденозин 0,04%', 'Оставить'],
      },
      {
        id: 'roller',
        title: 'GENOSYS EYE ROLLER',
      ...
      },
      {
        ...
        productNumber: '24',
        quantity: 1,
        step: 'Шаг 3 · Закрепить',
        body: 'Ежедневный крем после снятия патчей. Та же корейская функциональная пара, что в сыворотке: арбутин 2% и аденозин 0,04%. Содержит арахисовое масло и эфир ретинилпальмитата. Масло цедры апельсина и лимонен есть в формуле, поэтому это не крем без отдушки.',
  ...
  evidence: {
    ...
    cards: [
      {
        ...
        body: 'Арбутин 2% и аденозин 0,04%. Корейская функциональная пара на обоих leave-on. Пептиды в косметическом следе. Haloxyl это имя премикса, не двигатель.',
      },
      {
        value: '2% + 0,04%',
        title: 'Патчи',
    ...
    footnote:
      'Исследования эффективности на уровне набора нет. Надпись «10 Years Back» на упаковках не измеренный результат. Это не пептидный набор и не история про ботокс.',
  },
  suited: {
    ...
    alternatives: [
      { productNumber: '17', label: 'Сыворотка для контура глаз' },
      { productNumber: '24', label: 'Крем для контура глаз' },
