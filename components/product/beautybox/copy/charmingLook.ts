...
const AR: BeautyBoxCopy = {
  ...
  subheadline:
    'الكوشن في قلب هذه المجموعة مسجّل في كوريا كمستحضر ثلاثي الوظيفة: حماية من الأشعة فوق البنفسجية، وتفتيح، وتحسين التجاعيد، والثلاثة في شهادة واحدة. يبلغ ⁦SPF50+ PA++++⁩ بخمسة فلاتر، ويحمل نياسيناميد 2% وأدينوزين 0.04% أثناء التغطية. وحوله: منظّف الأكسجين، والتونر الخالي من العطر، ومزيل مكياج ثنائي الطور لمنطقة العين، وقناع ليلي بوزن 100 غرام.',
  heroBullets: [
  ...
  suited: {
    ...
    notForList: [
      ...
      'كان العطر مشكلة لك. التونر وحده خالٍ من العطر، وكل مجموعات GENOSYS مبنيّة حول المنظّف المعطّر نفسه، فاشترِ القطع منفردة',
...
const RU: BeautyBoxCopy = {
  ...
  suited: {
    ...
    notForList: [
      ...
      'Ароматизаторы для вас проблема. Без ароматизаторов только тоник, а все наборы GENOSYS собраны вокруг одного и того же ароматизированного очищающего геля, поэтому берите продукты по отдельности',
