...
/**
 * Dr. Valeria Borscheva — paymentin @ shipment 06703 / invoice 04947.
 * Order GENCardM260819VBSO → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-paymentin-04947-20260819.js
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-paymentin-04947-20260819.js --commit
 */
...
const MARKER = 'BORSCHEVA-PAYMENTIN-04947-2026-08-19'

const PAYMENT = {
  amountMinor: 55500,
  invoiceName: '04947',
  invoiceId: '6884fb33-9b97-11f1-0a80-0cbf0017b36b',
  shipmentName: '06703',
  shipmentId: '6a106d05-9b97-11f1-0a80-1eaf00179224',
  orderName: 'GENCardM260819VBSO',
  orderId: '6813b0b0-9b97-11f1-0a80-196f0016ad84',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Dr. Valeria Borscheva — paymentin @ 04947 / 06703')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Clinic order paid — beige x2, SPF40 x2, delivery.',
    ].join(' | '),
    operations: [
      {
        meta: {
