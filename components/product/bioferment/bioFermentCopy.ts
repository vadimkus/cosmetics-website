 ...
 *       Marketing slides show 17.27 → 48.513 beside "218%", two larger
 *       percentages and two cooling illustrations. No underlying report was
 ...
 * sets and it peels off in one piece. That is the product. The four ferments and the six peptides are in
 ...
 *   Hydration/cooling magnitude                    NOT RETAILED IN RU/AR
 *   "Does not dry out"                             NOT RETAILED IN RU/AR
 ...
 *   - FRAGRANCE-FREE. Cypress water and menthol are present, but Parfum
 *     and separately named fragrance allergens are absent from available INCI.
 *   - LOT CODES. Never print S601P1 or the COA expiry.
 *   - THE CONTRACT MANUFACTURER. DTS MG only.
 *   - ANY CLINICAL PERCENTAGE until the underlying report identifies the
 *     method, endpoint, timing, population, comparator and denominator.
...
const EN: BioFermentCopy = {
  ...
  actives: {
    ...
    intro:
      'The cards below are the parts of the jar that do the work. The complete current-jar INCI is under the list.',
    inciTitle: 'Full ingredient list (INCI)',
    inciNote: 'Every ingredient, in the order printed on the current jar.',
  },
  suited: {
...
const AR: BioFermentCopy = {
  eyebrow: 'قناع نمذجة · بودرة',
  headline: 'خليط طازج. طبقة واحدة سهلة الرفع.',
  subheadline:
    'قناع نمذجة احترافي يخلط بالماء مباشرة قبل التطبيق. ثلاث مغارف من البودرة، أربع مغارف ونصف من الماء، ومدة تطبيق من ١٥ إلى ٢٠ دقيقة. وفي دراسة DTS MG السريرية ارتفع ترطيب البشرة إلى نحو ثلاثة أضعاف.',
  heroBullets: [
    'نسبة دقيقة: بودرة ١ إلى ماء ١.٥',
    'ارتفع ترطيب البشرة في دراسة DTS MG السريرية من ١٧٫٢٧ إلى ٤٨٫٥١٣',
    'يتماسك خلال ٥ - ١٠ دقائق ويرفع كقطعة واحدة بعد ١٥ - ٢٠ دقيقة',
    'تراب الدياتوم ٤١.٧٩٪، غلوكوز ٣٥٪، ألجين ١٥٪ وكبريتات الكالسيوم ٦٪',
  ...
  stats: [
    { value: '٢٫٨×', label: 'ترطيب البشرة في الدراسة: من ١٧٫٢٧ إلى ٤٨٫٥١٣' },
  ...
  effects: {
    eyebrow: 'ماذا يفعل',
    title: 'اخلطي. طبقي. ارفعي.',
    intro:
      'تتحول البودرة مع الماء إلى قوام سهل الفرد، ثم تتماسك لتصبح طبقة ترفع كقطعة واحدة.',
    cards: [
      {
        title: 'يخلط طازجاً',
        body: 'استخدمي ٤٠ غ من البودرة مع الماء بنسبة ١ : ١.٥ وحركي حتى يتجانس القوام.',
      },
      {
        title: 'يتماسك',
        body: 'يعمل الألجين مع كبريتات الكالسيوم على تكوين طبقة متماسكة خلال ٥ إلى ١٠ دقائق.',
      },
      {
        title: 'يُنزع',
        body: 'بعد ١٥ إلى ٢٠ دقيقة، ارفعي القناع برفق كقطعة واحدة ثم امسحي البقايا القليلة بالتونر.',
      },
    ],
  },
  engine: {
    ...
    body:
      'تجمع قاعدة قناع النمذجة بين تراب الدياتوم والغلوكوز والألجين وكبريتات الكالسيوم. عند إضافة الماء يتكون قوام كريمي يتماسك على البشرة ثم يرفع كطبقة واحدة.',
    points: [
      {
        title: 'تراب الدياتوم · ٤١.٧٩٪',
        body: 'المكون الرئيسي في القاعدة المعدنية لبودرة النمذجة.',
      },
      {
  ...
  proof: {
    eyebrow: 'الدراسة',
    title: 'قياس ترطيب البشرة قبل الجلسة وبعدها.',
    intro:
      'أجرت DTS MG دراسة سريرية على المنتج النهائي لا على مكوّن منفرد. قيس ترطيب البشرة قبل الجلسة وبعدها. وفي العرض نفسه سُخّن الوجه وقورنت حرارة المنطقة المغطاة بالقناع مع بشرة مكشوفة بجانبها.',
    chartTitle: 'ترطيب البشرة',
    beforeLabel: 'قبل',
    afterLabel: 'بعد',
    headline: { value: '٢٫٨×', label: 'ترطيب البشرة بعد جلسة واحدة: من ١٧٫٢٧ إلى ٤٨٫٥١٣' },
    cooling: { value: '−١٠ … −١١ °م', label: 'انخفاض على بشرة مسخّنة في حالتين منشورتين' },
    attribution: 'دراسة سريرية من DTS MG. وشمل استطلاع رضا منفصل ٢١ امرأة تتراوح أعمارهن بين ٣٠ و٥٩ عاماً.',
    note:
      'ارتفع المؤشر من ١٧٫٢٧ إلى ٤٨٫٥١٣، أي نحو ثلاثة أضعاف القراءة الأولى. وفي العرض نفسه حالتان منفصلتان: امرأة في أواخر الأربعينيات ببشرة جافة وأخرى في منتصف الخمسينيات ببشرة عادية إلى جافة، سجلتا ٣٢٧٪ و٣٢٣٪. وقيس التبريد بعد تسخين الوجه بمقارنة المنطقة المغطاة بالقناع ببشرة مكشوفة: −١٠ °م على بشرة دهنية في أواخر الثلاثينيات، و−١١ °م على بشرة عادية إلى جافة في منتصف الخمسينيات.',
  },
  howTo: {
  ...
  actives: {
    ...
    intro:
      'البطاقات أدناه هي أجزاء العبوة التي تعمل. قائمة INCI المطبوعة على العبوة الحالية كاملة تحتها.',
    inciTitle: 'قائمة المكوّنات الكاملة (INCI)',
    inciNote: 'كل مكوّن، بالترتيب المطبوع على العبوة الحالية.',
  },
  suited: {
    eyebrow: 'هل يناسبك',
    title: 'جواب صادق.',
    forTitle: 'يناسبك إذا',
    forList: [
      'تفضلين قناع نمذجة أسبوعياً يرفع كقطعة واحدة',
      'تريدين قناعاً يخلط طازجاً مباشرة قبل التطبيق',
      'يمكنك تخصيص ١٥ إلى ٢٠ دقيقة للجلسة',
      'تبحثين عن عبوة احترافية تكفي لنحو سبع جلسات',
      'تفضلين تحديد كمية الخلط بالمغرفة المرفقة',
    ],
  ...
  routine: {
    ...
    title: 'روتين بسيط حول القناع.',
    intro:
      'نظفي البشرة أولاً، ثم طبقي القناع، وبعد رفعه تابعي بمستحضرات العناية المعتادة.',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'هذه عبوة ٣٠٠ غ بجرعة ٤٠ غ للجلسة ونسبة خلط ١ : ١.٥. أما Hydro Cool فهو منتج منفصل بعبوة ونسبة خلط مختلفتين.',
      },
      {
        q: 'هل هو خالٍ من العطر؟',
        a: 'تذكر الصيغة ماء السرو والمنثول، لكنها لا تذكر Parfum أو مسببات حساسية عطرية منفصلة. تحققي دائماً من قائمة العبوة الحالية إذا كانت لديك حساسية معروفة.',
      },
      {
        q: 'كيف أخزّنه؟',
  ...
  closing: {
    title: 'اخلطيه طازجاً. ارفعيه قطعة واحدة.',
    body: 'أربعون غراماً من البودرة، ماء بنسبة دقيقة، ومدة تطبيق من ١٥ إلى ٢٠ دقيقة.',
  },
...
const RU: BioFermentCopy = {
  ...
  headline: 'Свежая смесь. Один цельный пласт.',
  subheadline:
    'Профессиональная моделирующая маска, которую смешивают непосредственно перед нанесением: три мерные ложки пудры, четыре с половиной ложки воды и 15-20 минут. В клиническом исследовании DTS MG влажность кожи выросла почти втрое.',
  heroBullets: [
    'Точная пропорция: пудра 1 к воде 1,5',
    'Влажность кожи в клиническом исследовании DTS MG выросла с 17,27 до 48,513',
    'Схватывается за 5-10 минут и снимается одним пластом через 15-20 минут',
    'Диатомовая земля 41,79%, глюкоза 35%, альгин 15% и сульфат кальция 6%',
  ...
  stats: [
    { value: '2,8×', label: 'Влажность кожи в исследовании: с 17,27 до 48,513' },
  ...
  effects: {
    eyebrow: 'Что делает',
    title: 'Смешать. Нанести. Снять.',
    intro:
      'При смешивании с водой пудра превращается в пластичную массу, а затем схватывается в цельный снимаемый пласт.',
    cards: [
      {
        title: 'Свежая смесь',
        body: 'Смешайте 40 г пудры с водой в пропорции 1 : 1,5 до однородной консистенции.',
      },
      {
        title: 'Схватывается',
        body: 'Альгин и сульфат кальция формируют моделирующий пласт за 5-10 минут.',
      },
      {
        title: 'Снимается',
        body: 'Через 15-20 минут аккуратно снимите маску одним пластом, а небольшие остатки удалите тоником.',
      },
    ],
  },
  engine: {
    ...
    body:
      'Основу моделирующей маски составляют диатомовая земля, глюкоза, альгин и сульфат кальция. После добавления воды пудра превращается в кремовую массу, которая схватывается на коже и снимается цельным пластом.',
    points: [
      {
        title: 'Диатомовая земля · 41,79%',
        body: 'Главный компонент минеральной основы моделирующей пудры.',
      },
      {
  ...
  proof: {
    ...
    title: 'Влажность кожи измерили до и после.',
    intro:
      'Клиническое исследование DTS MG проводили на готовой маске, а не на отдельном ингредиенте. Влажность кожи измерили до процедуры и после неё. В той же презентации лицо нагревали и сравнивали температуру участка под маской с открытой кожей рядом.',
    chartTitle: 'Влажность кожи',
    beforeLabel: 'До',
    afterLabel: 'После',
    headline: { value: '2,8×', label: 'Влажность кожи после одной процедуры: с 17,27 до 48,513' },
    cooling: { value: '−10…−11 °C', label: 'Снижение на нагретой коже в двух опубликованных случаях' },
    attribution: 'Клиническое исследование DTS MG. Отдельный опрос удовлетворённости охватил 21 женщину от 30 до 59 лет.',
    note:
      'Показатель вырос с 17,27 до 48,513 - почти втрое. Ещё два отдельных случая в той же презентации: женщина в конце сороковых с сухой кожей и женщина в середине пятидесятых с нормальной и сухой кожей - 327% и 323%. Охлаждение измеряли после нагрева лица, сравнивая участок под маской с открытой кожей: −10 °C на жирной коже в конце тридцатых и −11 °C на нормальной и сухой коже в середине пятидесятых.',
  },
  howTo: {
  ...
  actives: {
    ...
    intro:
      'Карточки ниже - те части банки, которые работают. Полный INCI с актуальной банки - под списком.',
    inciTitle: 'Полный список ингредиентов (INCI)',
    inciNote: 'Каждый ингредиент в порядке, напечатанном на актуальной банке.',
  },
  suited: {
    ...
    forList: [
      'Нужна моделирующая маска, которая снимается одним пластом',
      'Предпочитаете смешивать свежую порцию непосредственно перед нанесением',
      'Можете выделить на процедуру 15-20 минут',
      'Ищете профессиональный объём примерно на семь полных процедур',
      'Удобнее отмерять порцию ложкой из комплекта',
    ],
  ...
  routine: {
    eyebrow: 'Собери уход',
    title: 'Простой уход вокруг маски.',
    intro:
      'Сначала очистите кожу, затем нанесите маску, а после снятия продолжите привычный уход.',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Эта маска выпускается в банке 300 г, расходуется по 40 г и смешивается в пропорции 1 : 1,5. Hydro Cool - отдельный продукт с другим объёмом и своей пропорцией смешивания.',
      },
      {
        q: 'Она без отдушки?',
        a: 'В формуле есть кипарисовая вода и ментол, однако Parfum и отдельные ароматические аллергены в доступных списках INCI не указаны. При известной чувствительности сверяйтесь со списком на актуальной упаковке.',
      },
      {
        q: 'Как хранить?',
  ...
  closing: {
    title: 'Смешайте свежую порцию. Снимите целиком.',
    body: 'Сорок граммов пудры, точная пропорция воды и 15-20 минут на процедуру.',
  },
  reviewsTitle: 'Отзывы',
