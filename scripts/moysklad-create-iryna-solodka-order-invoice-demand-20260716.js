...
/**
 * Iryna Solodka (Miss Irina Solodkaya) — clinic SO → invoice → shipment + PDF.
 *
 ...
 *   Total: 855 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-iryna-solodka-order-invoice-demand-20260716.js
 *   node --import dotenv/config scripts/moysklad-create-iryna-solodka-order-invoice-demand-20260716.js --commit
 */
...
const ORDER_SUFFIX = '5770'

const ORDER = {
  name: `GENCardM${uaeShortDate()}${ORDER_SUFFIX}`,
  marker: `Iryna Solodka clinic cleanser cushion cream PDRN ${uaeToday()}`,
}
...
const EXPECTED_SUM_MINOR = 85500
...
async function exportInvoicePdf(invoiceId, invoiceName) {
  ...
  const outPath = path.join(ordersDir, `GENOSYS_Iryna_Solodka_${safe}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Iryna Solodka — clinic SO → invoice → shipment + PDF')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00021 cleanser 180ml x1; 00144 cushion beige x2; 00035 problem control cream x1; 54467 PDRN mask x1 @ clinic list; delivery 45 AED.',
