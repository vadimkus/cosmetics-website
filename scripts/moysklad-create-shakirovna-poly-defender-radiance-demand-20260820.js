...
/**
 * SHAKIROVNA POLY CLINIC L.L.C — consignment replenishment into agreement 41.
 *   54461 Skin Defender ×2 @ 145
 *   00122 Multi Vita Radiance Cream 50g ×4 @ 145
 *   Total: 870 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-poly-defender-radiance-demand-20260820.js
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-poly-defender-radiance-demand-20260820.js --commit
 */
...
const AGENT_ID = '932f00c5-96e0-11f1-0a80-0d9b001a5a79'
const CONTRACT_ID = '93cc0951-96e0-11f1-0a80-036000196a36'
const STATE_DEMAND_SHIPPED_ID = '50d70717-4582-11ea-0a80-05e3001273a2'
const STOCK_NOTE_TEMPLATE_ID = '09ef2604-4a14-4571-bc17-dc266c9190c3'
const ORDERS_DIR = path.join(os.homedir(), 'Desktop', 'orders')

const MARKER = `SHAKIROVNA-POLY-DEFENDER-RADIANCE50-${uaeToday()}`

const LINES = [
  ['54461', 2, 145],
  ['00122', 4, 145],
]
const EXPECTED_SUM_MINOR = 87000
...
async function exportStockNotePdf(demandId, demandName) {
  ...
  const out = path.join(ORDERS_DIR, `GENOSYS_SHAKIROVNA_POLY_CLINIC_Consignment_Stock_Note_${demandName}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Shakirovna Poly Clinic — Defender + Radiance 50g into agr. 41')
  console.log('====================================================================')
  ...
  if (agent.name !== 'SHAKIROVNA POLY CLINIC L.L.C') throw new Error(`Unexpected agent: ${agent.name}`)
  if (contract.name !== '41') throw new Error(`Unexpected contract: ${contract.name}`)
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      MARKER,
      'SHAKIROVNA POLY CLINIC L.L.C — Agreement 41.',
      'Replenishment: 54461 Defender x2 @145, 00122 Radiance cream 50g x4 @145. No SO/invoice.',
    ].join('\n'),
    positions,
  })
