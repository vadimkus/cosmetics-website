...
/**
 * Brau Ladies Salon LLC — 2× SO → invoice → shipment @ clinic 38.
 *
 *   1) Brau Springs     — Peptide Gel Mask 00012 ×10  = 380 AED
 *   2) Brau Abu Dhabi   — Peptide Gel Mask 00012 ×20  = 760 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-springs-ad-20260818.js
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-springs-ad-20260818.js --commit
 */
...
function shipmentAddress(orderDef) {
  return {
    ...
    addInfo: `${orderDef.street}, ${orderDef.city}, United Arab Emirates`,
  }
}
...
async function runCycle(orderDef, idx, item, agent) {
  ...
  console.log(`\n────────────────────────────────────────────────────────────`)
  console.log(`  Mark: ${orderDef.comment}`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Brau Ladies — peptide Springs ×10 + Abu Dhabi ×20')
  console.log('====================================================================')
  ...
  if (item.available < need) {
    console.log(`  WARN stock 00012: need ${need}, have ${item.available} — posting anyway`)
  }
