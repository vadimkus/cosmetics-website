...
/**
 * Sales bonus payout to Vadim Sagatdinov — 4,000.00 AED (July 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-4000-20260723.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-4000-20260723.js --commit
 */
...
const SUM_MINOR = 400000 // 4,000.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-JULY-4000-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (July 2026) — 4,000 AED')
  console.log('====================================================================')
