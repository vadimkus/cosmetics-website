...
export const PRODUCT_QUICK_FACTS_CATALOG: Record<string, LocalizedQuickFact[]> = {
  ...
  '51': [
    t('Skin moisture nearly tripled', 'Skin moisture rose from 17.27 to 48.513 in the DTS MG clinical trial.', '40 г на процедуру', 'На одну полную процедуру нужны три мерные ложки пудры.', '40 غ لكل جلسة', 'تستخدم ثلاث مغارف من البودرة لكل جلسة كاملة.'),
