...
/**
 * Miss Alena (Shoreline) — paid retail SO → invoice → shipment → paymentin.
 *
 *   00021 Snow O₂ Cleanser 180ml ×1 @ 330
 *   Excellent Delivery Dubai ×1 @ 45
 *   Total: 375.00 AED
 *
 *   Shoreline 16, PH07, Dubai. Same card as 04997. Not Dudareva DIFC.
 *
 *   node --import dotenv/config scripts/moysklad-create-alena-shoreline-cleanser-paid-20260902.js
 *   node --import dotenv/config scripts/moysklad-create-alena-shoreline-cleanser-paid-20260902.js --commit --print
 */
...
const AGENT_ID = '16f2895a-a51b-11f1-0a80-0cd600c7a2b9'
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}SH16C`,
  moment: uaeMomentNow(),
  marker: `ALENA-SHORELINE-CLEANSER-180-PAID-${uaeToday()}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Alena (Shoreline) — cleanser 180 + delivery, paid + print')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ...
      `Ship: ${CUSTOMER.street}, ${CUSTOMER.city}. Same card as 04997.`,
    ].join('\n'),
