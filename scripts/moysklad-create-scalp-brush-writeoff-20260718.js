 ...
 *   54471 HR³ Matrix Scalp Brush ×2
 *
 *   node --import dotenv/config scripts/moysklad-create-scalp-brush-writeoff-20260718.js
 *   node --import dotenv/config scripts/moysklad-create-scalp-brush-writeoff-20260718.js --commit
 */
...
const MARKER = `SCALP-BRUSH-WRITE-OFF-x2-${uaeToday()}`

const LINES = [['54471', 2, 'HR³ Matrix Scalp Brush']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Write-off — Scalp Brush ×2 @ buyPrice')
  console.log('====================================================================')
  ...
  console.log(`\n  Total buy cost: ${money(totalMinor)} AED | 2 pcs`)
  ...
  const created = await api('POST', '/entity/loss', {
    applicable: true,
    moment: uaeMomentNow(),
    description: [MARKER, 'Warehouse write-off at buyPrice.', '54471 Scalp Brush x2.'].join(' | '),
