...
/**
 * Mr. Nail — new customer + unpaid clinic SO → invoice → shipment.
 *
 *   00190 Multi Functional Anti-Wrinkle Cream 50g ×1 @ 145
 *   00191 Multi Functional Anti-Wrinkle Serum 30ml ×1 @ 165
 *   00188 Microbiome Energy Infusing Mist 80ml ×1 @ 80
 *   00143 Cushion #1 Ivory ×1 @ 150
 *   Delivery Sharjah ×1 @ 70, 100% off
 *   Total: 540.00 AED
 *
 *   Taryam Tower, App 412, Sharjah
 *   Phone +971 50 572 7337
 *
 *   node --import dotenv/config scripts/moysklad-create-mr-nail-sharjah-clinic-20260823.js
 *   node --import dotenv/config scripts/moysklad-create-mr-nail-sharjah-clinic-20260823.js --commit
 */
...
const CUSTOMER = {
  ...
  phone: '+971 50 572 7337',
  city: 'Sharjah',
  street: 'Taryam Tower, App 412',
}

const ORDER = {
  name: `GENCardM${uaeShortDate()}NAIL`,
  marker: `MR-NAIL-SHARJAH-MF-MIST-IVORY-${uaeToday()}`,
}
...
function customerPayload() {
  return {
    ...
    description: [
      'Nail master, Taryam Tower App 412, Sharjah.',
      `Phone ${CUSTOMER.phone}.`,
    ].join(' '),
  }
}
...
function isThisCustomer(row) {
  ...
  return digits.endsWith('505727337') || name === 'mr. nail' || name === 'mr nail'
}

async function findOrCreateCustomer() {
  for (const q of ['Mr. Nail', 'Mr Nail', '505727337', '0505727337']) {
...
async function exportInvoicePdf(invoiceId, invoiceName) {
  ...
  const out = path.join(ORDERS_DIR, `GENOSYS_Mr_Nail_${safe}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Mr. Nail — MF cream/serum + mist + Ivory, Sharjah delivery free')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00190 MF cream 50g x1 @145; 00191 MF serum x1 @165; 00188 mist x1 @80; 00143 Ivory x1 @150; Sharjah delivery free. Clinic list. Unpaid.',
