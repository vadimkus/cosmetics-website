 ...
 *
 *   00050 HR³ Matrix Scalp Peeling 100ml ×1 @ 145 clinic
 *   Excellent Delivery Dubai ×1 @ 45
 *   Total: 190.00 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-family-class-scalp-peeling-order-20260806.js
 *   node --import dotenv/config scripts/moysklad-create-family-class-scalp-peeling-order-20260806.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}FCSP`,
  moment: uaeMomentNow(),
  marker: `FAMILY-CLASS-SCALP-PEELING-DELIVERY-${uaeToday()}`,
}
...
const EXPECTED_SUM_MINOR = 19000 // 145 + 45
...
async function main() {
  console.log('====================================================================')
  console.log('  FAMILY CLASS POLY CLINIC — scalp peeling ×1 + delivery 45')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00050 Scalp Peeling x1 @145; delivery 45 AED.',
    ].join(' | '),
