...
/**
 * Sales bonus payout to Vadim Sagatdinov — 488.00 AED (June 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-june-488-20260713.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-june-488-20260713.js --commit
 */
...
const SUM_MINOR = 48800 // 488.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-JUNE-488-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (June 2026)')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentout', {
    ...
    sum: SUM_MINOR,
    paymentPurpose: `Sales bonus June 2026 ${money(SUM_MINOR)} AED — Sagatdinov [${MARKER}]`,
    description: `Sales bonus>>June 2026 — Sagatdinov | ${MARKER}`,
  })
