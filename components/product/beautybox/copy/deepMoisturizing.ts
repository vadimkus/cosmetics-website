...
const AR: BeautyBoxCopy = {
  ...
  subheadline:
    'خمسة منتجات GENOSYS بالحجم الكامل صُممت للعمل بالتتابع: منظف لا يجفف البشرة، وتونر يعيد توازن الحموضة، وسيروم يجذب الماء، وكريم يحفظه، وثلاثة أقنعة ورقية للأيام التي تشعرين فيها بشد البشرة. شراؤها مجتمعة أقل تكلفة من شراء المنتجات الخمسة نفسها واحداً واحداً.',
  heroBullets: [
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          'تونر يومي لكل أنواع البشرة يرطب ويهدئ بمستخلصات نباتية، ويعيد الحموضة إلى توازنها بعد التنظيف. وهذا مهم هنا، لأن السيروم يعمل على بشرة رطبة.',
      },
      {
        titleKey: 'routineHyaluronSerumTitle',
        productNumber: '18',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'على الأرجح لا. يحتوي المنظف على عطر وليمونين، ويحتوي الكريم على زيت زهرة الجيرانيوم والسيترونيلول والجيرانيول. لا يمثل ذلك مشكلة لمعظم الناس وكله مذكور على الملصقات، لكن إن كان العطر يهيّج بشرتك فلا يوجد صندوق يخلو منه: الصناديق الستة كلها مبنية على المنظف نفسه. اشتري القطع المناسبة لك منفصلة. والتونر في هذا الصندوق خالٍ من العطر.',
      },
      {
...
const RU: BeautyBoxCopy = {
  ...
  subheadline:
    'Пять средств GENOSYS полного объёма, рассчитанных на работу по порядку: очищение, которое не сушит, тоник, который возвращает pH, сыворотка, которая притягивает воду, крем, который её удерживает, и три тканевые маски на дни, когда кожа стянута. Вместе они стоят меньше, чем те же пять средств по одному.',
  heroBullets: [
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        step: 'Шаг 2 - Тоник',
        body:
          'Ежедневный тоник для любого типа кожи: увлажняет и успокаивает растительными экстрактами и возвращает pH после очищения. Здесь это важно, потому что сыворотка работает на влажной коже.',
      },
      {
        titleKey: 'routineHyaluronSerumTitle',
        productNumber: '18',
