"""
Squares the POWER SOLUTION AWS hero shot by continuing its own studio sweep.

WHY. AWS.jpg is 956x662 on a light studio backdrop, same geometry as SWS.jpg
and CVS.jpg. The gallery stage is square and uses object-contain, so the shot
...
SRC = 'public/images/AWS.jpg'
OUT = sys.argv[1] if len(sys.argv) > 1 else 'public/images/aws-hero.jpg'
...
# Lift the sweep toward the cool rose paper the AWS page sits on, without
# chalking the magenta AWS wordmark. Same split as SWS: blur holds the sweep,
...
print(f'  gap to page tint #f7f3f5 at the corners: {gap}/255')
