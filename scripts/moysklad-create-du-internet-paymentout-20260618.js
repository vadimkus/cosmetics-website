...
/**
 * DU — internet monthly (paid today).
 *
 * Template: paymentout 00548 — agent DU, expense "Mobile plan".
 *
 *   node --import dotenv/config scripts/moysklad-create-du-internet-paymentout-20260618.js
 *   node --import dotenv/config scripts/moysklad-create-du-internet-paymentout-20260618.js --commit
 */
...
const DESCRIPTION = `DU office internet monthly>> ${(SUM_MINOR / 100).toFixed(2)}`
const MARKER = `DU-OFFICE-INTERNET-MONTHLY-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  DU — internet monthly (paymentout, paid today)')
  console.log('====================================================================')
