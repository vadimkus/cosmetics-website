# RAKEZ Amendment — Iryna KYC Blocker

Date: 2026-06-02

Context: RAKEZ requested due diligence documents for Iryna Kobzarenko during the Genosys Middle East FZ-LLC corporate amendment. The amendment intended to remove Iryna as manager/director/authorised signatory and transfer her 50 shares to Vadim Sagatdinov, leaving Vadim as 100% shareholder and sole officer.

RAKEZ requested from Iryna:

- Valid UAE or other country residence permit for her current country of residence.
- Two address / residence proofs from lease/title deed, utility bill, and personal bank statement for the latest two months.
- If she resides with a relative or friend, RAKEZ asked for her personal bank statement, a host letter, the host's tenancy/title deed, and host ID.

Issue:

- Vadim has lost contact with Iryna and does not have access to her personal bank statement or current residence documents.
- The bank statement is personal KYC data and should not be fabricated or substituted with another person's document.

Recommended path:

1. Ask RAKEZ immediately whether they can accept an alternative due diligence package because Iryna is an outgoing party and unreachable.
2. Provide signed and stamped corporate documents already available: share transfer resolution, appointment/resignation resolution, and acceptance letter.
3. Provide proof of attempts to contact Iryna: email, WhatsApp, call logs, registered letter or courier attempt to last known address.
4. Ask whether RAKEZ can use Iryna's existing KYC documents already on file from company formation / prior renewal, if any.
5. Ask whether officer/signatory change can be processed separately now, with share transfer held pending if RAKEZ cannot waive outgoing shareholder KYC.
6. If RAKEZ refuses, use a UAE corporate/RAKEZ agent or lawyer to determine whether the signed share transfer can be enforced or whether the amendment must wait until Iryna cooperates.

Key principle: do not submit a forged or third-party bank statement. If RAKEZ insists on Iryna's live KYC, the administrative share transfer may be blocked until she cooperates or a formal legal route is used.

Update 2026-06-03:

- Vadim confirmed the KYC pack is substantially complete and the only missing item is Iryna's latest 2-month personal bank statement.
- Vadim requested it from Iryna; she refused and asked for money. She appears to be outside the UAE and currently in Ukraine.
- Recommended next step: avoid paying an undefined demand. If needed, offer reimbursement only for actual document/bank fees against receipt, after delivery of the statement. In parallel, ask RAKEZ whether they can accept two non-bank address proofs in Iryna's name from Ukraine, or proceed using existing KYC plus proof of refusal/non-cooperation because she is the outgoing party.

Update 2026-06-03 10:43:

- Vadim sent a formal request to Iryna by WhatsApp/email asking for documents to complete the RAKEZ KYC process for Genosys Middle East FZ-LLC.
- Message requested either:
  - current residency/residence document plus any two of lease/title deed, utility bill, or 2-month personal bank statement; or
  - if residence is not in her name, 2-month personal bank statement plus host letter, host tenancy/title deed, and host ID/passport.
- Vadim offered reimbursement only for actual bank document fees after receipt and proof of payment.
- Deadline given: 04.06.2026 18:00 UAE time.
- If no documents/reply are received by the deadline, use the WhatsApp/email screenshots as proof of non-cooperation in the RAKEZ escalation package.

Update 2026-06-03 10:57:

- Iryna replied. She did not provide the requested KYC documents.
- Her reply frames the matter as a business/equity contribution dispute and objects to providing assistance "for free". She asks to separate personal relationship issues from business issues and says she is willing to resolve matters directly and "as adults".
- Interpretation: this is no longer simple silence; it is evidence that Iryna is conditioning cooperation with the RAKEZ KYC/amendment process on a broader business settlement or compensation discussion.
- Recommended response: do not argue about personal matters; acknowledge her position, keep tone calm, ask her to put any business/financial proposal in writing, and restate that the RAKEZ KYC documents are required to complete the formal process. Do not admit liability or agree to undefined payment in WhatsApp.

Update 2026-06-03 11:05:

- Vadim replied to Iryna in a neutral business tone.
- Reply acknowledged her message, asked her to send any concrete Genosys business position/proposal in writing, separated that from the formal RAKEZ KYC process, and stated that actual bank/notary/admin fees for documents can be reimbursed after proof.
- Reply asked her to either provide KYC documents or confirm in writing that she is not ready to provide them.
- No admission of liability or agreement to undefined compensation was made.

Update 2026-06-03 11:08:

- Vadim clarified that he does not want to accept any undefined premise that additional compensation is owed. He believes he has already contributed materially to Iryna personally and professionally over the years.
- Strategic note: the request for Iryna to put any Genosys position/proposal in writing was not a concession. It was intended to move vague grievance/leverage into a concrete written claim that can be assessed separately from the RAKEZ KYC process.

Update 2026-06-03 11:11:

- Iryna replied that she will formulate her position, but that "the process will be in another order: first point 3, then point 2" — meaning she wants the business discussion first, then KYC/document provision.
- She also told Vadim to "listen to your heart, not GPT advice."
- Interpretation: this further supports that KYC cooperation is being conditioned on prior business/financial discussion or settlement.

Update 2026-06-06:

- Vadim received Wio statements from Iryna via WhatsApp and placed them in `/Users/vadimkus/Desktop/Amendment_Rakez/Statements`.
- Verified files:
  - `Monthly statement (2026.04).pdf` — Wio statement, Iryna Kobzarenko, 01/04/2026 to 30/04/2026, 7 pages, IBAN and transaction table present.
  - `Monthly statement (2026.05).pdf` — Wio statement, Iryna Kobzarenko, 01/05/2026 to 31/05/2026, 8 pages, IBAN and transaction table present.
  - `Monthly statement (2026.06).pdf` — Wio statement, Iryna Kobzarenko, 01/06/2026 to 06/06/2026, 4 pages, IBAN and transaction table present.
- Practical use for RAKEZ: upload April and May as the latest two complete monthly statements; include June as supplemental if the portal allows.

Update 2026-06-06 17:16:
