...
/**
 * Love My Body — paymentin for commissioner report 01416 (1,115 AED) + mark Paid.
 *
 *   node --import dotenv/config scripts/moysklad-create-love-my-body-paymentin-01416-20260803.js
 *   node --import dotenv/config scripts/moysklad-create-love-my-body-paymentin-01416-20260803.js --commit
 */
...
const REPORT_ID = 'af95ec7e-8cab-11f1-0a80-1439001176e2'
const REPORT_NAME = '01416'
const EXPECTED_SUM_MINOR = 111500 // 1,115.00
const STATE_REPORT_PAID_ID = 'fd15289c-c3c4-11eb-0a80-065200268290'
const MARKER = `LOVE-MY-BODY-CONSIGNMENT-PAYMENT-${REPORT_NAME}-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Love My Body — paymentin @ consignment report 01416 (1,115)')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'LOVE MY BODY — consignment sales 1,115 AED — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
