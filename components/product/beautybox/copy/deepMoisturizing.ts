  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          'سيروم خفيف يعوض الرطوبة بحمض الهيالورونيك المتحلل 2,000 جزء في المليون، بينما يساعد PENTAVITIN بنسبة 0.615% البشرة على الاحتفاظ بها. وتدعم قاعدة من بيوتلين غليكول 7.02% والغليسرين 5% وGlycereth-26 بنسبة 4% نعومة البشرة وراحتها.',
      },
      {
        titleKey: 'routineHyaluronCreamTitle',
        productNumber: '29',
        ...
        body:
          'طبقة كريمية خفيفة تساعد على الاحتفاظ بالرطوبة بعد السيروم. تجمع بين 9% من الغليسرين و0.615% من PENTAVITIN و1,000.9 جزء في المليون من هيالورونات الصوديوم عالية الوزن الجزيئي؛ وارتفع ترطيب البشرة 82% فور تطبيق واحد وظل أعلى بصورة ملحوظة بعد 72 ساعة.',
      },
      {
        titleKey: 'routineSoothingBombMaskTitle',
        productNumber: '36',
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          'Лёгкая сыворотка восполняет влагу благодаря гидролизованной гиалуроновой кислоте 2 000 ppm, а PENTAVITIN 0,615% помогает коже её удерживать. База из бутиленгликоля 7,02%, глицерина 5% и Glycereth-26 4% поддерживает мягкость и комфорт.',
      },
      {
        titleKey: 'routineHyaluronCreamTitle',
        productNumber: '29',
        quantity: 1,
        step: 'Шаг 4 - Удержание влаги',
        body:
          'Лёгкий крем помогает удержать влагу после сыворотки. В формуле 9% глицерина, 0,615% PENTAVITIN и 1 000,9 ppm высокомолекулярного гиалуроната натрия; увлажнённость выросла на 82% сразу после одного нанесения и оставалась значимо выше исходного через 72 часа.',
      },
      {
        titleKey: 'routineSoothingBombMaskTitle',
        productNumber: '36',
