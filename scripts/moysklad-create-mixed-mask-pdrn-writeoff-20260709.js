...
/**
 * Warehouse write-off @ buyPrice (2026-07-09):
 ...
 *   00012 Peptide Gel Mask 39g ×15
 *
 *   node --import dotenv/config scripts/moysklad-create-mixed-mask-pdrn-writeoff-20260709.js
 *   node --import dotenv/config scripts/moysklad-create-mixed-mask-pdrn-writeoff-20260709.js --commit
 */
...
const MARKER = `MIXED-MASK-PDRN-WRITE-OFF-${uaeToday()}`

const LINES = [
  ['54470', 2, 'BIO-MESO PDRN Expert Ampoule 60000 (3mlx4)'],
...
async function main() {
  console.log('====================================================================')
  console.log('  Warehouse write-off — PDRN Expert, hyaluron serum, masks')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '54470 PDRN Expert 60000 x2, 00195 hyaluron serum x1, 00063 collagen mask x10, 00140 sea algae mask x10, 00012 peptide mask x15.',
    ].join(' | '),
