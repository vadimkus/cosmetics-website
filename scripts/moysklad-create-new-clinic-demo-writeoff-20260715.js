...
/**
 * New clinic demo — warehouse write-off @ buyPrice:
 *   00022 Snow Booster Toner 200ml ×1
 *   00021 Snow O₂ Cleanser 180ml ×1
 *   00015 SRS 1 Vial 2ml ×2
 *   54470 BIO-MESO PDRN Expert Ampoule 60000 (box) ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-new-clinic-demo-writeoff-20260715.js
 *   node --import dotenv/config scripts/moysklad-create-new-clinic-demo-writeoff-20260715.js --commit
 */
...
const MARKER = `NEW-CLINIC-DEMO-WRITE-OFF-${uaeToday()}`

/** [code, qty, label] */
const LINES = [
  ['00022', 1, 'Snow Booster Toner 200ml'],
  ['00021', 1, 'Snow O₂ Cleanser 180ml'],
  ['00015', 2, 'Skin Renewal Peeling System (SRS) 1 Vial 2ml'],
  ['54470', 1, 'BIO-MESO PDRN Expert Ampoule 60000 (3mlx4 box)'],
]
...
async function main() {
  console.log('====================================================================')
  console.log('  New clinic demo — write-off @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'New clinic demo kit — warehouse write-off at buyPrice.',
      '00022 Snow Booster 200ml x1; 00021 Snow O2 Cleanser 180ml x1; 00015 SRS vial x2; 54470 PDRN Expert 60000 box x1.',
    ].join(' | '),
