  ...
  return (
    <div className={`cera-page hr3-page min-h-[100dvh]`} dir={dir}>
      ...
      <section className="mx-auto max-w-[1000px] px-4 pt-14 sm:px-6 lg:pt-20">
        ...
        <CeraReveal>
          <p className="mt-7 text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.caffeine.body}</p>
        </CeraReveal>
      </section>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="mx-auto max-w-[1040px] px-4 sm:px-6">
          <CeraReveal>
            ...
            <p className="mt-4 max-w-[62ch] text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.trace.body}</p>
          </CeraReveal>
          ...
          <CeraReveal>
            <p className="mt-6 text-[15px] leading-relaxed text-[var(--cera-body)]">{copy.trace.footnote}</p>
          </CeraReveal>
