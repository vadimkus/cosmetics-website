...
/**
 * Persona Nakheel Mall (First Person Palm Jumeirah) — consignment replenishment + stock note.
 *
 *   54484 CERABARRIER Biome Gel Cleanser 200ml ×6
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-nakheel-cerabarrier-demand-20260708.js
 *   node --import dotenv/config scripts/moysklad-create-persona-nakheel-cerabarrier-demand-20260708.js --commit
 *   node --import dotenv/config scripts/moysklad-create-persona-nakheel-cerabarrier-demand-20260708.js --commit --no-print
 */
...
const COMMON = {
  ...
  contractId: '393d4076-1d00-11ef-0a80-028700179a4e', // Agreement 00078
}

const MARKER = `Persona Nakheel Mall CERABARRIER replenishment ${uaeToday()}`

const LINES = [['54484', 6, 'CERABARRIER Biome Gel Cleanser 200ml']]

const EXPECTED_SUM_MINOR = 114000 // 190 * 6
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Nakheel Mall — CERABARRIER consignment note (00078)')
  console.log('====================================================================')
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      'CERABARRIER Biome Gel Cleanser 200ml ×6.',
    ].join('\n'),
