...
/**
 * Face Care Pro Spa LTD — full paymentin for shipment 06577 / invoice 04849 / SO GENCardM260722FCPS,
 * then mark customer order as Delivered.
 *
 *   Total: 2,390 AED
 *
 *   node --import dotenv/config scripts/moysklad-face-care-pro-spa-paymentin-delivered-20260724.js
 *   node --import dotenv/config scripts/moysklad-face-care-pro-spa-paymentin-delivered-20260724.js --commit
 */
...
const AGENT_ID = 'e0eb8f5c-29c5-11f1-0a80-11a200380fea'
const ORDER_ID = '97bef39a-85b3-11f1-0a80-1e7700169bd4'
const DEMAND_ID = '9936352c-85b3-11f1-0a80-1e7700169c8a'
const INVOICE_ID = '982599c0-85b3-11f1-0a80-15b9001638bd'
const STATE_ORDER_DELIVERED_ID = 'e1a0ae5f-33c5-11ea-0a80-043f000b275e'
const EXPECTED_SUM_MINOR = 239000
const MARKER = 'FACE-CARE-PRO-SPA-PAYMENTIN-06577-2026-07-24'
...
async function main() {
  console.log('====================================================================')
  console.log('  Face Care Pro Spa — paymentin + mark delivered')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      MARKER,
      `Full payment for shipment ${demand.name} / invoice ${invoice.name} / ${order.name}`,
      'Face Care Pro Spa LTD — 2,390 AED',
    ].join(' | '),
