  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          'المنتج الوحيد في الصندوق بلا أي عطر. تونر يومي يرطّب ويهدّئ بمستخلصات نباتية مع إعادة الحموضة إلى مستواها بعد التنظيف، وهذا يهمّ لأن السيروم يعمل أفضل على بشرة لا تزال رطبة.',
        facts: ['بيتايين 3.000%', 'خميرة اليقطين 1.000%', 'الحموضة 6.08', 'بلا عطر'],
      },
      {
        titleKey: 'routineAllForSensitiveSerumTitle',
        productNumber: '19',
        ...
        body:
          'خطوة التهدئة، وسبب كون هذا صندوق البشرة الحساسة لا صندوق ترطيب. وهو مبني على مركّب نباتي بنسبة 1% كاملة من العبوة يحمل سبعة نباتات — السنتيلا والبوليجونوم والسكوتيلاريا والشاي الأخضر وعرق السوس والبابونج وإكليل الجبل — ووراءها الألانتوين والبيتايين.',
        facts: ['المركّب النباتي 1.0000%', 'ألانتوين 0.1000%', 'الحموضة 5.77', 'معطَّر · زيت قشر البرتقال'],
      },
      {
        titleKey: 'routineSkinBarrierCreamTitle',
        productNumber: '27',
    ...
    items: [
      {
        ...
        a: 'سؤال عادل ونفضّل الإجابة عليه على دفنه. ثلاثة من الستة تحمل عطراً: المنظف والسيروم وكريم الحاجز. أما التونر والقناعان فلا. وكل واحد من تلك المكوّنات مذكور على الملصق، والكمّيات صغيرة — فعطر الكريم نحو جزء من مئة من الواحد بالمئة — لكن الصغير ليس صفراً، وإن كان العطر مُحفّزك فهذا الصندوق شراء خاطئ. والطريق الصريح في تلك الحالة أن تشتري التونر والقناعين وتتركي الباقي، لأن صناديق جينوسيس الستة كلها مبنية على المنظف المعطَّر نفسه.',
      },
      {
...
const RU: BeautyBoxCopy = {
  ...
  subheadline:
    'Шесть полноразмерных продуктов GENOSYS для чувствительной, реактивной кожи: очищение без трения, тоник без ароматизатора, сыворотка на успокаивающем комплексе из семи растений, самый богатый барьерный крем в линейке с керамидом 5 000 ppm, ночная крем-маска, снизившая покраснение на 26% за четыре недели, и тканевая маска с морскими водорослями для тяжёлых вечеров. Вместе они стоят меньше, чем те же шесть по отдельности.',
  heroBullets: [
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          'Единственный продукт в наборе вообще без ароматизатора. Ежедневный тоник, который увлажняет и успокаивает растительными экстрактами и возвращает pH после очищения — это важно, потому что сыворотка лучше работает на ещё влажной коже.',
        facts: ['Бетаин 3,000%', 'Тыквенный фермент 1,000%', 'pH 6,08', 'Без ароматизатора'],
      },
      {
        titleKey: 'routineAllForSensitiveSerumTitle',
        productNumber: '19',
        ...
        body:
          'Успокаивающий шаг и причина, по которой это набор для чувствительной кожи, а не для увлажнения. Он построен на растительном комплексе в полный 1% флакона, несущем семь растений — центелла, горец, шлемник, зелёный чай, лакрица, ромашка и розмарин, — а за ними аллантоин и бетаин.',
        facts: ['Растительный комплекс 1,0000%', 'Аллантоин 0,1000%', 'pH 5,77', 'Ароматизирован · масло апельсиновой корки'],
      },
      {
        titleKey: 'routineSkinBarrierCreamTitle',
        productNumber: '27',
  ...
  evidence: {
    ...
    footnote:
      'Показатели 26% и 15% — из одного и того же четырёхнедельного исследования ночной крем-маски. У сыворотки, очищающего средства, тоника и тканевой маски исследований эффективности нет, и мы не будем намекать на обратное: очищающее, тоник, сыворотка и крем дерматологически протестированы, а это тест на безопасность, а не на результат.',
  },
  suited: {
    ...
    items: [
      {
        ...
        a: 'Справедливый вопрос, и мы предпочтём на него ответить, а не спрятать его. Три из шести содержат ароматизатор: очищающее, сыворотка и барьерный крем. Тоник и обе маски — нет. Каждый из этих компонентов указан на этикетке, и количества малы — parfum в креме около сотой доли процента, — но малое не значит нулевое, и если ароматизатор ваш триггер, то этот набор — неправильная покупка. Честный путь в таком случае: взять тоник и обе маски, а остальное пропустить, потому что все шесть наборов GENOSYS построены на одном и том же ароматизированном очищающем.',
      },
      {
