 ...
 *   1,2-hexanediol 0.00008%, camellia sinensis 0.00005% (0.5 ppm), sixteen botanicals
 ...
 *   Peeling 0.900 + 0.800 = 1.700%  (most total cooling agent of any GENOSYS product)
 ...
 *   - A pregnancy instruction attributed to this carton: we cannot read its panel. The
 *     page signposts the sibling ampoule's pregnancy caution and says to ask a doctor,
 *     which is honest and does not invent a label instruction.
 */
...
const AR: ScalpPeelingCopy = {
  eyebrow: 'مقشّر فروة الرأس إتش آر³ ماتريكس α · 100 مل',
  headline: 'ثلث هذه العبوة كحول. وهذا هو المقصود.',
  subheadline:
    'هذا ليس علاجاً مقشّراً، بل خطوة تحضير — وخطوة جيّدة فعلاً. فالكحول المُمَوَّه بنسبة 33.600% مع بروبيلين جليكول بنسبة 11.994% يقطع زيت الفروة والعرق وتراكم المنتجات في ثوانٍ، حتى يصل ما تفعلينه بعده إلى بشرة نظيفة. وفي هذه المجموعة، ما تفعلينه بعده هو إدخال أمبولة Hair Solution بالإبر. ثم 1.7% من عوامل التبريد مجتمعة، وهو أكثر ممّا يحمله أي منتج جينوسيس آخر.',
  heroBullets: [
  ...
  badges: ['صُنع في كوريا', '100 مل', 'خطوة تحضير', 'لا يُشطف'],
  ...
  notGentle: {
    ...
    title: 'كان وصفنا نفسه يسمّي هذا لطيفاً. وهو ليس كذلك.',
    body:
      'ثلاث مرات وصف النصّ القديم على هذه الصفحة مقشّر فروة لطيفاً. ومحلول ثلثه كحول مُمَوَّه، ويحمل 1.7% عوامل تبريد، ويُفرك في الفروة بعود قطني، ليس لطيفاً، وقول ذلك قبل الشراء أنفع لك من قوله بعده. وهو فعّال. وتلك كلمة أخرى.',
    items: [
    ...
    detail:
      'ولا شيء من ذلك عيب في التركيبة. فتجريد الفروة سريعاً والجفاف بلا أثر هو تماماً ما ينبغي لخطوة تحضير قبل الإبر الدقيقة أن تفعله. لكنه أداة لعمل، لا منتج راحة، ومكانه في روتين لا وحده.',
  },
    ...
    items: [
      {
        name: 'Alcohol Denat.',
        dose: '33.600%',
        body: 'ثلث العبوة. يُذيب الزهم وبقايا المنتجات عند الملامسة ويتبخّر في ثوانٍ، فلا يترك شيئاً تدفعه الخطوة التالية. ويحمل أيضاً دينوتونيوم بنزوات، وهو عامل مُمرّر، حتى لا يمكن شرب الكحول المُمَوَّه.',
      },
      {
        name: 'Propylene Glycol',
        dose: '11.994%',
      ...
      },
      {
        ...
        dose: '0.900% + 0.800%',
        body: '1.7% من عوامل التبريد بينهما، وهو أعلى مجموع في أي منتج جينوسيس. المنثول يعطي البرد الفوري، والمنثيل لاكتات يحمله عدة دقائق بعده.',
      },
      {
        name: 'PEG-60 Hydrogenated Castor Oil',
        dose: '2.000%',
  ...
  cooling: {
    ...
    title: 'أعلى عامل تبريد تضعه جينوسيس في أي شيء',
    intro:
    ...
    body:
      'تمييز صريح واحد: الشامبو يحمل منثولاً أكثر تحديداً، 1.120% مقابل 0.900% هنا، لكن هذه التركيبة فيها عامل تبريد أكثر بالمجموع وتذهب على بشرة جُرّدت للتوّ من زيتها، بلا ماء يخفّفها. وعملياً هذا أبرد ما في المجموعة استخداماً. والأمبولة في أسفل ذلك الجدول هي الألطف، وذلك مقصود — فهي توضع بعد الإبر.',
  },

  labelClaims: {
    eyebrow: 'التناسب',
    title: 'مكوّنان يتصدّر بهما الملصق، وجرعاتهما الحقيقية',
    body:
      'حمض الساليسيليك والكوبر ترايببتايد-1 يظهران عالياً في قائمة المكوّنات، وكان نصّنا نفسه يبني المنتج حولهما. وهذا ما هو موجود فعلاً.',
    items: [
      ...
      { name: 'ستة عشر نباتاً', dose: '0.1 ppm لكل', note: 'ومنها تسعة مستخلصات Black Complex' },
  ...
  howTo: {
    ...
    frequency: 'قبل معالجة بالإبر الدقيقة · لا يُشطف',
    steps: [
      {
        title: 'صبّي نحو 5 مل',
      ...
      {
        title: 'اعملي قسماً بقسم ثم توقّفي',
        body: 'افرقي، امسحي بالعود، انتقلي. ولا تشطفيه ولا تتبعيه بالماء: فالمقصود كلّه أن تبقى الفروة نظيفة وجافّة للخطوة التالية.',
      },
      {
        title: 'ثم الأمبولة',
        body: 'في نظام إتش آر³ ماتريكس يتبع هذا محلول Hair Solution α، يُدخَل بالإبر برولر أو ستامب 0.25 إلى 0.5 مم. والمنتجان يُوردان معاً في طقم ميزوبيشيا.',
      },
    ],
    note:
      'أبعديه جيداً عن العينين — فهذا ثلثه كحول مع 0.9% منثول وسيؤلم أكثر بكثير من شامبو. واتركي الفروة تجفّ قبل أي حرارة: فعند تركيز الكحول هذا يكون السائل قابلاً للاشتعال. وإن كنتِ حاملاً أو مرضعاً فاستشيري طبيبك أولاً: فأمبولة Hair Solution في المجموعة نفسها تحمل تحفّظاً للحمل يُعزى إلى منثولها، وهذه التركيبة فيها أربعة أضعاف ونصف منه.',
  },
  ...
  quality: {
    ...
    intro:
      'صُنع في كوريا وأُفرج عنه مقابل مواصفة مكتوبة، وبصورة غير معتادة في هذه المجموعة اختُبرت الدفعة للاستقرار كما للنقاء. ومسجّل تحت العناية بالشعر لا كعلاج.',
    rows: [
  ...
  safety: {
    ...
    points: [
      ...
      'إن كنتِ حاملاً أو مرضعاً فاستشيري طبيبك قبل الاستخدام.',
    ...
    note:
      'مأخوذة من تقييم السلامة والتركيبة. والعمل الفنّي المسجّل الذي نملكه لا يحتوي نصّ لوحة قابلاً للقراءة، فلا شيء أعلاه منقول عن العلبة — تحقّقي من العلبة التي تستلمينها لصيغتها الخاصة.',
  },
  ...
  spec: {
    ...
    rows: [
      ...
      { label: 'الفئة المسجّلة', value: 'العناية بالشعر' },
      { label: 'الغرض', value: 'إزالة الدهن وتحضير فروة الرأس قبل معالجة بالإبر الدقيقة' },
      ...
      { label: 'بجرعات أثرية', value: 'شاي أخضر 0.5 ppm، ستة عشر نباتاً 0.1 ppm لكل، كوبر ترايببتايد-1 5 ppb' },
      ...
      { label: 'التطبيق', value: 'بعود قطني، يُفرك بقوة، قسماً بقسم. ولا يُشطف' },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'فقط إن كنتِ تستخدمين الإبر الدقيقة. فالشامبو ينظّف فروتك جيداً تماماً للأغراض اليومية. وهذا موجود ليترك الفروة مجرّدة تماماً وجافّة قبل معالجة بالإبر مباشرة، وهو ما لا يمكن لشطف وتنشيف تحقيقه بالموثوقية نفسها. وإن لم تكوني تستخدمين الإبر، فاشتري الشامبو واتركي هذا.',
      },
      {
      ...
      {
        q: 'هل يطهّر الفروة قبل الإبر؟',
        a: 'لا، وهذا يهمّ إن كنتِ تستخدمين الإبر في المنزل. فأدبيات الشركة تقول إنه يطهّر منطقة المعالجة، لكن الكحول يحتاج عموماً 60 إلى 70% ليعمل مطهّراً وهذا 33.6%. فهو يُزيل الدهن وينظّف. ولأي شيء يحتاج تعقيماً، استخدمي منتجاً مخصّصاً لذلك فعلاً — وأطقم المنزل تشمل وعاء تطهير منفصلاً للمُطبّق لهذا السبب بالضبط.',
      },
      {
...
const RU: ScalpPeelingCopy = {
  eyebrow: 'HR³ MATRIX пилинг для кожи головы α · 100 мл',
  headline: 'Треть этого флакона — спирт. В этом и смысл.',
  subheadline:
    'Это не отшелушивающий уход, а подготовительный шаг — и по-настоящему хороший. Денатурированный спирт 33,600% с пропиленгликолем 11,994% срезает кожное сало, пот и остатки средств за секунды, чтобы то, что вы делаете дальше, попадало на чистую кожу. В этой линии дальше идёт ампула Hair Solution, вводимая иглами. Затем 1,7% охлаждающих агентов суммарно — больше, чем несёт любой другой продукт GENOSYS.',
  heroBullets: [
  ...
  badges: ['Сделано в Корее', '100 мл', 'Подготовка', 'Не смывается'],
  ...
  notGentle: {
    ...
    title: 'Наше собственное описание называло его мягким. Он не мягкий.',
    body:
      'Трижды старый текст на этой странице описывал мягкий пилинг для кожи головы. Раствор, треть которого — денатурированный спирт, который несёт 1,7% охлаждающих агентов и втирается в кожу головы ватной палочкой, не является мягким, и сказать это до покупки полезнее, чем после. Он эффективен. Это другое слово.',
    items: [
    ...
    detail:
      'Ничего из этого не является недостатком формулы. Быстро снять всё с кожи головы и высохнуть без остатка — именно то, что должен делать подготовительный шаг перед микронидлингом. Но это инструмент для задачи, а не продукт для комфорта, и его место в схеме, а не отдельно.',
  },
    ...
    items: [
      {
        name: 'Alcohol Denat.',
        dose: '33.600%',
        body: 'Треть флакона. Растворяет себум и остатки средств при контакте и улетает за секунды, не оставляя ничего, через что следующему шагу пришлось бы пробиваться. Он также несёт денатоний бензоат, горькую добавку, чтобы денатурированный спирт нельзя было выпить.',
      },
      {
        name: 'Propylene Glycol',
        dose: '11.994%',
      ...
      },
      {
        ...
        dose: '0.900% + 0.800%',
        body: '1,7% охлаждающих агентов вместе — самая высокая сумма в любом продукте GENOSYS. Ментол даёт немедленный холод, ментил лактат продлевает его на несколько минут.',
      },
      {
        name: 'PEG-60 Hydrogenated Castor Oil',
        dose: '2.000%',
  ...
  cooling: {
    ...
    title: 'Больше охлаждающего агента, чем GENOSYS кладёт куда-либо ещё',
    intro:
    ...
    body:
      'Одно честное уточнение: у шампуня больше именно ментола — 1,120% против 0,900% здесь, — но в этой формуле больше охлаждающего агента суммарно, и она попадает на кожу, с которой только что сняли жир, без воды, которая бы её разбавила. На практике это самое холодное в линии в использовании. Ампула внизу таблицы — самая мягкая, и это осознанно: она идёт после игл.',
  },

  labelClaims: {
    eyebrow: 'Пропорция',
    title: 'Два ингредиента, которыми ведёт этикетка, и их реальные дозы',
    body:
      'Салициловая кислота и медный трипептид-1 стоят высоко в списке ингредиентов, и наш собственный текст строил продукт вокруг них. Вот что там на самом деле.',
    items: [
  ...
  howTo: {
    ...
    frequency: 'Перед процедурой микронидлинга · не смывается',
    steps: [
      {
      ...
      {
        title: 'Обрабатывайте пробор за пробором и остановитесь',
        body: 'Разделить, обработать, идти дальше. Не смывайте и не проходите водой после: весь смысл в том, чтобы кожа головы осталась чистой и сухой для следующего шага.',
      },
      {
        title: 'Затем ампула',
        body: 'В системе HR³ MATRIX за этим идёт Hair Solution α, вводимый роллером или штампом 0,25–0,5 мм. Оба продукта поставляются вместе в наборе Mesopecia.',
      },
    ],
    note:
      'Держите подальше от глаз — это на треть спирт с 0,9% ментола, и будет больно куда сильнее, чем от шампуня. Дайте коже головы высохнуть до любого нагрева: при такой концентрации спирта жидкость горюча. И если вы беременны или кормите, сначала спросите врача: ампула Hair Solution из этой же линии несёт предостережение о беременности, отнесённое к её ментолу, а в этой формуле его в четыре с половиной раза больше.',
  },
  ...
  quality: {
    ...
    intro:
      'Сделано в Корее и выпущено против письменной спецификации, и, что для этой линии необычно, партию проверяли и на стабильность, а не только на чистоту. Зарегистрировано в категории ухода за волосами, а не как средство лечения.',
    rows: [
  ...
  safety: {
    ...
    points: [
      ...
      'Если вы беременны или кормите, спросите врача перед применением.',
    ...
    note:
      'Составлено по оценке безопасности и формуле. В имеющемся у нас зарегистрированном макете нет читаемого текста панели, поэтому ничего выше не цитируется с коробки — проверьте формулировки на упаковке, которую получите.',
  },
  ...
  spec: {
    ...
    rows: [
      ...
      { label: 'Категория', value: 'Уход за волосами' },
      { label: 'Для чего', value: 'Обезжиривание и подготовка кожи головы перед микронидлингом' },
      ...
      { label: 'Следово', value: 'Зелёный чай 0,5 ppm, шестнадцать растительных по 0,1 ppm, медный трипептид-1 5 ppb' },
      ...
      { label: 'Нанесение', value: 'Ватной палочкой, втирая с усилием, пробор за пробором. Не смывать' },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Только если вы делаете микронидлинг. Шампунь прекрасно очищает кожу головы для повседневных задач. Этот существует, чтобы оставить кожу полностью обезжиренной и сухой непосредственно перед процедурой с иглами, чего мытьё и полотенце не дают так надёжно. Если игл нет — берите шампунь и пропустите это.',
      },
      {
      ...
      {
        q: 'Он дезинфицирует кожу головы перед иглами?',
        a: 'Нет, и это важно, если вы делаете микронидлинг дома. Литература производителя действительно говорит, что он дезинфицирует зону обработки, но спирту обычно нужно 60–70%, чтобы работать как антисептик, а здесь 33,6%. Он обезжиривает и очищает. Для того, что должно быть стерильным, используйте средство, действительно для этого предназначенное: домашние наборы включают отдельную дезинфицирующую баночку для аппликатора именно по этой причине.',
      },
      {
