...
/**
 * Promotional presents write-off @ buyPrice (2026-07-04):
 ...
 *   00038 Soothing Repair Post Cream 20g ×4
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-gift-writeoff-20260704.js
 *   node --import dotenv/config scripts/moysklad-create-presents-gift-writeoff-20260704.js --commit
 */
...
const MARKER = `PRESENTS-WRITE-OFF-GIFT-${uaeToday()}`
...
const LINES = [
  ...
  ['00038', 4, 'Soothing Repair Post Cream 20g'],
]
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents write-off — bio ferment, peptide/collagen/sea masks, post cream')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '54466 Bio Ferment x1, 00012 peptide gel mask x10, 00063 collagen x10, 00140 sea algae x10, 00038 post cream 20g x4.',
    ].join(' | '),
