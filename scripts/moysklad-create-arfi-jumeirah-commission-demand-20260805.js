...
const MARKER = `ARFI Nails Jumeirah consignment sales July 2026 ${uaeToday()}`

/** [code, qty, label] — from Jumeirah WhatsApp table 2026-08-05 */
const LINES = [
  ...
  ['00041', 2, 'Multi Sun Cream SPF40 40g'],
  ...
  ['00140', 2, 'Soothing Bomb Sea Algae Mask'],
]

const EXPECTED_UNITS = 17
const EXPECTED_SUM_MINOR = 188700 // 1,887.00
...
async function main() {
  console.log('====================================================================')
  console.log('  ARFI Nails Jumeirah — report + demand (agreement 30, July 2026)')
  console.log('====================================================================')
  ...
  const report = await api('POST', '/entity/commissionreportin', {
    ...
    description: [
      MARKER,
      'ARFI NAILS BEAUTY SALON 2 (Jumeirah) | Agreement 30 | July 2026 sold (17 pcs).',
