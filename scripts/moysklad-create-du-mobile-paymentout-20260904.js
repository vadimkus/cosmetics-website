...
/**
 * DU — mobile monthly Aug 2026 eBill (acct 2856165422, +971559152985).
 * 393.75 AED incl. 5% VAT. Period 01/08/2026–31/08/2026. Due 22/09/2026.
 *
 *   node --import dotenv/config scripts/moysklad-create-du-mobile-paymentout-20260904.js
 *   node --import dotenv/config scripts/moysklad-create-du-mobile-paymentout-20260904.js --commit
 */
...
const AGENT_ID = '1bf9175d-4910-11f0-0a80-13c800353b3d'
const EXPENSE_ITEM_ID = 'e4a42ce6-43c2-11eb-0a80-05e500017674'
const STATE_PAID_ID = 'e7020a99-d671-11ea-0a80-0216000f3623'

const SUM_MINOR = 39375
const DU_ACCOUNT = '2856165422'
const DU_MOBILE = '971559152985'
const MARKER = `DU-MOBILE-MONTHLY-AUG2026-${DU_ACCOUNT}`
const DESCRIPTION = [
...
async function main() {
  console.log('====================================================================')
  console.log('  DU — mobile monthly Aug 2026 (paymentout)')
  console.log('====================================================================')
  ...
  if (agent.name !== 'DU') throw new Error(`Unexpected agent ${agent.name}`)
  ...
  const created = await api('POST', '/entity/paymentout', {
    ...
    sum: SUM_MINOR,
    paymentPurpose: `DU mobile monthly ${money(SUM_MINOR)} AED acct ${DU_ACCOUNT} Aug 2026 [${MARKER}]`,
