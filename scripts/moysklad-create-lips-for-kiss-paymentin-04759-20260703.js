...
/**
 * Lips for Kiss Clinic — paymentin @ shipment 06467 / invoice 04759.
 * Order GENCardM260703LFK → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-lips-for-kiss-paymentin-04759-20260703.js
 *   node --import dotenv/config scripts/moysklad-create-lips-for-kiss-paymentin-04759-20260703.js --commit
 */
...
const MARKER = `LIPS-FOR-KISS-PAYMENTIN-04759-${uaeToday()}`

const PAYMENT = {
  amountMinor: 299000,
  note: 'INV 04759 GENOSYS',
  invoiceName: '04759',
  invoiceId: '9ca017c5-76c0-11f1-0a80-10320015362e',
  shipmentName: '06467',
  shipmentId: '9d907a74-76c0-11f1-0a80-1148001517bf',
  orderName: 'GENCardM260703LFK',
  orderId: '9b01baab-76c0-11f1-0a80-0c640014a1a7',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Lips for Kiss — paymentin @ 04759 / 06467 + order delivered')
  console.log('====================================================================')
