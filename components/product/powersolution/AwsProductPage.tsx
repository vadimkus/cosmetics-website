...
import { AWS_VARIANT } from './awsCopy'
import PowerSolutionProductPage from './PowerSolutionProductPage'

/**
 * POWER SOLUTION AWS, product 9. See awsCopy.ts for the sourcing.
 *
 ...
 */
export default function AwsProductPage(props: {
  product: Product
  unitsSold?: number
  routineProducts?: Product[]
}) {
  return <PowerSolutionProductPage {...props} variant={AWS_VARIANT} />
}
