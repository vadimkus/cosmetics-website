...
/**
 * X Beauty Consulting — paymentin @ shipment 06725 / invoice 04963.
 * 950 AED. Order GENCardM260822XBC → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-xbc-paymentin-04963-20260822.js
 *   node --import dotenv/config scripts/moysklad-create-xbc-paymentin-04963-20260822.js --commit
 */
...
const MARKER = 'XBC-PAYMENTIN-04963-2026-08-22'

const PAYMENT = {
  amountMinor: 95000,
  invoiceName: '04963',
  invoiceId: 'af8ced8a-9e1a-11f1-0a80-1eb700600be5',
  shipmentName: '06725',
  shipmentId: 'b0700c34-9e1a-11f1-0a80-1a67005f4a97',
  orderName: 'GENCardM260822XBC',
  orderId: 'af2ffaad-9e1a-11f1-0a80-14c1005d37fc',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  X Beauty Consulting — paymentin @ 04963 / 06725')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Full payment 950 AED. Defender, Snow 180, mist, radiance 50g, overnight, PDRN mask, delivery 45.',
    ].join(' | '),
    operations: [
      {
        meta: {
