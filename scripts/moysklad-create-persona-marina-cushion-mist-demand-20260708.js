 ...
 *   00188 Microbiome Energy Infusing Mist 80ml ×4
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-marina-cushion-mist-demand-20260708.js --commit
 */
...
const MARKER = `Persona Marina cushion+mist replenishment ${uaeToday()}`
const LINES = [
  ['00144', 2, 'Skin Caring Blemish Balm Cushion #2 Beige'],
  ['00188', 4, 'Microbiome Energy Infusing Mist 80ml'],
]
const EXPECTED_SUM_MINOR = 62000
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Marina — cushion + mist consignment note (00024)')
  console.log('====================================================================')
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      'Cushion Beige 00144 ×2; Microbiome Mist 00188 ×4.',
    ].join('\n'),
