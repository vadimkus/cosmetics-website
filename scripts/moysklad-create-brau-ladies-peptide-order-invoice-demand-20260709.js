 ...
 *
 *   Peptide Gel Mask 39g single (00012) ×10
 *
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-order-invoice-demand-20260709.js
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-order-invoice-demand-20260709.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}BRAUP10`,
  moment: uaeMomentNow(),
  marker: `BRAU-PEPTIDE-P10-${uaeToday()}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Brau Ladies Salon LLC — peptide gel mask x10')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    name: ORDER.name,
    moment: t0,
    description: [ORDER.marker, 'Peptide Gel Mask 00012 x10.', 'Chain: invoice → shipment.'].join(' | '),
