    ...
    steps: [
      {
        ...
        body: 'نظّفي وجفّفي بالتربيت. وتقترح الشركة التحضير بـ GENOSYS Snow Booster أولاً، ما يمنح الورقة سطحاً رطباً تعمل عليه.',
      },
      {
    ...
    steps: [
      {
        ...
        body: 'Очистите и промокните. Производитель предлагает сначала подготовить кожу GENOSYS Snow Booster — так у полотна будет влажная поверхность для работы.',
      },
      {
