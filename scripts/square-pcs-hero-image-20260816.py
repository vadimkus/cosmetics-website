"""
Squares the POWER SOLUTION PCS hero shot by continuing its own studio sweep.

WHY. PCS.jpg is 956x662 on a light studio backdrop, same geometry as CTS.jpg
and AWS.jpg. The gallery stage is square and uses object-contain, so the shot
...
SRC = 'public/images/PCS.jpg'
OUT = sys.argv[1] if len(sys.argv) > 1 else 'public/images/pcs-hero.jpg'
...
print(f'  gap to page tint #f4f3f8 at the corners: {gap}/255')
