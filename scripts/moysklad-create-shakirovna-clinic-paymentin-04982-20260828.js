...
/**
 * SHAKIROVNA ESTHETIC CLINIC L.L.C — paymentin @ shipment 06750 / invoice 04982.
 * 145 AED. Order GENCardM260827SHKDEF → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-clinic-paymentin-04982-20260828.js
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-clinic-paymentin-04982-20260828.js --commit
 */
...
const MARKER = 'SHAKIROVNA-CLINIC-PAYMENTIN-04982-2026-08-28'

const PAYMENT = {
  amountMinor: 14500,
  invoiceName: '04982',
  invoiceId: '804a8c84-a231-11f1-0a80-0dc40076624f',
  shipmentName: '06750',
  shipmentId: '80fea1d0-a231-11f1-0a80-136b0077fd29',
  orderName: 'GENCardM260827SHKDEF',
  orderId: '800b7297-a231-11f1-0a80-087b007732f5',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Shakirovna Clinic BB — paymentin @ 04982 / 06750')
  console.log('====================================================================')
  ...
  if (order.agent?.name !== 'SHAKIROVNA ESTHETIC CLINIC L.L.C') {
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      `Order ${PAYMENT.orderName} — 145 AED.`,
    ].join(' | '),
    operations: [
      {
        meta: {
