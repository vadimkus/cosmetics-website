...
/**
 * Yula Beauty Salon LLC — paymentin for consignment report 01407 (490 AED).
 * Agreement 12 — EyeCell kit 00059 ×1.
 *
 *   node --import dotenv/config scripts/moysklad-create-yula-beauty-consignment-paymentin-01407-20260716.js
 *   node --import dotenv/config scripts/moysklad-create-yula-beauty-consignment-paymentin-01407-20260716.js --commit
 */
...
const MARKER = `YULA-BEAUTY-CONSIGNMENT-PAYMENT-01407-${uaeToday()}`

const PAYMENT = {
  reportId: '12eb0269-8103-11f1-0a80-19ba001957ec',
  reportName: '01407',
...
async function main() {
  console.log('====================================================================')
  console.log('  Yula Beauty Salon LLC — paymentin @ consignment report 01407')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      `${agent.name} — EyeCell kit 00059 x1 consignment sales ${money(openMinor)} AED — paid in full.`,
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
