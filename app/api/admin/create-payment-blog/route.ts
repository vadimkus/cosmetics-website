...
export async function POST(request: NextRequest) {
  ...
  <div class="text-center bg-gradient-to-r from-red-600 to-red-700 text-white p-8 rounded-lg">
    ...
    <a href="/products" class="inline-block bg-white text-red-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors">Shop Now with New Payment Options</a>
      ...
      titleRu: "Новые способы оплаты: Apple Pay, Google Pay и карты",
      excerptRu: "Мы обновили оплату через Stripe: теперь доступны Apple Pay, Google Pay, Link и основные банковские карты для быстрых и безопасных онлайн-платежей.",
      contentRu: `<div class="max-w-4xl mx-auto space-y-8">
  <div>
    <h2 class="text-3xl font-bold mb-4">🚀 Новые способы оплаты на сайте</h2>
    <p class="text-lg text-gray-700 mb-6">Мы рады объявить о крупном обновлении нашего процесса оформления заказа! Наша новая платёжная система на базе Stripe теперь поддерживает несколько способов оплаты, что делает покупку средств GENOSYS ещё проще.</p>
  </div>
  <div>
