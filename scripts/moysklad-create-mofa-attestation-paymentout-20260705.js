 ...
 *
 * Paid 2026-07-05 via Magnati/UAE Pass for Document Attestation Fee.
 * Magnati ref 618639187173 | paymentId 101202618678014746 | txn 261861333551671
 *
 *   node --import dotenv/config scripts/moysklad-create-mofa-attestation-paymentout-20260705.js
 *   node --import dotenv/config scripts/moysklad-create-mofa-attestation-paymentout-20260705.js --commit
 */
...
const MOMENT = '2026-07-05 13:33:00'
const MARKER = 'MOFA-ATTEST-20260705-30215'
const DESCRIPTION =
  'MOFA invoices attestation 302.15 AED (300.00 + 2.15 Magnati) — Magnati ref 618639187173 / paymentId 101202618678014746 / txn 261861333551671 — paid 05-Jul-2026 UAE Pass'
...
async function ensureNoDuplicate() {
  ...
  const bySearch = await api('GET', `/entity/paymentout?search=618639187173&limit=5`)
