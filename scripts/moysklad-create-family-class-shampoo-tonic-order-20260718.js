...
/**
 * FAMILY CLASS POLY CLINIC L.L.C — SO → invoice → shipment + Legal_TAX PDF → Desktop/orders.
 *
 *   00052 HR³ Matrix Medi Scalp Shampoo 300ml ×2 @ 170 clinic
 *   00051 HR³ Matrix Hair Tonic 70ml ×2 @ 145 clinic
 *   Excellent Delivery Dubai ×1 @ 45
 *   Total: 675.00 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-family-class-shampoo-tonic-order-20260718.js
 *   node --import dotenv/config scripts/moysklad-create-family-class-shampoo-tonic-order-20260718.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}FCHS`,
  moment: uaeMomentNow(),
  marker: `FAMILY-CLASS-SHAMPOO-TONIC-JVC-${uaeToday()}`,
}

/** [code, qty, clinicAed] */
const PRODUCT_LINES = [
  ['00052', 2, 170], // Medi Scalp Shampoo 300ml
  ['00051', 2, 145], // Hair Tonic 70ml
]
const DELIVERY_AED = 45
const EXPECTED_SUM_MINOR = 67500 // 340 + 290 + 45
...
async function main() {
  console.log('====================================================================')
  console.log('  FAMILY CLASS POLY CLINIC — shampoo ×2 + tonic ×2 + delivery 45')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00052 Medi Scalp Shampoo x2 @170; 00051 Hair Tonic x2 @145; delivery 45 AED; JVC Monday delivery.',
    ].join(' | '),
