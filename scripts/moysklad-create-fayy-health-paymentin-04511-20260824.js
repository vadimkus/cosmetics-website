...
/**
 * Fayy Health FZCO — paymentin @ shipment 06153 / invoice 04511 (May).
 * Stripe Mastercard ••••1465 / 3,800 AED. Order GENCardW2605147962 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-fayy-health-paymentin-04511-20260824.js
...
const MARKER = 'FAYY-PAYMENTIN-04511-STRIPE-3800-2026-08-24'

const PAYMENT = {
  amountMinor: 380000,
  invoiceName: '04511',
  invoiceId: 'a0de441b-4f8d-11f1-0a80-0c4e000fa39a',
  shipmentName: '06153',
  shipmentId: '5fe2d91f-4f8f-11f1-0a80-0ef1000f6d08',
  orderName: 'GENCardW2605147962',
  orderId: '9ed98b01-4f8d-11f1-0a80-1c9700105788',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Fayy Health — paymentin @ 04511 / 06153 (May)')
  console.log('====================================================================')
  ...
  console.log(`  Invoice ${invoice.name}: ${money(invoice.sum)} AED (paid ${money(invoice.payedSum)}) ${String(invoice.moment).slice(0, 10)}`)
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Stripe Mastercard 1465 / muhammad.usman@fayy.health / 3800 AED. May peptide x100.',
    ].join(' | '),
    operations: [
      {
        meta: {
