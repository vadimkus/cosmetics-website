...
/**
 * Salik — road toll 100 AED via Dubai Pay (24 Jul 2026).
 * Account 34742174 | Txn ref 139530243 | Wio Business → Digital Dubai Authority
 *
 *   node --import dotenv/config scripts/moysklad-create-salik-paymentout-20260724.js
 *   node --import dotenv/config scripts/moysklad-create-salik-paymentout-20260724.js --commit
 */
...
const PAY_DATE = '2026-07-24'
const PAY_MOMENT = '2026-07-24 10:19:00'
const SUM_MINOR = 10000 // 100.00 AED
const REF = '139530243'
const ACCOUNT = '34742174'
const MARKER = `SALIK-DUBAIPAY-${REF}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Salik — road toll (paymentout, Dubai Pay receipt)')
  console.log('====================================================================')
  console.log(`  Mode : ${COMMIT ? 'COMMIT' : 'DRY RUN'}`)
  console.log(`  Date : ${PAY_DATE} (${PAY_MOMENT})`)
  console.log(`  Sum  : ${money(SUM_MINOR)} AED`)
  console.log(`  Ref  : ${REF} | account ${ACCOUNT}`)
  ...
  const purpose = [
    ...
    `Account ${ACCOUNT} | txn ${REF}`,
    'Dubai Pay via Wio Business → Digital Dubai Authority',
    `Balance after: 101.9 AED | ${MARKER}`,
  ].join(' | ')
