...
/**
 * Melanta Poly Clinic — June 2026 consignment sales report only (contract 14).
 *
 *   node --import dotenv/config scripts/moysklad-create-melanta-commission-report-20260702.js
...
const MARKER = `Melanta Poly Clinic consignment sold June 2026 ${uaeToday()}`

/** [code, qty, label] — masks 16g label → 23g SKUs */
const LINES = [
...
async function main() {
  console.log('====================================================================')
  console.log('  Melanta Poly Clinic — June consignment sales report (contract 14)')
  console.log('====================================================================')
  ...
  const report = await api('POST', '/entity/commissionreportin', {
    ...
    description: [
      MARKER,
      'Melanta Poly Clinic L.L.C | Contract 14.',
      'Report only — no demand.',
      'June 2026 sold list — masks 16g label → 23g SKUs 00063/00140.',
    ].join('\n'),
