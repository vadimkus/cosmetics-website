...
/**
 * Admin Shakirovna Salon — paymentin @ shipment 06781 / invoice 05008.
 * 310 AED. Order GENCardM260901SHKSPC → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-paymentin-05008-20260902.js
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-paymentin-05008-20260902.js --commit
 */
...
const MARKER = `ADMIN-SHAKIROVNA-PAYMENTIN-05008-${uaeToday()}`

const PAYMENT = {
  amountMinor: 31000,
  invoiceName: '05008',
  invoiceId: 'd7aecfad-a61b-11f1-0a80-137500459a5f',
  shipmentName: '06781',
  shipmentId: 'd935de9f-a61b-11f1-0a80-08990047f9e1',
  orderName: 'GENCardM260901SHKSPC',
  orderId: 'd754a5fb-a61b-11f1-0a80-137500459a1f',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Admin Shakirovna — paymentin @ 05008 / 06781')
  console.log('====================================================================')
  ...
  if (!/admin shakirovna/i.test(order.agent?.name || '')) {
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      `Order ${PAYMENT.orderName} — 310 AED.`,
    ].join(' | '),
    operations: [
      {
        meta: {
