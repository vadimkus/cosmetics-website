 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-masks-writeoff-20260622.js
 *   node --import dotenv/config scripts/moysklad-create-presents-masks-writeoff-20260622.js --commit
 */
...
const MARKER = `PRESENTS-WRITE-OFF-MASKS-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents write-off — sea algae + collagen masks')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00140 Sea Algae Mask x10, 00063 Collagen Mask x10.',
    ].join(' | '),
