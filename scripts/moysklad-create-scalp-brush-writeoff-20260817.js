...
/**
 * Warehouse write-off @ buyPrice (2026-08-17):
 *   54471 HR³ Matrix Scalp Brush ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-scalp-brush-writeoff-20260817.js
 *   node --import dotenv/config scripts/moysklad-create-scalp-brush-writeoff-20260817.js --commit
 */
...
const MARKER = `WRITE-OFF-SCALP-BRUSH-54471-${uaeToday()}`

const LINES = [['54471', 1, 'HR³ Matrix Scalp Brush']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Write-off — HR³ Matrix Scalp Brush ×1')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    applicable: true,
    moment: uaeMomentNow(),
    description: [MARKER, 'Warehouse write-off at buyPrice.', 'HR3 Matrix Scalp Brush x1.'].join(
      ' | ',
    ),
