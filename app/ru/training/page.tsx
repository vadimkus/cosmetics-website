                  ...
                  <div className="group border border-gray-200 rounded-md md:rounded-lg p-2 md:p-3 hover:border-green-300 hover:shadow-lg transition-all duration-200">
                    <div className="flex items-center gap-2 md:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] md:text-xs text-gray-400">39.9 МБ</p>
                      </div>
                      <PDFDownloadButton
                  ...
                  <div className="group border border-gray-200 rounded-md md:rounded-lg p-2 md:p-3 hover:border-red-300 hover:shadow-lg transition-all duration-200">
                    <div className="flex items-center gap-2 md:gap-3">
                      <div className="w-8 h-8 md:w-10 md:h-10 bg-gray-100 rounded-md md:rounded-lg flex items-center justify-center overflow-hidden flex-shrink-0">
                        <Link href="/ru/products/66">
                          <Image
                            src="/images/cera/main.jpeg"
                            alt="CERABARRIER BIOME GEL CLEANSER"
                            width={500}
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="text-xs md:text-sm font-semibold text-gray-900 truncate">
                          CERABARRIER BIOME ГЕЛЬ ДЛЯ УМЫВАНИЯ
                        </h4>
            ...
            <div className="grid gap-4 md:gap-8">
              ...
              <div className="bg-white rounded-lg shadow-md md:shadow-lg overflow-hidden">
                <div className="p-3 md:p-6">
                  ...
                  <p className="hidden md:block text-gray-600 mb-6">
                    ...
                    Это обучение охватывает правильные методы применения, соображения безопасности и достижение оптимальных результатов для этой чувствительной области.
                  </p>
              ...
              <div className="bg-white rounded-lg shadow-md md:shadow-lg overflow-hidden">
                <div className="p-3 md:p-6">
                  ...
                  <p className="hidden md:block text-gray-600 mb-6">
                    Освойте профессиональные техники процедуры HR3 Matrix с использованием технологии Genosys.
              ...
              <div className="bg-white rounded-lg shadow-md md:shadow-lg overflow-hidden">
                <div className="p-3 md:p-6">
                  ...
                  <p className="hidden md:block text-gray-600 mb-6">
                    ...
                    Этот комплексный урок охватывает протоколы матричного лечения, профессиональные методы применения и достижение оптимальных результатов для омоложения кожи и улучшения матрикса.
                  </p>
