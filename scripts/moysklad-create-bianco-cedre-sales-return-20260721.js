 ...
 *
 *   00042 EGF Repair Oxymask Cream 50ml ×1 @ 145 clinic
 *   00041 Multi Sun Cream SPF40 40g ×1 @ 105 clinic
 *   00143 Cushion #1 Ivory ×1 @ 150 clinic
 *   Total: 400.00 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-bianco-cedre-sales-return-20260721.js
 *   node --import dotenv/config scripts/moysklad-create-bianco-cedre-sales-return-20260721.js --commit
 */
...
const MARKER = `BIANCO-CEDRE-RETURN-EGF-SPF40-IVORY-${uaeToday()}`

/** [code, qty, clinicAed] */
const LINES = [
  ['00042', 1, 145], // EGF Oxymask
  ['00041', 1, 105], // SPF40
  ['00143', 1, 150], // Ivory cushion
]
...
async function main() {
  console.log('====================================================================')
  console.log('  Bianco Cedre (Silicon Oasis) — consignment return')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/salesreturn', {
    ...
    description: [
      MARKER,
      'Bianco Silicon Oasis / Cedre — consignment return collected.',
      '00042 EGF x1 @145; 00041 SPF40 x1 @105; 00143 Ivory x1 @150.',
    ].join(' | '),
    positions,
  })
