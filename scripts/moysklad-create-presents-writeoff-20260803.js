...
/**
 * Presents — warehouse write-off @ buyPrice (2026-08-03):
 *   54470 BIO-MESO PDRN Expert 60000 ×2
 *   00015 SRS vial 2ml ×10
 *   00069 Power Solution CTS vial 2ml ×10
 *   00065 Power Solution PCS vial 2ml ×10
 *   00038 Soothing Repair Post Cream 20g ×2
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260803.js
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260803.js --commit
 */
...
const MARKER = `PRESENTS-PDRN60000-SRS-CTS-PCS-POSTCREAM-${uaeToday()}`

const LINES = [
  ['54470', 2, 'BIO-MESO PDRN Expert Ampoule 60000'],
  ['00015', 10, 'SRS peeling vial 2ml'],
  ['00069', 10, 'Power Solution CTS vial 2ml'],
  ['00065', 10, 'Power Solution PCS vial 2ml'],
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents — write-off @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'PDRN 60000 x2, SRS x10, CTS x10, PCS x10, post cream 20g x2.',
    ].join(' | '),
