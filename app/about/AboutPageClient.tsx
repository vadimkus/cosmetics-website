    ...
    >
      ...
      {isAppLikeMode ? (
        ...
        <div className="max-w-6xl mx-auto">
          <nav className={`text-xs md:text-sm text-gray-500 mb-2 md:mb-4 ${dir === 'rtl' ? 'text-right' : ''}`} aria-label="Breadcrumb">
            <Link href={getLocalizedPath('/', locale)} className="hover:text-gray-900 transition-colors">{t('common.home')}</Link>
            <span className="mx-1.5">/</span>
            <span className="text-gray-900">{t('common.about')}</span>
          </nav>
          ...
          <header className="mb-12 md:mb-16">
            ...
            <h1 className={`mt-3 max-w-4xl text-3xl md:text-5xl lg:text-[3.4rem] font-semibold leading-[1.05] tracking-tight text-gray-900 ${dir === 'rtl' ? 'text-right' : ''}`}>
              {locale === 'ar'
            ...
            <p className={`mt-4 max-w-2xl text-base md:text-lg leading-relaxed text-gray-600 ${dir === 'rtl' ? 'text-right' : ''}`}>
              {locale === 'ar'
            ...
            <dl className="mt-8 hidden md:grid md:grid-cols-4 gap-px overflow-hidden rounded-2xl border border-gray-200 bg-gray-200">
              <div className="bg-white px-6 py-5">
                ...
                <dd className="mt-2 flex items-baseline gap-2 text-3xl font-semibold tracking-tight text-gray-900">
                  ...
                  <span className="text-sm font-medium text-gray-500">{locale === 'ar' ? 'منذ 2019' : locale === 'ru' ? 'с 2019' : 'since 2019'}</span>
                </dd>
              </div>
              <div className="bg-white px-6 py-5">
                <dt className="flex items-center gap-2 text-[11px] font-mono uppercase tracking-[0.2em] text-gray-500">
                ...
                <dd className="mt-2 flex items-baseline gap-2 text-3xl font-semibold tracking-tight text-gray-900">
                  <span>2</span>
                  <span className="text-sm font-medium text-gray-500">RAK · Dubai</span>
                </dd>
              </div>
              <div className="bg-white px-6 py-5">
                <dt className="flex items-center gap-2 text-[11px] font-mono uppercase tracking-[0.2em] text-gray-500">
                ...
                <dd className="mt-2 flex items-baseline gap-2 text-3xl font-semibold tracking-tight text-gray-900">
                  <span>3</span>
                  <span className="text-sm font-medium text-gray-500">DM · Montaji · TDRA</span>
                </dd>
              </div>
              <div className="bg-white px-6 py-5">
                <dt className="flex items-center gap-2 text-[11px] font-mono uppercase tracking-[0.2em] text-gray-500">
                  <Globe2 className="h-3.5 w-3.5 text-red-600" />
                  {locale === 'ar' ? 'المنشأ' : locale === 'ru' ? 'происхождение' : 'origin'}
                </dt>
                <dd className="mt-2 flex items-baseline gap-2 text-3xl font-semibold tracking-tight text-gray-900">
                  <span className="text-2xl">🇰🇷</span>
                  <span className="text-sm font-medium text-gray-500">{locale === 'ar' ? 'سيول، كوريا' : locale === 'ru' ? 'Сеул, Корея' : 'Seoul, Korea'}</span>
                </dd>
              </div>
            </dl>
          </header>
          ...
          <section className="mb-12 md:mb-16 grid gap-6 md:grid-cols-12 md:gap-10">
            <article className={`md:col-span-7 ${dir === 'rtl' ? 'text-right' : ''}`}>
              <p className="text-[11px] font-mono uppercase tracking-[0.28em] text-gray-500">01</p>
              <h2 className={`mt-2 flex items-center gap-3 text-2xl md:text-3xl font-semibold tracking-tight text-gray-900 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                <Sparkles className="h-6 w-6 text-red-600" aria-hidden="true" />
                {t('about.aboutUs')}
              </h2>
              <div className="mt-5 space-y-4 text-base leading-relaxed text-gray-700">
                ...
                <p>
                  {t('about.productsCertifiedDescription')}{' '}
                  <a href="https://www.dm.gov.ae/" target="_blank" rel="noopener noreferrer" className="text-red-600 underline underline-offset-4 decoration-red-300 hover:decoration-red-600 transition-colors">
                    {t('about.dubaiMunicipality')}
                  </a>.
                </p>
              </div>
            ...
            <aside className={`md:col-span-5 ${dir === 'rtl' ? 'text-right' : ''}`}>
              <div className="relative h-full rounded-2xl border border-gray-200 bg-gray-50 p-7 md:p-8">
                <span aria-hidden className={`absolute top-7 ${dir === 'rtl' ? 'right-0' : 'left-0'} h-12 w-1 bg-red-600`} />
                <p className="text-[11px] font-mono uppercase tracking-[0.28em] text-gray-500">02</p>
                <h2 className={`mt-2 flex items-center gap-3 text-xl md:text-2xl font-semibold tracking-tight text-gray-900 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
          ...
          <section className="mb-12 md:mb-16">
            <div className={`mb-6 flex items-end justify-between gap-4 ${dir === 'rtl' ? 'flex-row-reverse text-right' : ''}`}>
              <div className={dir === 'rtl' ? 'text-right' : ''}>
                <p className="text-[11px] font-mono uppercase tracking-[0.28em] text-gray-500">03</p>
                <h2 className="mt-2 text-2xl md:text-3xl font-semibold tracking-tight text-gray-900">
                  {t('about.legalInformationContact')}
                </h2>
              </div>
              <span className="hidden md:inline text-xs font-mono uppercase tracking-[0.2em] text-gray-400">
            ...
            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-gray-200 bg-gray-200 md:grid-cols-3">
              ...
              <div className={`bg-white p-6 md:p-7 ${dir === 'rtl' ? 'text-right' : ''}`}>
                ...
                <dl className="space-y-3 text-sm">
                  ...
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                    <dt className="text-gray-500 flex-shrink-0">TRN</dt>
                    <dd className={dir === 'rtl' ? 'text-left' : 'text-right'}>
                      <PDFLinkButton href="/documents/genosys-trn-104229886700003.pdf" filename="GENOSYS-TRN-104229886700003.pdf" download="GENOSYS-TRN-104229886700003.pdf" className="text-red-600 underline underline-offset-2 decoration-red-300 hover:decoration-red-600 font-medium transition-colors">104229886700003</PDFLinkButton>
                    </dd>
                  </div>
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                  ...
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                    ...
                    <dd className={`text-gray-900 font-medium ${dir === 'rtl' ? 'text-left' : 'text-right'}`}>Cordoba Residence, E02</dd>
                  </div>
                </dl>
              </div>
              ...
              <div className={`bg-white p-6 md:p-7 ${dir === 'rtl' ? 'text-right' : ''}`}>
                <div className={`flex items-center gap-2.5 mb-4 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                  <PhoneIcon className="h-4 w-4 text-red-600" aria-hidden="true" />
                  <h3 className="text-xs font-mono uppercase tracking-[0.2em] text-gray-500">
                ...
                <dl className="space-y-3 text-sm">
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                    <dt className="text-gray-500 flex-shrink-0">{t('contact.phoneWhatsapp')}</dt>
                    <dd className={dir === 'rtl' ? 'text-left' : 'text-right'}>
                      <a href="tel:+971585487665" className="text-gray-900 hover:text-red-600 font-medium transition-colors" dir="ltr">+971 58 548 76 65</a>
                    </dd>
                  </div>
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                    <dt className="text-gray-500 flex-shrink-0 inline-flex items-center gap-1.5"><Mail className="h-3.5 w-3.5" />{t('about.email')}</dt>
                    <dd className={dir === 'rtl' ? 'text-left' : 'text-right'}>
                      <a href="mailto:sales@genosys.ae" className="text-gray-900 hover:text-red-600 font-medium transition-colors" dir="ltr">sales@genosys.ae</a>
                    </dd>
                  </div>
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                    <dt className="text-gray-500 flex-shrink-0 inline-flex items-center gap-1.5"><Globe2 className="h-3.5 w-3.5" />{t('about.website')}</dt>
                    <dd className={dir === 'rtl' ? 'text-left' : 'text-right'}>
                      <a href="https://genosys.ae" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-red-600 font-medium transition-colors" dir="ltr">genosys.ae</a>
                    </dd>
                  </div>
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                    <dt className="text-gray-500 flex-shrink-0 inline-flex items-center gap-1.5"><Instagram className="h-3.5 w-3.5" />{t('about.instagram')}</dt>
                    <dd className={dir === 'rtl' ? 'text-left' : 'text-right'}>
                      <a href="https://www.instagram.com/genosys.uae/" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-red-600 font-medium transition-colors" dir="ltr">@genosys.uae</a>
                    </dd>
                  </div>
                </dl>
              </div>
              ...
              <div className={`bg-white p-6 md:p-7 ${dir === 'rtl' ? 'text-right' : ''}`}>
                <div className={`flex items-center gap-2.5 mb-4 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                  <IconOfficialDistributor className="h-4 w-4 text-red-600" />
                  <h3 className="text-xs font-mono uppercase tracking-[0.2em] text-gray-500">
                ...
                <dl className="space-y-3 text-sm">
                  ...
                  <div className={`flex items-baseline justify-between gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                    <dt className="text-gray-500 flex-shrink-0">{locale === 'ru' ? 'Сертификат' : locale === 'ar' ? 'الاعتماد' : 'Certified'}</dt>
