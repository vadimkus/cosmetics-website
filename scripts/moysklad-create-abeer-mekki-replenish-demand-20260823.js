...
/**
 * Abeer Mekki — consignment replenishment into agreement 31 + stock note PDF.
 *
 * Clinic list, no discount on placement — −10% at commission-report settlement.
 *
 *   node --import dotenv/config scripts/moysklad-create-abeer-mekki-replenish-demand-20260823.js
 *   node --import dotenv/config scripts/moysklad-create-abeer-mekki-replenish-demand-20260823.js --commit
 */
...
const AGENT_ID = '39a7af2b-f5d0-11f0-0a80-108500063cb5'
const CONTRACT_ID = 'a5ab62b9-f5d1-11f0-0a80-1085000693a6'
const STATE_DEMAND_SHIPPED_ID = '50d70717-4582-11ea-0a80-05e3001273a2'
const STOCK_NOTE_TEMPLATE_ID = '09ef2604-4a14-4571-bc17-dc266c9190c3'
const ORDERS_DIR = path.join(os.homedir(), 'Desktop', 'orders')

const MARKER = `ABEER-MEKKI-REPLENISH-SNOW-ON-AFS-RAD-HYAL-EYE-PDRN-${uaeToday()}`
...
const EXPECTED_SUM_MINOR = 1160000
...
async function exportStockNotePdf(demandId, demandName) {
  ...
  const out = path.join(ORDERS_DIR, `GENOSYS_ABEER_MEKKI_${safe}_Consignment_Stock_Note.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Abeer Mekki — replenishment into agreement 31')
  console.log('====================================================================')
  ...
  if (agent.name !== 'ABEER MEKKI BEAUTY LADIES CENTER - L.L.C - S.P.C') {
    throw new Error(`Unexpected agent: ${agent.name}`)
  }
  if (contract.name !== '31') throw new Error(`Unexpected contract: ${contract.name}`)
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      MARKER,
      'ABEER MEKKI BEAUTY LADIES CENTER — Agreement 31.',
      'Replenishment: Snow 180, overnight, AFS serum, radiance 50g, hyaluron cream/serum, EyeCell kit, PDRN mask, EZ CO2, PDRN 60000/5000 @ clinic list, no discount.',
      '−10% applied at commission-report settlement when sold.',
    ].join('\n'),
    positions,
  })
