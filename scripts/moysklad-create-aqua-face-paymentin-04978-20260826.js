...
/**
 * Aqua Face Facialbar Ltd — paymentin @ shipment 06743 / invoice 04978.
 * 445 AED. Order GENCardM2608266594 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-aqua-face-paymentin-04978-20260826.js
 *   node --import dotenv/config scripts/moysklad-create-aqua-face-paymentin-04978-20260826.js --commit
 */
...
const MARKER = 'AQUA-FACE-PAYMENTIN-04978-2026-08-26'

const PAYMENT = {
  amountMinor: 44500,
  invoiceName: '04978',
  invoiceId: '1183854e-a111-11f1-0a80-1a71001840c0',
  shipmentName: '06743',
  shipmentId: '1298c806-a111-11f1-0a80-0bbb0017be3d',
  orderName: 'GENCardM2608266594',
  orderId: '111e7e19-a111-11f1-0a80-05b2001730cf',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Aqua Face — paymentin @ 04978 / 06743')
  console.log('====================================================================')
  ...
  if (order.agent?.name !== 'Aqua Face Facialbar Ltd') throw new Error(`Unexpected agent: ${order.agent?.name}`)
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Clinic order paid — PDRN mask x2 @200 + delivery 45.',
    ].join(' | '),
    operations: [
      {
        meta: {
