...
/**
 * Evolution Aesthetics Clinic — paymentin @ shipment 06497 / invoice 04783.
 * Order GENCardM260708EVCL → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-evolution-paymentin-04783-20260716.js
 *   node --import dotenv/config scripts/moysklad-create-evolution-paymentin-04783-20260716.js --commit
 */
...
const AGENT_ID = '89d4bfbd-81d1-11ed-0a80-0ffb0008d1c5'
const STATE_ORDER_DELIVERED_ID = 'e1a0ae5f-33c5-11ea-0a80-043f000b275e'

const MARKER = 'EVOLUTION-PAYMENTIN-04783-2026-07-16'

const PAYMENT = {
  amountMinor: 51000,
  invoiceName: '04783',
  invoiceId: '61571594-7aa9-11f1-0a80-078b00141492',
  shipmentName: '06497',
  shipmentId: '62351914-7aa9-11f1-0a80-1e2a00143107',
  orderName: 'GENCardM260708EVCL',
  orderId: '610f0328-7aa9-11f1-0a80-0eda0013ce85',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Evolution Aesthetics Clinic — paymentin @ 04783 / 06497')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Snow O2 cleanser 500ml x2 — paid.',
    ].join(' | '),
    operations: [
      {
        meta: {
