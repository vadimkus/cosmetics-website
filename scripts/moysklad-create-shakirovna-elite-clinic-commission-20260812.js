...
/**
 * Shakirovna Business Bay — consignment sold 26.07.2026–10.08.2026.
 * ELITE SHAKIROVNA LADIES SALON (contract 21) + SHAKIROVNA ESTHETIC CLINIC (contract 26).
 *
 * From Tamara sales table (Salon / Clinic):
 *   Salon: Sea Algae ×2, Problem Control Toner 200ml ×1
 *   Clinic: Eye Contour Cream ×1, Eye Peptide Gel Patch ×1, Multi Sun SPF40 ×1
 *
 * Reports only (no matching demand). PDFs → ~/Desktop/orders/
 *
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-elite-clinic-commission-20260812.js
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-elite-clinic-commission-20260812.js --commit
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-elite-clinic-commission-20260812.js --commit --report=elite
 */
...
const COMMON = {
  ...
  commissionPeriodStart: '2026-07-26 00:00:00',
  commissionPeriodEnd: '2026-08-10 23:59:59',
}

const MARKER_BASE = 'Shakirovna ELITE+CLINIC consignment sold 2026-07-26 to 2026-08-10'
...
async function main() {
  console.log('====================================================================')
  console.log('  Shakirovna Elite + Clinic — consignment 26.07–10.08.2026')
  console.log('====================================================================')
  ...
  for (const cfg of filtered) {
    ...
    const report = await api('POST', '/entity/commissionreportin', {
      ...
      description: [
        cfg.marker,
        `Sold table 26.07.2026–10.08.2026 Business Bay — ${cfg.title}.`,
