...
/**
 * Miss Irina Solodkaya (Iryna Solodka) — unpaid clinic SO → invoice → shipment.
 * Mist ×6 @ 80 + Blemish Balm Cream ×1 @ 125 + Collagen Mask ×6 @ 18
 * + delivery Dubai @ 45 = 758 AED.
 * Invoice PDF → ~/Desktop/orders/ (no print, no payment).
 *
 *   node --import dotenv/config scripts/moysklad-create-iryna-solodka-order-invoice-demand-20260813.js
 *   node --import dotenv/config scripts/moysklad-create-iryna-solodka-order-invoice-demand-20260813.js --commit
 */
...
const CUSTOMER = {
  name: 'Miss Irina Solodkaya',
  phone: '+380 67 380 5770',
  city: 'Dubai',
  street: 'Emar South, GreenView 1, Villa 6',
}

const ORDER = {
  name: `GENCardM${uaeShortDate()}5770`,
  moment: uaeMomentNow(),
  marker: `IRYNA-SOLODKA-MIST-BB-COLLAGEN-${uaeToday()}`,
}

/** [code, qty, clinicAed] — оптовая, same as her May 28 / Jul 16 orders */
const PRODUCT_LINES = [
  ['00188', 6, 80], // Microbiome Energy Infusing Mist 80ml
  ['00040', 1, 125], // Intensive Blemish Balm Cream 50g
  ['00063', 6, 18], // Intensive Repair Collagen Mask 23g
]
const DELIVERY_AED = 45
const EXPECTED_SUM_MINOR = 75800 // 6×80 + 125 + 6×18 + 45
...
async function exportInvoicePdf(invoiceId, invoiceName) {
  ...
  const outPath = path.join(ORDERS_DIR, `GENOSYS_Iryna_Solodka_${safe}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Irina Solodkaya — mist ×6 + BB cream + collagen ×6 + 45')
  console.log('====================================================================')
  ...
  console.log(`  Total: ${money(sumMinor)} AED (unpaid, clinic list)`)
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00188 Mist x6 @80; 00040 Blemish Balm Cream x1 @125; 00063 Collagen Mask x6 @18; delivery Dubai @45.',
