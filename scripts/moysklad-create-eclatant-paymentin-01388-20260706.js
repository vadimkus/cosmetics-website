...
/**
 * ECLATANT&CO — full paymentin for commissioner report 01388 (1,498 AED).
 *
 *   node --import dotenv/config scripts/moysklad-create-eclatant-paymentin-01388-20260706.js
 *   node --import dotenv/config scripts/moysklad-create-eclatant-paymentin-01388-20260706.js --commit
 */
...
const CONTRACT_ID = '132684fd-1a99-11f0-0a80-071f0006a1ec' // Agreement 18
const BANK_ACCOUNT_ID = 'e1852e1c-33c5-11ea-0a80-043f000b2739'
const REPORT_ID = 'fdd071a2-7542-11f1-0a80-0134001c388e'
const REPORT_NAME = '01388'
const PAYMENT_MINOR = 149800 // 1,498.00 AED
const MARKER = `ECLATANT-CONSIGNMENT-PAYMENT-${REPORT_NAME}-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Eclatant — paymentin @ commissioner report 01388 (full)')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'ECLATANT&CO — June 2026 consignment sales — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
