...
/**
 * Valeriya Borsheva (Dr. Valeria Borscheva) — retail order + invoice.
 *
 * Lines: Sea Algae mask (00140) ×3, Collagen mask (00063) ×3,
 *        Cushion #2 Beige (00144) ×2, Excellent Delivery Dubai 45 AED.
 * Prices: MoySklad list (salePrice).
 *
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borsheva-masks-order-invoice-20260528.js
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borsheva-masks-order-invoice-20260528.js --commit
 */
...
const ORDER_SUFFIX = '9446' // phone 0525829446

const ORDER = {
  name: `GENCardM${uaeShortDate()}${ORDER_SUFFIX}`,
  moment: uaeMomentNow(),
  marker: `Valeriya Borsheva masks cushion delivery ${uaeToday()}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Valeriya Borsheva — order + invoice (masks + cushion)')
  console.log('====================================================================')
  ...
  const orderPayload = {
    ...
    description: [
      ORDER.marker,
      'Sea Algae 00140 x3, Collagen 00063 x3, Cushion Beige 00144 x2, Dubai delivery 45 AED',
    ].join(' | '),
