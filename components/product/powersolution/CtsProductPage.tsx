...
import { CTS_VARIANT } from './ctsCopy'
import PowerSolutionProductPage from './PowerSolutionProductPage'

/**
 * POWER SOLUTION CTS, product 6. See ctsCopy.ts for the sourcing.
 *
 ...
 */
export default function CtsProductPage(props: {
  product: Product
  unitsSold?: number
  routineProducts?: Product[]
}) {
  return <PowerSolutionProductPage {...props} variant={CTS_VARIANT} />
}
