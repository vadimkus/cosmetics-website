...
const content = `<div class="blog-content">
  ...
  <div class="bg-gray-900 text-white rounded-2xl p-6 md:p-10 mb-10">
    ...
    <div class="grid grid-cols-2 gap-6 max-w-md mx-auto">
      <a href="https://apps.apple.com/app/id6756648064" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center gap-3 bg-white/10 rounded-xl p-5 hover:bg-white/20 transition-colors">
