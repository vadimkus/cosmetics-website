...
/**
 * Present to Sara — warehouse write-off @ buyPrice (2026-07-05):
 *   54475 BIO-MESO PDRN Homecare Ampoule 5000 ×1
 *   54465 Soothing Repair Post Cream 100g ×1
 *   00012 Peptide Gel Mask 39g ×5
 *
 *   node --import dotenv/config scripts/moysklad-create-sara-present-writeoff-20260705.js
 *   node --import dotenv/config scripts/moysklad-create-sara-present-writeoff-20260705.js --commit
 */
...
const MARKER = `PRESENT-SARA-WRITE-OFF-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Present to Sara — warehouse write-off @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Promotional present to Sara — warehouse write-off at buyPrice.',
      '54475 PDRN Homecare 5000 x1, 54465 post cream 100g x1, 00012 peptide gel mask x5.',
    ].join(' | '),
