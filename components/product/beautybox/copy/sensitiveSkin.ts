...
const AR: BeautyBoxCopy = {
  ...
  heroBullets: [
    ...
    'سيراميد NP بتركيز 5,000 جزء في المليون مع غليسرين 17.49% في كريم الحاجز',
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        productNumber: '27',
        quantity: 1,
        step: 'الخطوة 4 - الكريم',
        body:
          'كريم غني للبشرة الحساسة والجافة يجمع سيراميد NP بتركيز 0.5% مع الغليسرين 17.49% وزبدة الشيا 3%. يساعد على الاحتفاظ بالرطوبة وتنعيم المناطق الجافة ودعم حاجز البشرة.',
        facts: ['سيراميد NP 5,000 ppm', 'غليسرين 17.49%', 'زبدة الشيا 3%', 'الأس الهيدروجيني 6.07', 'يحتوي على عطر'],
      },
      {
        titleKey: 'routineOvernightMaskTitle',
        productNumber: '34',
  ...
  howTo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          'يُوزع على الوجه بعد السيروم مع تجنب محيط العينين، ثم يُربت بلطف بأطراف الأصابع. ويُختتم الروتين الصباحي بواقي الشمس.',
      },
      {
  ...
  evidence: {
    ...
    cards: [
      ...
      {
        value: '5,000 ppm',
        title: 'سيراميد NP بتركيز 0.5% في كريم الحاجز',
        body:
          'يعادل التركيز 5,000 جزء في المليون، وتدعمه قاعدة مرطبة غنية بالغليسرين 17.49% وزبدة الشيا 3% لتنعيم البشرة الحساسة والجافة.',
      },
    ],
    footnote:
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'أُوقف إنتاج EGF Repair Oxymask نهائياً، لذلك أصبح قناع Skin Rescue الليلي بوزن 100 غ جزءاً من المجموعة. يُستخدم كخطوة أخيرة مرة أو مرتين أسبوعياً ويُترك حتى الصباح. وفي تقييم استمر أربعة أسابيع، تحسن الاحمرار بنسبة 26% وانخفض فقدان الماء عبر البشرة بنسبة 15%.',
      },
      {
...
const RU: BeautyBoxCopy = {
  ...
  heroBullets: [
    ...
    'Церамид NP 5 000 ppm и глицерин 17,49% в барьерном креме',
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        step: 'Шаг 4 - Крем',
        body:
          'Насыщенный крем для чувствительной и сухой кожи с церамидом NP 0,5%, глицерином 17,49% и маслом ши 3%. Помогает удерживать влагу, смягчает сухие участки и поддерживает защитный барьер.',
        facts: ['Церамид NP 5 000 ppm', 'Глицерин 17,49%', 'Масло ши 3%', 'pH 6,07', 'Содержит отдушку'],
      },
      {
        titleKey: 'routineOvernightMaskTitle',
        productNumber: '34',
  ...
  howTo: {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          'Нанесите на лицо после сыворотки, избегая области вокруг глаз, и мягко прижмите подушечками пальцев. Утром завершите уход солнцезащитным средством.',
      },
      {
  ...
  evidence: {
    ...
    cards: [
      ...
      {
        value: '5 000 ppm',
        title: 'Церамид NP 0,5% в барьерном креме',
        body:
          'Концентрация соответствует 5 000 ppm. Глицерин 17,49% и масло ши 3% дополняют формулу, помогая смягчать чувствительную и сухую кожу.',
      },
    ],
    footnote:
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'EGF Repair Oxymask окончательно снята с производства, поэтому теперь в набор входит ночная крем-маска Skin Rescue объёмом 100 г. Используйте её последним шагом один-два раза в неделю и оставляйте до утра. В четырёхнедельной оценке выраженность покраснения уменьшилась на 26%, а трансэпидермальная потеря влаги — на 15%.',
      },
      {
