...
/**
 * Presents to customers — warehouse write-off @ buyPrice (2026-07-31):
 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260731.js
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260731.js --commit
 */
...
const MARKER = `PRESENTS-SPF50-BEIGE-COLLAGEN-SEA-PEPTIDE-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents to customers — write-off @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Presents to customers — warehouse write-off at buyPrice.',
      'SPF50 x1, beige cushion x1, collagen x10, sea algae x10, peptide gel mask x5.',
    ].join(' | '),
