...
/**
 * FAMILY CLASS POLY CLINIC L.L.C — paymentin @ shipment 06563 / invoice 04836.
 * Order GENCardM260718FCHS → Доставлен. Amount 675 AED.
 *
 *   node --import dotenv/config scripts/moysklad-create-family-class-paymentin-04836-20260722.js
 *   node --import dotenv/config scripts/moysklad-create-family-class-paymentin-04836-20260722.js --commit
 */
...
const MARKER = 'FAMILY-CLASS-PAYMENTIN-04836-2026-07-22'

const PAYMENT = {
  amountMinor: 67500,
  invoiceName: '04836',
  invoiceId: 'db64035e-8297-11f1-0a80-0dc8003a2f2c',
  shipmentName: '06563',
  shipmentId: 'dd09cab4-8297-11f1-0a80-1164003ad71e',
  orderName: 'GENCardM260718FCHS',
  orderId: 'dacf1c56-8297-11f1-0a80-069700399977',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Family Class Polyclinic — paymentin @ 04836 / 06563')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Clinic order paid — shampoo x2, tonic x2, delivery 45.',
    ].join(' | '),
    operations: [
      {
        meta: {
