 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-postcream-100g-writeoff-20260817.js
 *   node --import dotenv/config scripts/moysklad-create-postcream-100g-writeoff-20260817.js --commit
 */
...
const MARKER = `WRITE-OFF-POSTCREAM-100G-54465-${uaeToday()}`

const LINES = [['54465', 1, 'Soothing Repair Post Cream 100g']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Write-off — Soothing Repair Post Cream 100g ×1')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'Soothing Repair Post Cream 100g x1.',
    ].join(' | '),
