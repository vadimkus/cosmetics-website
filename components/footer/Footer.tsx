        ...
        <div className="hidden md:flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-gray-100 pb-8">
          ...
          <div className={`flex flex-wrap items-center gap-x-3 gap-y-2 ${locale === 'ar' ? 'flex-row-reverse' : ''}`}>
            <div className="flex items-center gap-2" aria-label="Accepted payment methods">
              ...
              {/* Visa */}
              <span
                className="inline-flex items-center justify-center h-7 w-11 rounded-md border border-gray-200 bg-white px-1.5"
                aria-label="Visa"
                title="Visa"
              >
              ...
              <span
                ...
                title="Apple Pay"
              >
                <svg viewBox="0 0 40 16" className="h-4 w-auto" aria-hidden="true" fill="#000">
            ...
            <span className="inline-flex items-center gap-1.5 text-[11px] text-gray-500 border-l border-gray-200 pl-3 ml-1">
