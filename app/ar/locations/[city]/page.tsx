...
const locations: Record<string, {
  ...
  dubai: {
    ...
    description: 'GENOSYS الشرق الأوسط يخدم دبي بمستحضرات التجميل الكورية الاحترافية والتدريب على العناية بالبشرة. توصيل سريع في جميع أنحاء دبي مع شحن مجاني للطلبات فوق 1000 درهم.',
  ...
  'abu-dhabi': {
    ...
    description: 'GENOSYS الشرق الأوسط يوصل مستحضرات التجميل الكورية الاحترافية إلى أبوظبي والعين. منتجات العناية بالبشرة عالية الجودة متاحة من خلال موزعنا المعتمد.',
  ...
  sharjah: {
    ...
    description: 'GENOSYS الشرق الأوسط يقدم مستحضرات التجميل الكورية الاحترافية إلى الشارقة. منتجات العناية بالبشرة عالية الجودة والتدريب الاحترافي متاحان.',
  ...
  ajman: {
    ...
    description: 'GENOSYS الشرق الأوسط يوصل مستحضرات التجميل الكورية الاحترافية إلى عجمان. منتجات العناية بالبشرة عالية الجودة متاحة مع توصيل موثوق.',
  ...
  fujairah: {
    ...
    description: 'GENOSYS الشرق الأوسط يقدم مستحضرات التجميل الكورية الاحترافية إلى الفجيرة. منتجات العناية بالبشرة عالية الجودة يتم توصيلها في جميع أنحاء الإمارة.',
  ...
  'umm-al-quwain': {
    ...
    description: 'GENOSYS الشرق الأوسط يخدم أم القيوين بمستحضرات التجميل الكورية الاحترافية. منتجات العناية بالبشرة عالية الجودة يتم توصيلها في جميع أنحاء الإمارة.',
...
export async function generateMetadata({ params }: LocationPageProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      `العناية بالبشرة الاحترافية ${location.name}`,
