...
/**
 * Present to Vaness — warehouse write-off @ buyPrice (2026-07-05):
 ...
 *   54467 Skin Reboot PDRN Mask Pack 350g ×1
 *   00011 EZ CO₂ MASK Professional Box ×1
 *   00041 Multi Sun Cream SPF40/PA++ 40g ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-vaness-present-writeoff-20260705.js
 *   node --import dotenv/config scripts/moysklad-create-vaness-present-writeoff-20260705.js --commit
 */
...
const MARKER = `PRESENT-VANESS-WRITE-OFF-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Present to Vaness — warehouse write-off @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Promotional present to Vaness — warehouse write-off at buyPrice.',
      '54458 hyaluron cream 50g x1, 00195 hyaluron serum x1, 00024 Snow O₂ cleanser 500ml x1, 54467 PDRN mask pack x1, 00011 EZ mask box x1, 00041 SPF40 x1.',
    ].join(' | '),
