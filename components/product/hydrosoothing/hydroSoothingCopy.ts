...
const AR: HydroSoothingCopy = {
  ...
  subheadline:
    'كريم جل شفاف وخفيف بقاعدة مرطبة نسبتها 21.7%: بيوتلين غليكول 10.555% وغليسرين 6.175% وبيتين 5%. أظهر الاختبار انخفاض حرارة البشرة بنحو درجة مئوية واحدة بعد 20 دقيقة من التطبيق، وارتفاع ترطيبها بنسبة 12% خلال أربعة أسابيع. خيار منعش للبشرة المتعطشة للماء في الحر والهواء المكيّف.',
  heroBullets: [
  ...
  clinical: {
    eyebrow: 'ما تم قياسه',
    title: 'نتيجتان واضحتان للعناية اليومية',
    intro:
      'يجمع القوام الخفيف بين إحساس فوري بالانتعاش وتحسن تدريجي في مستوى الترطيب مع الاستخدام المنتظم.',
    findings: [
      {
        value: '−1 °C',
        label: 'حرارة البشرة، بعد عشرين دقيقة من التطبيق',
        body: 'إحساس منعش يبرز عندما تكون البشرة دافئة بعد الحر أو بعد جلسة عناية، من دون ثقل أو طبقة دهنية.',
      },
      {
        value: '+12%',
        label: 'ترطيب البشرة، بعد أربعة أسابيع من الاستخدام المنتظم',
        body: 'تحسن مقاس بعد أربعة أسابيع من الاستخدام المنتظم، تدعمه قاعدة مرطبة عالية مع قوام جل خفيف.',
      },
    ],
    caveat:
      'النتيجتان تخصان قياسات المنتج: نحو −1 °م في حرارة البشرة بعد 20 دقيقة، و+12% في الترطيب خلال أربعة أسابيع. تختلف الاستجابة الفردية بحسب حالة البشرة والروتين.',
  },
  ...
  working: {
    ...
    intro:
      'ثلاثة مكونات مرطبة تشكل جوهر هذا الكريم وتمنحه قدرته على جذب الماء مع الحفاظ على ملمس خفيف.',
    items: [
      {
        name: 'Betaine',
        dose: '5.000%',
        body: 'أوسموليت يساعد البشرة على الحفاظ على توازن الماء والشعور بالراحة. بتركيز 5% هو الفعّال الرئيسي في التركيبة.',
      },
      {
      ...
      },
      {
        ...
        dose: '0.0500%',
        body: '500 جزء في المليون تكمل اتجاه التركيبة المرطب والمهدئ.',
      },
      {
        name: 'Sodium Hyaluronate',
        dose: '0.0500%',
      ...
      },
      {
        name: 'Phytolex SC',
        dose: '0.00765%',
        body: 'مركب من مستخلص الماش ولحاء البتولا وجذر الحمّاض، بتركيز إجمالي يقارب 76 جزءاً في المليون.',
      },
    ],
  },

  reorder: {
    eyebrow: 'قراءة التركيبة بدقة',
    title: 'ما الذي يرطب البشرة فعلاً؟',
    intro:
      'توضح التركيزات النهائية الفرق بين المواد الأساسية في الكريم والمكونات الموجودة بكميات دقيقة.',
    columns: { name: 'المكوّن', sheet: 'تركيز مزيج المادة', actual: 'التركيز النهائي' },
    rows: [
      { name: 'مرشّح إفراز الحلزون', sheet: '0.100%', actual: '10 ppm' },
  ...
  preservation: {
    ...
    title: 'من دون عطر، وغير نباتي',
    body:
      'لا تحتوي التركيبة على عطر أو بارابين أو فينوكسي إيثانول. تعتمد الحماية الميكروبيولوجية على 1,2-هكسانيديول 2% مع بنتيلين غليكول وكابريليل غليكول. ويعني وجود مرشّح إفراز الحلزون بتركيز 10 أجزاء في المليون أن المنتج غير نباتي.',
  },
    ...
    items: [
      {
        ...
        a: 'نعم. انخفضت حرارة البشرة المقاسة في المتوسط بنحو درجة مئوية واحدة بعد 20 دقيقة من التطبيق. ويمنح القوام الجل الخفيف إحساساً منعشاً من دون طبقة دهنية.',
      },
      {
        q: 'هل هذا كريم حلزون؟',
        a: 'يحتوي على مرشّح إفراز الحلزون، لكن بتركيز 10 أجزاء في المليون فقط. تأتي قوة الترطيب الأساسية من البيتين 5% وبيوتلين غليكول 10.555% والغليسرين 6.175%. وبسبب مكوّن الحلزون، المنتج غير نباتي.',
      },
      {
        q: 'ما هو البيتايين ولماذا يهمّ؟',
        a: 'البيتين أوسموليت يساعد البشرة على الحفاظ على توازن الماء والراحة. يوجد هنا بتركيز 5%، وهو أكبر فعّال في التركيبة وجزء رئيسي من قاعدتها المرطبة.',
      },
      {
...
const RU: HydroSoothingCopy = {
  ...
  subheadline:
    'Прозрачный лёгкий гель-крем с увлажняющей базой 21,7%: бутиленгликоль 10,555%, глицерин 6,175% и бетаин 5%. Через 20 минут после нанесения температура кожи снизилась примерно на 1 °C, а за четыре недели регулярного применения увлажнённость выросла на 12%. Освежающий уход для обезвоженной кожи в жару и кондиционированном воздухе.',
  heroBullets: [
  ...
  clinical: {
    ...
    title: 'Два измеримых результата',
    intro:
      'Лёгкая текстура даёт мгновенное ощущение свежести, а при регулярном применении помогает коже лучше сохранять влагу.',
    findings: [
      {
        value: '−1 °C',
        label: 'Температура кожи через двадцать минут после нанесения',
        body: 'Освежающий эффект особенно приятен, когда коже жарко после улицы или косметологической процедуры. Гель-крем не оставляет тяжёлой масляной плёнки.',
      },
      {
        value: '+12%',
        label: 'Увлажнённость кожи после четырёх недель регулярного применения',
        body: 'Результат измерен после четырёх недель регулярного применения и поддерживается высокой концентрацией водосвязывающих компонентов.',
      },
    ],
    caveat:
      'Результаты относятся к измерениям продукта: около −1 °C через 20 минут и +12% увлажнённости за четыре недели. Индивидуальный эффект зависит от состояния кожи и всего ухода.',
  },
  ...
  working: {
    ...
    intro:
      'Три увлажняющих компонента составляют основу крема и помогают удерживать воду без ощущения тяжести.',
    items: [
      {
        name: 'Betaine',
        dose: '5.000%',
        body: 'Ключевой актив и осмолит, который помогает коже поддерживать водный баланс и ощущение комфорта. В концентрации 5% он занимает центральное место в формуле.',
      },
      {
      ...
      },
      {
        ...
        dose: '0.0500%',
        body: '500 ppm алоэ дополняют увлажняющее и успокаивающее направление формулы.',
      },
      {
        name: 'Sodium Hyaluronate',
        dose: '0.0500%',
      ...
      },
      {
        name: 'Phytolex SC',
        dose: '0.00765%',
        body: 'Комплекс экстрактов мунга, коры берёзы и корня щавеля в суммарной концентрации около 76 ppm.',
      },
    ],
  },

  reorder: {
    eyebrow: 'Точный разбор формулы',
    title: 'Что действительно отвечает за увлажнение',
    intro:
      'Финальные концентрации показывают, какие компоненты формируют основу крема, а какие присутствуют в точном поддерживающем количестве.',
    columns: { name: 'Ингредиент', sheet: 'Концентрация смеси', actual: 'В готовой формуле' },
    rows: [
  ...
  quality: {
    eyebrow: 'Качество',
    title: 'Формула, проверенная по ключевым параметрам',
    intro:
  ...
  preservation: {
    ...
    title: 'Без отдушки, но не веганский',
    body:
      'В формуле нет отдушки, парабенов и феноксиэтанола. Микробиологическую стабильность поддерживают 1,2-гександиол 2%, пентиленгликоль и каприлилгликоль. Фильтрат секрета улитки присутствует в концентрации 10 ppm, поэтому средство не является веганским.',
  },
    ...
    items: [
      {
        ...
        a: 'Да. Через 20 минут после нанесения измеренная температура кожи снизилась в среднем примерно на 1 °C. Лёгкая гелевая текстура усиливает ощущение свежести и не оставляет тяжёлой плёнки.',
      },
      {
        q: 'Это улиточный крем?',
        a: 'Фильтрат секрета улитки присутствует, но всего в концентрации 10 ppm. Основное увлажняющее действие создают бетаин 5%, бутиленгликоль 10,555% и глицерин 6,175%. Из-за компонента улитки средство не является веганским.',
      },
      {
