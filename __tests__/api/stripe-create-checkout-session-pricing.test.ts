...
jest.mock('@/lib/stripe', () => ({
  ...
  aedToFils: jest.fn((amount: number) => Math.round(amount * 100)),
}))
...
jest.mock('@/lib/orderNumber', () => ({
  generateUniqueOrderNumber: jest.fn(async () => 'GENCardW2604260002'),
}))
...
describe('legacy web Stripe Checkout Session pricing', () => {
  beforeEach(() => {
    jest.clearAllMocks()
