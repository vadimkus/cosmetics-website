...
/**
 * Miss Ekaterina (Odessa) — paymentin @ shipment 06751 / invoice 04984.
 * 639 AED. Order GENCardM2608280763 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-ekaterina-odessa-paymentin-04984-20260829.js
 *   node --import dotenv/config scripts/moysklad-create-ekaterina-odessa-paymentin-04984-20260829.js --commit
 */
...
const AGENT_ID = 'ee9077cc-a312-11f1-0a80-137200429785'
const STATE_ORDER_DELIVERED_ID = 'e1a0ae5f-33c5-11ea-0a80-043f000b275e'

const MARKER = 'EKATERINA-ODESSA-PAYMENTIN-04984-2026-08-29'

const PAYMENT = {
  amountMinor: 63900,
  invoiceName: '04984',
  invoiceId: 'efa0766c-a312-11f1-0a80-17b00042cd6c',
  shipmentName: '06751',
  shipmentId: 'f09114fe-a312-11f1-0a80-182000415a79',
  orderName: 'GENCardM2608280763',
  orderId: 'ef3cb235-a312-11f1-0a80-0fb50042beed',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Ekaterina — paymentin @ 04984 / 06751')
  console.log('====================================================================')
  ...
  if (order.agent?.name !== 'Miss Ekaterina') throw new Error(`Unexpected agent: ${order.agent?.name}`)
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      `Order ${PAYMENT.orderName} — 639 AED.`,
    ].join(' | '),
    operations: [
      {
        meta: {
