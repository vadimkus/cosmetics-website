      ...
      <div className="flex-1 px-6 pb-8">
        ...
        <div className={`flex gap-3 mb-6 ${isRTL ? 'flex-row-reverse' : ''}`}>
          ...
          <button
            ...
            disabled={isLoading || !privacyConsent}
            className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 bg-[var(--cera-cta)] text-white rounded-xl ${!privacyConsent ? 'opacity-50' : 'hover:bg-[var(--cera-rose-ink)]'} transition-colors ${isRTL ? 'flex-row-reverse' : ''}`}
          >
