...
/**
 * Le Ciel — SO → invoice → shipment + Legal_TAX PDF.
 *
 ...
 *   Excellent Delivery Dubai ×1 @ 45 AED, 100% discount (Le Ciel never charged delivery)
 *
 *   node --import dotenv/config scripts/moysklad-create-le-ciel-skincare-order-invoice-demand-20260708.js --commit
 */
...
const ORDER = {
  ...
  moment: uaeMomentNow(),
  marker: `LE-CIEL-SKINCARE-ORDER-${uaeToday()}`,
}
...
const EXPECTED_SUM_MINOR = 75500
...
async function main() {
  console.log('====================================================================')
  console.log('  Le Ciel — SO + invoice + shipment (skincare)')
  console.log('====================================================================')
  console.log(`  Mode: ${COMMIT ? 'COMMIT' : 'DRY RUN'}`)
  console.log('  Delivery: free (100% discount) — no delivery on prior Le Ciel orders')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00021 cleanser 180ml, 00145 toner 200ml, 54457 Ultra Shield SPF50 x2, 00041 Multi Sun SPF40 x2 @ clinic list.',
      'Delivery Dubai 45 AED @ 100% discount (Le Ciel — no delivery charge).',
    ].join(' | '),
