...
/**
 * Admin Shakirovna Salon — order → invoice → shipment + PDF.
 *
 *   BB Cushion #3 Camel (54464) ×1 @ 150 AED
 *   Excellent Delivery Dubai ×1 @ 15 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-camel-cushion-order-invoice-demand-20260623.js
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-camel-cushion-order-invoice-demand-20260623.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}SHKC`,
  moment: uaeMomentNow(),
  marker: `ADMIN-SHAKIROVNA-CAMEL-CUSHION-${uaeToday()}`,
}

/** [code, qty, unitAed VAT incl.] */
const PRODUCT_LINES = [['54464', 1, 150]]
...
async function main() {
  console.log('====================================================================')
  console.log('  Admin Shakirovna Salon — camel cushion + delivery')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      'Camel cushion 54464 x1 @ 150 AED; delivery 15 AED.',
