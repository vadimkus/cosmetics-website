...
- Cart, checkout, profile routes, Partner Portal, skin recommendation, and training now share one enclosed minimal footer: compact trust cues, payment marks, legal links, and copyright.
