...
/**
 * Masks write-off @ buyPrice (2026-08-01):
 *   00013 Hydro Cool Modeling Mask 1kg ×1
 *   00063 Intensive Repair Collagen Mask ×2
 *   00140 Soothing Bomb Sea Algae Mask ×2
 *
 *   node --import dotenv/config scripts/moysklad-create-masks-writeoff-20260801.js
 *   node --import dotenv/config scripts/moysklad-create-masks-writeoff-20260801.js --commit
 */
...
const MARKER = `MASKS-HYDRO-COOL-COLLAGEN-SEA-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Masks — write-off @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'Hydro Cool Modeling Mask 1kg x1, collagen x2, sea algae x2.',
    ].join(' | '),
