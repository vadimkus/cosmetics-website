...
/**
 * Milena AESTHETIC CLINIC LLC (JBR Branch) — paymentin @ shipment 06719 / invoice 04957.
 * 440 AED. Order GENCardM260820MILJPC2 → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-milena-jbr-paymentin-04957-20260829.js
 *   node --import dotenv/config scripts/moysklad-create-milena-jbr-paymentin-04957-20260829.js --commit
 */
...
const MARKER = 'MILENA-JBR-PAYMENTIN-04957-2026-08-29'

const PAYMENT = {
  amountMinor: 44000,
  invoiceName: '04957',
  invoiceId: '89fc14a0-9c96-11f1-0a80-176e002bd726',
  shipmentName: '06719',
  shipmentId: '8ab3a6f7-9c96-11f1-0a80-1b69002b2f44',
  orderName: 'GENCardM260820MILJPC2',
  orderId: '89b25f7c-9c96-11f1-0a80-15b7002ae93a',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Milena JBR — paymentin @ 04957 / 06719')
  console.log('====================================================================')
  ...
  if (order.agent?.name !== 'Milena AESTHETIC CLINIC LLC (JBR Branch)') {
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      `Order ${PAYMENT.orderName} — 440 AED.`,
    ].join(' | '),
    operations: [
      {
        meta: {
