    ...
    <div className={`cera-page hr3-page ${ceraSerif.variable} min-h-[100dvh]`} dir={dir}>
      ...
      <section className="mx-auto max-w-[900px] px-4 pt-14 sm:px-6 lg:pt-20">
        <CeraReveal className="hr3-alert p-6 md:p-9">
          ...
          <p className="mt-4 text-[14.5px] leading-relaxed text-[var(--cera-body)]">{copy.whatItIs.carton}</p>
        </CeraReveal>
      </section>
      ...
      {canSeePrices ? (
        <section className="bg-white py-16 lg:py-24">
          <div className="mx-auto max-w-[1000px] px-4 sm:px-6">
            ...
            <CeraReveal>
              <p className="mt-7 text-[15.5px] leading-relaxed text-[var(--cera-body)]">{copy.arithmetic.body}</p>
            </CeraReveal>
          </div>
        </section>
      ) : null}
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-[1040px] px-4 sm:px-6">
          <CeraReveal>
            ...
            <p className="mt-4 max-w-[62ch] text-[15.5px] leading-relaxed text-[var(--cera-body)]">
              {copy.roller.body}
            </p>
          </CeraReveal>
          ...
          <div className="mt-9 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4">
            {copy.roller.items.map((item, i) => (
              <CeraReveal key={item.name} delay={i * 70} className="cera-card p-5 text-center">
                <p dir="ltr" className="cera-numeral hr3-figure text-[24px] leading-none text-[var(--cera-rose)]">
                  {item.dose}
                </p>
                <p className="mt-2 text-[13.5px] font-semibold leading-snug text-[var(--cera-ink)]">{item.name}</p>
          ...
          <CeraReveal>
            <p className="mt-7 text-[14.5px] leading-relaxed text-[var(--cera-body)]">{copy.roller.footnote}</p>
          </CeraReveal>
        </div>
      </section>
