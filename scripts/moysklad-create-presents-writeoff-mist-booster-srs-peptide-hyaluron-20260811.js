...
/**
 * Presents — warehouse write-off @ buyPrice (2026-08-11):
 *   00188 Microbiome Mist 80ml ×1
 *   00022 Snow Booster Toner 200ml ×1
 *   00015 SRS vial 2ml ×20
 *   00012 Peptide Gel Mask ×5
 *   00195 Moisture Replenishing Hyaluron Serum 30ml ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-mist-booster-srs-peptide-hyaluron-20260811.js
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-mist-booster-srs-peptide-hyaluron-20260811.js --commit
 */
...
const MARKER = `PRESENTS-MIST-BOOSTER200-SRS20-PEPTIDE5-HYALURON-${uaeToday()}`

const LINES = [
  ['00188', 1, 'Microbiome Mist 80ml'],
  ['00022', 1, 'Snow Booster Toner 200ml'],
  ['00015', 20, 'SRS vial 2ml'],
...
async function main() {
  console.log('====================================================================')
  console.log('  Presents — mist / booster 200 / SRS×20 / peptide×5 / hyaluron')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'Mist x1, Snow Booster 200ml x1, SRS x20, peptide mask x5, hyaluron serum x1.',
    ].join(' | '),
