    ...
    <div className={`cera-page genosys-page ${ceraSerif.variable} min-h-screen`}>
                  ...
                  <div className="flex items-center gap-4 sm:gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        <h3 className="text-sm sm:text-base font-semibold text-[var(--cera-ink)] group-hover/link:text-[var(--cera-rose-ink)] transition-colors">{concern.protocolPdf.title.ru}</h3>
                      ...
                      <p className="text-[var(--cera-muted)] text-xs sm:text-sm leading-relaxed line-clamp-1 sm:line-clamp-none">{concern.protocolPdf.description.ru}</p>
                    </div>
                  ...
                  {section.steps.map((step) => (
                    <details key={step.step} className="bg-white rounded-xl border border-[var(--cera-line)] overflow-hidden group open:border-[var(--cera-blush-deep)] open:ring-1 open:ring-[var(--cera-blush)] transition-all">
                      <summary className="px-5 py-4 cursor-pointer list-none flex items-center gap-3 hover:bg-[var(--cera-cream-deep)] group-open:bg-[var(--cera-blush)]/40 transition-colors">
                        <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[var(--cera-cta)] group-open:bg-[var(--cera-rose)] text-white text-xs font-bold flex items-center justify-center transition-colors">{step.step}</span>
                        <div className="flex-1 min-w-0">
      ...
      {faq.length > 0 && (
        <section className="py-8 sm:py-12 px-4 bg-[var(--cera-cream-deep)]">
          <div className="max-w-4xl mx-auto">
            <h2 className="cera-serif mb-6 text-[24px] leading-tight text-[var(--cera-ink)] sm:text-[30px]">Часто задаваемые вопросы</h2>
