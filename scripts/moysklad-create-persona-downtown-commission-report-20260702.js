...
/**
 * Persona Downtown — consignment sales report only (agreement 00077).
 * No demand/shipment.
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-downtown-commission-report-20260702.js
 *   node --import dotenv/config scripts/moysklad-create-persona-downtown-commission-report-20260702.js --commit
 */
...
const MARKER = `Persona Downtown consignment sold June 2026 ${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Downtown — consignment sales report only (00077)')
  console.log('====================================================================')
  ...
  const report = await api('POST', '/entity/commissionreportin', {
    ...
    description: [
      ...
      'June 2026 consignment sold list (6 lines, 6 pcs).',
    ].join('\n'),
