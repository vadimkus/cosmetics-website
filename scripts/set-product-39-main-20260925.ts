...
// Product 39, ULTRA SHIELD SUN CREAM: new tube packshot as main. Gallery
// (s1-s6) unchanged. Run after the deploy carrying the file is live.
const MAIN = '/images/ultra/main-v2.jpeg'
