...
// Product 34, SKIN RESCUE OVERNIGHT CREAM MASK: September 2026 campaign slides.
// Hero stays /images/overnight/main-v2.jpeg (identical bytes to the Main.jpeg
// supplied with this set). Run after the deploy carrying the files is live.
const PRODUCT_NUMBER = '34'
const DIR = '/images/overnight_o'
