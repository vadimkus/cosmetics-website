        ...
        <div className="max-w-4xl mx-auto mb-0 pb-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-6 mb-4 md:mb-12">
            ...
            >
              ...
              <h3 className="text-xs md:text-lg font-semibold text-gray-800 mb-0.5 md:mb-2">Website</h3>
            ...
            >
              ...
              <h3 className="text-xs md:text-lg font-semibold text-gray-800 mb-0.5 md:mb-2">Location</h3>
          ...
          <div className="text-center mb-8 md:mb-12 pb-8 md:pb-12">
            <div className="bg-primary-50 rounded-lg px-4 md:px-8 py-4 md:py-8">
              ...
              <p className="text-gray-600 mb-2 md:mb-4 text-xs md:text-base">
                Official distributor of DTSMG. Co., Ltd, Korea since 2019.
              </p>
              <p className="text-[10px] md:text-sm text-gray-500 mb-3 md:mb-4">
                Products certified in Montaji System by <a href="https://www.dm.gov.ae/" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700">Dubai Municipality</a>.
              </p>
