...
/**
 * Prospect / promo gift write-off @ buyPrice (purchase cost).
 *
 *   node --import dotenv/config scripts/moysklad-create-prospect-promo-gift-writeoff-20260617.js
 *   node --import dotenv/config scripts/moysklad-create-prospect-promo-gift-writeoff-20260617.js --commit
 */
...
const MARKER = `PROSPECT-PROMO-GIFT-WRITE-OFF-${uaeToday()}`
...
const LINES = [
  ...
  ['00140', 15, 'Soothing Bomb Sea Algae Mask 23g'],
  ['00063', 15, 'Intensive Repair Collagen Mask 23g'],
  ['00018', 10, 'Power Solution AWS 1 Vial 2ml'],
  ['00069', 10, 'Power Solution CTS 1 Vial 2ml'],
  ['00065', 10, 'Power Solution PCS 1 Vial 2ml'],
  ['00020', 15, 'Power Solution SWS 1 Vial 2ml (expired)'],
  ['00015', 10, 'Skin Renewal Peeling System (SRS) 1 Vial 2ml'],
...
async function main() {
  console.log('====================================================================')
  console.log('  Prospect / promo gifts — write-off @ buyPrice (warehouse)')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Prospect / promo presents — warehouse write-off at purchase cost (buyPrice).',
      'SPF40, mist, cleanser, camel cushion, sea algae x15, collagen x15, AWS/CTS/PCS x10, SWS x15 expired, SRS x10, hyaluron serum.',
    ].join(' | '),
