/**
 * Update only product 57's main image while preserving its existing gallery
 * string byte-for-byte. Also repoint historical order and blog references.
 *
 * Dry run:
 *   npx tsx --env-file=.env.local scripts/update-product-57-main-image.ts
 * Apply:
 *   npx tsx --env-file=.env.local scripts/update-product-57-main-image.ts --apply
 */
/* eslint-disable no-console */
import { prisma } from '../lib/prisma'

const PRODUCT_NUMBER = '57'
const OLD_MAIN = '/images/beauty_boxes/Charming_look.jpeg'
const NEW_MAIN = '/images/bbbox_charming/main.jpeg'
