 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-order-invoice-demand-20260623.js
 *   node --import dotenv/config scripts/moysklad-create-brau-ladies-peptide-order-invoice-demand-20260623.js --commit
 */
...
const ORDER = {
  ...
  moment: uaeMomentNow(),
  marker: `Brau Ladies peptide gel mask x20 ${uaeToday()}`,
}
...
async function main() {
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      'Peptide Gel Mask 39g 00012 x20.',
