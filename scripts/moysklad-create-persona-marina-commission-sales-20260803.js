...
/**
 * Persona Marina — July 2026 consignment sales report (agreement 00024) + PDF.
 *
 *   Matrix shampoo 00052 ×2, Matrix tonic 00051 ×2, Microbiome mist 00188 ×3,
 *   Patch 00053 ×1, Problem control cream 00035 ×2, Snow cleanser 00021 ×1,
 *   Collagen mask 00063 ×1
 *   Total: 1,533 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-marina-commission-sales-20260803.js
 *   node --import dotenv/config scripts/moysklad-create-persona-marina-commission-sales-20260803.js --commit
 */
...
const MARKER = `Persona Marina consignment sold July 2026 ${uaeToday()}`
const EXPECTED_SUM_MINOR = 153300 // 340+290+240+190+290+165+18
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Marina — July consignment sales (00024)')
  console.log('====================================================================')
  ...
  const report = await api('POST', '/entity/commissionreportin', {
    ...
    description: [
      ...
      'July 2026: shampoo×2, tonic×2, mist×3, patch×1, problem cream×2, snow cleanser×1, collagen×1.',
