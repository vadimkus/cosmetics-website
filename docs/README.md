...
|----------|----------|-------------|
| 🟡 **Important** | [Product 65 localized slides](./SESSION_CHANGES_2026-08-20_PRODUCT_65_LOCALIZED_SLIDES.md) | Added content-aligned AR/RU studio slides across web and mobile API. Russian uses the correct English composition slide because the supplied RU artwork misprints panthenol as 1,010 ppm instead of 10,000 ppm. |
...
| 🔴 **Important** | [Product 48 Hair-GENTRON page](./SESSION_CHANGES_2026-08-18_PRODUCT_48_HAIR_GENTRON_PAGE.md) | The record claimed we held no documents for this device; the manual, the EU DoC and a 105-page IEC 60335-2-32 report were on disk. Bespoke EN/AR/RU page built on them. **A product row has eight claim-bearing fields, not four** — `howToUse`, `directions` and the `descriptionAr`/`descriptionRu` columns still carried hair-growth and circulation claims on products 3 and 48. Cache `product-by-id-v56`. |
| 🟡 **Important** | [Product 64 stamp claims aligned](./SESSION_CHANGES_2026-08-18_PRODUCT_64_CLAIMS_ALIGN.md) | Page dropped the leaflet wound-healing / circulation cards and the unsourced “medical-grade” needle line. AR/RU translations and the static fallback rewritten to match the corrected record. |
| 🟡 **Important** | [Abeer hair department proforma](./SESSION_CHANGES_2026-08-18_ABEER_HAIR_DEPARTMENT_PROFORMA.md) | Clinic-price starter pack for a GENOSYS Hair Treatment Department. Complete **15,520 AED** · Stage 1 **10,950** · Stage 2 **4,570**. |
| 🟡 **Important** | [Miss Valeriya cleanser paid](./SESSION_CHANGES_2026-08-18_MISS_VALERIYA_CLEANSER_PAID.md) | **GENCardM2608187755** / INV **04946** / SHIP **06702** / pay **06092** / **375 AED**. Cleanser 180 + delivery. Printed landscape. PDF `~/Desktop/orders/GENOSYS_Miss_Valeriya_04946.pdf`. |
| 🟡 **Important** | [DU August paymentout](./SESSION_CHANGES_2026-08-18_DU_INTERNET_PAYMENTOUT.md) | Paymentout **00681** / **247.75 AED** → DU (acct 1.80097938, txn 002200995578, Apple Pay). |
| 🟡 **Important** | [Shakirovna /prof treatment-cost PDF](./SESSION_CHANGES_2026-08-18_SHAKIROVNA_PROF_TREATMENT_COSTS.md) | 2-page branded PDF from genosys.ae/prof for Shakirovna Ladies Beauty Saloon. `~/Desktop/orders/GENOSYS_Shakirovna_Salon_Professional_Treatment_Costs.pdf`. |
| 🟡 **Important** | [Brau Springs + Abu Dhabi + Jumeirah peptide](./SESSION_CHANGES_2026-08-18_BRAU_SPRINGS_AD_PEPTIDE.md) | INV **04942** Springs ×10 / **380**. INV **04943** Abu Dhabi ×20 / **760**. INV **04944** Jumeirah ×10 / **380**. Unpaid. PDFs in `~/Desktop/orders/`. |
| 🟡 **Important** | [Shakirovna 04932 drop Snow Booster](./SESSION_CHANGES_2026-08-18_SHAKIROVNA_04932_DROP_SNOW_BOOSTER.md) | INV **04932** / SHIP **06685** — removed Snow Booster 1000ml. Total **2,395 AED** unpaid. PDF `~/Desktop/orders/GENOSYS_SHAKIROVNA_POLY_CLINIC_04932.pdf`. |
| 🟡 **Important** | [Bianco Cedre ampoules](./SESSION_CHANGES_2026-08-18_BIANCO_CEDRE_AMPOULES.md) | **GENCardM260818CEDRE** / INV **04941** / SHIP **06697** / **2,570 AED** unpaid. SWS×10, CVS×10, HES×10, SRS×20, PDRN pack×1, EZ mask×3, delivery free. PDF `~/Desktop/orders/GENOSYS_Bianco_Cedre_04941.pdf`. |
| 🟡 **Important** | [Ilmira paymentin 01436](./SESSION_CHANGES_2026-08-18_ILMIRA_HAIRULINA_PAYMENTIN_01436.md) | Paymentin **06090** / **898 AED** @ consignment report **01436**. Report **Paid**. |
| 🟡 **Important** | [Samin Savoji name](./SESSION_CHANGES_2026-08-18_SAMIN_SAVOJI_NAME.md) | `samin savoji` → **Samin Savoji** on MoySklad + website order **GENCardW2608173711**. |
| 🟡 **Important** | [DEWA August paymentout](./SESSION_CHANGES_2026-08-18_DEWA_AUGUST_PAYMENTOUT.md) | Paymentout **00680** / **2,044.78 AED** → DEWA (acct 2049209886, txn NPIB…11240330). |
...
| 🟡 **Important** | [Shakirovna Poly Clinic 04932](./SESSION_CHANGES_2026-08-17_SHAKIROVNA_POLY_CLINIC_04932.md) | **GENCardM260812MAR1912** / INV **04932** / SHIP **06685** moved to **SHAKIROVNA POLY CLINIC L.L.C**. Snow Booster dropped 18 Aug → **2,395 AED** unpaid. PDF `~/Desktop/orders/GENOSYS_SHAKIROVNA_POLY_CLINIC_04932.pdf`. |
| 🟡 **Important** | [CEIA Basil CSN VAT check](./SESSION_CHANGES_2026-07-31_CEIA_CLINIC_CONSIGNMENT_OPENING.md) | CSN **06611** / **9,595** is arithmetically correct (9,138.12 + 456.88). Not a tax invoice. Consignment agr. **38**. |
| 🟡 **Important** | [Fayy Health basic cleanse](./SESSION_CHANGES_2026-08-17_FAYY_HEALTH_BASIC_CLEANSE.md) | **GENCardM260817FAYY** / INV **04938** / SHIP **06693** / **1,220 AED** unpaid. No Hydro Cool. PDF `~/Desktop/orders/GENOSYS_Fayy_Health_04938.pdf`. |
| 🟡 **Important** | [Persona Marina PC cream demand](./SESSION_CHANGES_2026-08-17_PERSONA_MARINA_PC_CREAM_DEMAND.md) | Demand **06692** / **355 AED** into agr. **00024** — PC cream 250g @210 + 50g @145. Stock note `~/Desktop/orders/GENOSYS_Persona_Marina_Consignment_Stock_Note_06692.pdf`. |
| 🟡 **Important** | [CEIA 04927 cream only](./SESSION_CHANGES_2026-08-17_CEIA_CLINIC_CREAM_ONLY.md) | **GENCardM260813CEIA** — dropped peeling + hair pro. Left **00034** cream @ **210 AED** unpaid. PDF `~/Desktop/orders/GENOSYS_CEIA_Clinic_04927.pdf`. |
| 🟡 **Important** | [Kind Care consignment sales May–July](./SESSION_CHANGES_2026-08-17_KIND_CARE_CONSIGNMENT_SALES.md) | Report **01435** / **1,020 AED** unpaid (overnight ×1, eye cream ×3, gel patch ×1, multi sun ×1). PDF `~/Desktop/orders/GENOSYS_Kind_Care_Consignment_Sales_01435.pdf`. |
| 🟡 **Important** | [Gold Apple Korea offline mall request](./SESSION_CHANGES_2026-08-17_GOLD_APPLE_KOREA_OFFLINE_REQUEST.md) | Follow-up to Mrs. Saem Kim after OMNI decline. Ask only UAE offline / one mall store, no website. Draft in `~/Desktop/Gold_apple/04_working/`. |
| 🟡 **Important** | [gildaze jamolod address](./SESSION_CHANGES_2026-08-17_GILDAZE_JAMOLOD_ADDRESS.md) | **CODM2608169758** — address → Villa 20B, 13b Street, Jumeirah 1, Dubai. |
| 🔴 **Important** | [Six pages reworked onto the editorial design](./SESSION_CHANGES_2026-08-16_SIX_PAGE_EDITORIAL_REWORK.md) | `/contact` `/brand` `/about` `/delivery` `/faq` `/orders`. Adds `components/editorial/editorial.css` so the palette lives once instead of per page. Delivery stated the same four facts in three places and had RU/AR copies of the whole page; both fixed. Orders keeps its status colour map fenced off from the palette swap because amber/green/red there are meaning, not decoration. **`/orders` was not visually verified — it redirects to login when signed out.** |
| 🟡 **Important** | [/blog reworked onto the editorial design](./SESSION_CHANGES_2026-08-16_BLOG_REWORK.md) | The shared `BlogPageClient` moves onto the cera system; locale strings collected into one object. Thumbnails are square now, because nearly every post carries a square packshot and the old 16:10 and 4:3 frames pillarboxed them. `loading.tsx` rewritten to mirror the real page. Fixes an `lg:order-2` that un-mirrored the featured article in Arabic, and deletes the RU and AR blog clients replaced back in May. |
| 🔴 **Important** | [/training reworked and unified across three locales](./SESSION_CHANGES_2026-08-16_TRAINING_REWORK.md) | EN, AR and RU each carried a hand-unrolled copy of the library and had drifted: EN showed 6 video lessons, RU 7, AR 11. Now one `TrainingLibrary.tsx` over one `trainingCatalogue.ts`, so all three get all 12 lessons and 35 documents. Moved onto the editorial design. Deletes ~2,800 lines including the never-imported `components/`, `data/`, `types/` scaffold and a stray `page.tsx.tmp`. Fixes Arabic bidi ("39.9 MB" was rendering "MB 9.9 3") and two absolute document URLs. |
| 🟡 **Important** | [Friendlier ingredient-list note on every bespoke page](./SESSION_CHANGES_2026-08-16_FRIENDLY_INCI_NOTES.md) | "The complete ingredient list, exactly as it appears on the carton" becomes "Every ingredient, in the same order as the box in your hand", across 35 pages × EN/AR/RU, which had drifted into a dozen wordings. Formula-order pages get "Every ingredient, strongest first". pH, ppm/ppb and shade clauses all preserved. Drops "Formula_up" from four pages and the "not claimed to match every language panel" hedge from five. Heading harmonised to "Full ingredient list (INCI)", which also fixes product 18 showing English in the AR and RU slots. |
| 🟡 **Important** | [/skin-recommendation reworked onto the editorial design](./SESSION_CHANGES_2026-08-16_SKIN_RECOMMENDATION_REDESIGN.md) | Quiz page moved onto the bespoke-PDP system: Cormorant Garamond serif, cream ground, hairline rules, `cera-card` panels, red accent. New page-scoped `skin-recommendation.css` for the tiles, tick badge, step numerals, progress track and ink pills. Behaviour untouched. The serif needs `ceraSerif.variable` on the root or `.cera-serif` silently falls back to the body sans. Also caps the results grid at three columns so long product names stop truncating, and fixes "1 products curated for you". |
| 🟡 **Important** | [Product 31 Multi Vita Radiance Cream page](./SESSION_CHANGES_2026-08-16_PRODUCT_31_MULTI_VITA_CREAM.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page with 50g/230g size selection. Distinctive fact: the only certificate in the range that assays the active, niacinamide specified 2.00% and found 2.04%. Carried in 13% macadamia oil, which the old copy never mentioned. Cut astaxanthin-as-powerhouse (10 ppm), the UV-defence line, ceramide and panthenol as actives. Prints the panel's 95% rather than rounding it to the serum's 100%. Cache `product-by-id-v35`. |
| 🟡 **Important** | [Product 21 Multi Vita Radiance Serum page](./SESSION_CHANGES_2026-08-16_PRODUCT_21_MULTI_VITA_SERUM.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: the carton prints every vitamin's dose, four in ppm and eleven in ppb. Niacinamide 20,000 ppm is the registered Korean whitening active. MELAZERO confirmed real (loquat 0.04%, spearmint 0.01%). Recovered three warnings that were on documents and nowhere else: may sting, not in pregnancy, colour darkens with air. Cut glutathione-at-1ppb and gluconolactone-as-exfoliant. Also fixes three more wrong chatbot ids. Cache `product-by-id-v34`. |
| 🟡 **Important** | [Product 27 Skin Barrier Protecting Cream page](./SESSION_CHANGES_2026-08-16_PRODUCT_27_SKIN_BARRIER_CREAM.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: Ceramide NP 0.5%, printed on the Korean carton panel as 5,000 ppm, plus glycerin 17.49% making it the richest of the three creams. MultiEx is 0.0001% here against 1% in product 19 and was wrongly the technology line. Cut repair / all-skin-types / macadamia-as-active / 2-4 weeks. Restored 1,2-Hexanediol and C18-C21 Alkane. Cache `product-by-id-v33`. |
| 🟡 **Important** | [Product 29 Moisture Replenishing Hyaluron Cream page](./SESSION_CHANGES_2026-08-16_PRODUCT_29_HYALURON_CREAM.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page with 50g/250g size selection. Distinctive fact: the carton prints the dose of every hyaluronate, and the 1,000.9 ppm one is the high molecular weight grade that seals where the serum's 2,000 ppm fills. Hyaluronan 11 confirmed as a real name (11 grades, 8 INCI). Cut mushrooms-as-anti-inflammatory / elasticity / all-skin-types / aquaporin-as-mechanism. Restored 1,2-Hexanediol and the ppm figures. Cache `product-by-id-v32`. |
| 🟡 **Important** | [Product 30 Intensive Problem Control Cream page](./SESSION_CHANGES_2026-08-16_PRODUCT_30_PROBLEM_CONTROL_CREAM.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page with 50g/250g size selection. Distinctive fact: a cream with no oil in it, 86.6% water thickened by 1.3% polymer. Zinc PCA 0.05%, same as the serum. Cut all-skin-types / healing / non-comedogenic / sebum −14%. Restored 1,2-Hexanediol. Also fixes four wrong product ids in the chatbot hair-loss answer. Cache `product-by-id-v31`. |
...
| 🔴 **PDP consistency** | [Bespoke PDP slides audit](./SESSION_CHANGES_2026-08-16_BESPOKE_PDP_SLIDES_AUDIT.md) | Bespoke pages now show a studio slide beside the section it illustrates, rather than leaving the set to the 80px thumbs. No slide dumps: a grid listing the whole set was tried and removed the same evening. Also fixes four products that listed their main image inside the gallery array. Cache `product-by-id-v29`. |
...
| 🟡 **Important** | [Alena / Miss Irina PC set commission](./SESSION_CHANGES_2026-08-16_ALENA_MISS_IRINA_PC_SET.md) | Invoice 04934, client 1,962 card. Alena 10% from her margin. Pay her **783.84** after 5% + Stripe 3% on her 852 share. |
| 🟡 **Important** | [Presents write-off booster/PDRN/masks](./SESSION_CHANGES_2026-08-16_PRESENTS_WRITEOFF_BOOSTER_PDRN_MASKS.md) | Loss **00008-00496** / **327.98 AED** buy — booster 200 ×3, PDRN mask ×1, collagen ×5, sea algae ×5, defender ×2, post cream 20g ×5. |
| 🟡 **Important** | [Product 18 Hyaluron Serum page](./SESSION_CHANGES_2026-08-16_PRODUCT_18_HYALURON_SERUM.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: moisturizing serum, hydrolyzed HA 2,000 ppm, apply and pat AM/PM. Coconut water 0.80%. PENTAVITIN 0.615%. Not the cream. Cut 78% coconut water / +52% / 4-step electrolyte / mushroom-as-engine. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 16 Snow Booster page](./SESSION_CHANGES_2026-08-16_PRODUCT_16_SNOW_BOOSTER.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: daily toner, all skin types, betaine 3%, apply or spray AM/PM, over makeup. Phytolex is a 0.5% premix. Not the oil-control toner. Cut Phytolex-as-engine / lotus-brightener / cotton-pad mask / 2-3 layers / brightening booster. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 15 Problem Control Toner page](./SESSION_CHANGES_2026-08-16_PRODUCT_15_PROBLEM_TONER.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: oil-control toner, zinc PCA 0.5%, apply or spray AM/PM, 200 ml 360°. Not a BHA toner. Copper peptide is not in the INCI. Cut patented Anti Sebum P / BHA-as-engine / all-skin-types / pH-restore. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 14 Microbiome Mist page](./SESSION_CHANGES_2026-08-16_PRODUCT_14_MIST.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: sprayable shea emulsion, shea 1.2%, shake / 10-20 cm / over makeup. Not a water toner. Cut FENSEBIOME-as-engine / HA-plumping / all-skin-types / derm-tested / pat-in. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 13 SRS page](./SESSION_CHANGES_2026-08-16_PRODUCT_13_SRS.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: professional AHA peel, glycolic 15% + lactic 13.5% + mandelic 2%, apply / 15-20 min / cold rinse. Not Epi. Cut peptide-as-engine / neutralize / licensed-only / pregnancy / microneedling-as-purpose. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 11 Skin Defender Remover page](./SESSION_CHANGES_2026-08-16_PRODUCT_11_SKIN_DEFENDER_REMOVER.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: biphasic lip-and-eye makeup remover, shake / hold / wipe. Oil layer 49.8% (cetyl ethylhexanoate 27.8% + disiloxane 13% + isohexadecane 9%). Not a face wash. Cut vitamins-as-engine / peptides / waterproof / ophthalmology / all-skin-types. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 50 Eye Zone Care Kit page](./SESSION_CHANGES_2026-08-16_PRODUCT_50_EYE_ZONE_CARE_KIT.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU kit page. Distinctive fact: registered four-piece EyeCell sequence (serum + 0.25mm / 60-needle eye roller, patches 20-40 min, cream). Arbutin 2% + adenosine 0.04% on serum and cream; niacinamide 2% + adenosine 0.04% on the patches. Not a beauty box. Roller is not product 1. Cut peptides / Haloxyl / callus / patented / Botox / all-skin-types. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 10 Snow O₂ Cleanser page](./SESSION_CHANGES_2026-08-16_PRODUCT_10_SNOW_O2.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: dry-face oxygen-bubble facial cleanser, ether 8%, apply dry / bubbles / massage / tepid rinse. Not oxygen therapy. Not a Korean functional cosmetic. Cut Phytolex-as-engine / wet-finger ritual / all-skin-types / paraben-free. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 7 Power Solution PCS page](./SESSION_CHANGES_2026-08-16_PRODUCT_7_POWER_SOLUTION_PCS.md) | Intertek audit + selling-tone rewrite + shared Power Solution layout. Distinctive fact: Problem Control Solution, carton function oil and sebum control, leave-on cleanse/open/apply/absorb. Cut microneedling-as-purpose / witch-hazel-as-engine / acne-as-drug / fragrance-free. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 6 Power Solution CTS page](./SESSION_CHANGES_2026-08-16_PRODUCT_6_POWER_SOLUTION_CTS.md) | Intertek audit + selling-tone rewrite + shared Power Solution layout. Distinctive fact: Cytokine Concentrate Solution, carton function improvement of skin texture, leave-on cleanse/open/apply/absorb. Cut microneedling-as-purpose / collagen-as-co-lead / GH / healing / fragrance-free. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 9 Power Solution AWS page](./SESSION_CHANGES_2026-08-16_PRODUCT_9_POWER_SOLUTION_AWS.md) | Intertek audit + selling-tone rewrite + shared Power Solution layout. Distinctive fact: adenosine 0.04%, Korean wrinkle-improving functional cosmetic, leave-on cleanse/open/apply/absorb. Cut microneedling-as-purpose / ceramide-as-co-lead / Botox / fragrance-free. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 8 Power Solution SWS page](./SESSION_CHANGES_2026-08-15_PRODUCT_8_POWER_SOLUTION_SWS.md) | Intertek audit + selling-tone rewrite + shared Power Solution layout. Distinctive fact: arbutin 2%, Korean whitening functional cosmetic, leave-on cleanse/open/apply/absorb. Cut microneedling-as-purpose / kojic-as-co-lead / fragrance-free. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 37 Peptide Gel Mask page](./SESSION_CHANGES_2026-08-15_PRODUCT_37_PEPTIDE_GEL_MASK.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: face hydrogel sheet, glycerin 20%, sit 20-40 min then off. Peptide sits at 0.05 ppm. Cut patented transdermal / peptide-as-engine / HA / collagen / 15-20 min. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
...
| 🟡 **Important** | [Product 33 EyeCell Eye Peptide Gel Patch page](./SESSION_CHANGES_2026-08-15_PRODUCT_33_EYE_PEPTIDE_GEL_PATCH.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: take-off hydrogel mask, Niacinamide 2% + Adenosine 0.04%, 20-40 min then remove. Cut peptide-as-engine / Made White / patented transdermal / 10 Years Back. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
| 🟡 **Important** | [Product 17 EyeCell Eye Contour Serum page](./SESSION_CHANGES_2026-08-15_PRODUCT_17_EYE_CONTOUR_SERUM.md) | Intertek audit + selling-tone rewrite + bespoke EN/AR/RU page. Distinctive fact: first-layer serum, Arbutin 2% + Adenosine 0.04%. Cut peptide premix / Haloxyl-as-0.10%-active / 10 Years Back. Image rows in `~/Desktop/genosys-artwork-corrections.html`. |
...
| 🟡 **Important** | [Product 56 Skin Brightening Beauty Box main image](./SESSION_CHANGES_2026-08-09_PRODUCT_56_MAIN_IMAGE.md) | Main-only migration to cache-safe `bbbox_brightening/main.jpeg`; DB gallery preserved exactly, 9 historical order images repointed, and the unreferenced old asset removed after a clean dead-image audit. |
| 🟡 **Important** | [Product 57 Charming Look Beauty Box main image](./SESSION_CHANGES_2026-08-08_PRODUCT_57_MAIN_IMAGE.md) | Main-only migration to cache-safe `bbbox_charming/main.jpeg`; DB gallery preserved exactly, 55 historical order images repointed, and the unreferenced old asset removed after a clean dead-image audit. |
| 🟡 **Important** | [Product 58 Anti-Aging Beauty Box main image](./SESSION_CHANGES_2026-08-08_PRODUCT_58_MAIN_IMAGE.md) | Main-only migration to cache-safe `bbox_age/main.jpg`; DB gallery preserved exactly, 39 historical order images repointed, and the unreferenced old asset removed after a clean dead-image audit. |
...
| 🟡 **Account ops** | [Olga Pikina previous X Beauty order import](./SESSION_CHANGES_2026-08-08_OLGA_PIKINA_PREVIOUS_ORDER_IMPORT.md) | Verified unique paid/delivered MoySklad chain **GENCardM2606166868 / 04688 / 06378 / 05787**, mirrored four exact products + delivery into Olga's history, and transactionally awarded **745 points** (**1,015 balance**); no email and no MoySklad mutation. |
...
| 🟢 **Commerce UX** | [Quick Facts manual catalog rework](./SESSION_CHANGES_2026-07-23_quick-facts-manual-catalog.md) | Removes units-sold “popular” tile; ships manual/clinical sales points (%, actives, formats) for 32 SKUs in EN/RU/AR; no PDP benefit recycle; 10-iteration QA before ship. |
...
| 🟡 **Important** | [Product 30 Problem Control Cream video](./SESSION_CHANGES_2026-08-05_PRODUCT_30_PROBLEM_CREAM_VIDEO.md) | Compressed portrait video from 29.1 MB to 913 KB; DB + productConfig + products.ts set to `/videos/problem_cream.mp4`. |
| 🟡 **Important** | [Product 30 Problem Control Cream images](./SESSION_CHANGES_2026-08-05_PRODUCT_30_PROBLEM_CREAM_IMAGES.md) | Cache-safe `problem_cream/` main + s1–s6 gallery; DB single source of truth; order/email and blog references migrated before old assets were removed. |
| 🟡 **Important** | [Product 33 Eye Peptide Gel Patch images](./SESSION_CHANGES_2026-08-05_PRODUCT_33_EYE_PATCH_IMAGES.md) | Cache-safe `patch/` main + s1–s6 gallery; DB and training/download fallbacks updated; 14 historical order/email images repointed; old assets removed safely. |
| 🟡 **Important** | [Product 32 Anti-Wrinkle Cream images](./SESSION_CHANGES_2026-08-03_PRODUCT_32_MULTIFUNC_CREAM_IMAGES.md) | New cache-safe `multifunc_cream/` main + s1–s6 gallery; DB and fallbacks updated; 38 historical order/email images repointed; old `ANT.jpg` removed safely. |
| 🟡 **Important** | [Product 43 Hair Tonic images](./SESSION_CHANGES_2026-08-03_PRODUCT_43_HAIR_TONIC_IMAGES.md) | New cache-safe `hair_tonic/` main + s1–s6 gallery; DB, training, downloads, and fallbacks updated; 20 historical order/email images repointed; old assets removed safely. |
...
| 🟢 **Content/SEO** | [EyeCell Eye Peptide Gel Patch blog](./SESSION_CHANGES_2026-08-09_EYECELL_EYE_PEPTIDE_GEL_PATCH_BLOG.md) | Long-form EN/RU/AR post `cooling-hydrogel-eyecell-eye-peptide-gel-patch`: Mayo/AAO under-eye framing, thermo-sensitive hydrogel physics, Intertek Formula_up (niacinamide 2%, adenosine 0.04%, peptide 46.5 ppb), 20–40 min protocol; product 33. |
| 🟢 **Content/SEO** | [HR³ Hair Tonic scalp-first blog post](./SESSION_CHANGES_2026-08-03_HR3_HAIR_TONIC_BLOG.md) | Long-form EN/RU/AR post `scalp-first-hair-care-hr3-matrix-hair-tonic-alpha`: MFDS functional-cosmetic context, Intertek-verified α formula and AM/PM leave-on protocol, appropriately limited caffeine evidence, and the new product 43 image set. |
| 🟢 **Content/SEO** | [Bakuchiol MFS Serum blog post](./SESSION_CHANGES_2026-07-28_BAKUCHIOL_MFS_SERUM_BLOG.md) | Long-form EN/RU/AR post `bakuchiol-multi-functional-anti-wrinkle-serum`: babchi-seed story, BJD 2019 head-to-head vs retinol, photostability, MFS formula (0.1% bakuchiol + Peptide 6 + liposome), P&K 2024 study; product 22 gallery images. |
| 🔴 **Bugfix** | [Training download links fix](./SESSION_CHANGES_2026-07-28_TRAINING_DOWNLOAD_LINKS_FIX.md) | `/documents/ppt/` → `/documents/PPT/` everywhere (EN/RU/AR training, mobile API, DownloadsSection, productConfig); legacy `trainingData.ts` dead URLs rewritten; PDF viewer whitelist → fs check. 27/28 EN links were 404. |
| 🟡 **Important** | [Product 32 Anti-Wrinkle Cream video](./SESSION_CHANGES_2026-07-28_PRODUCT_32_MULTIF_CREAM_VIDEO.md) | Compressed `multif_cream.mp4` (37.1 MB → 998 KB); DB + productConfig + products.ts set `videoUrl`. |
| 🟡 **Important** | [Product 22 Anti-Wrinkle Serum video](./SESSION_CHANGES_2026-07-28_PRODUCT_22_MULTIF_SERUM_VIDEO.md) | Compressed `multif_serum.mp4` (33.8 MB → 865 KB); DB + productConfig + products.ts set `videoUrl`. |
| 🟡 **Important** | [Product 22 Anti-Wrinkle Serum images](./SESSION_CHANGES_2026-07-28_PRODUCT_22_MULTIF_SERUM_IMAGES.md) | New `multif_serum/` main + s1–s6; DB/gallery/order emails; removed `MSSS.jpg` + `multiserum1.jpg`. |
| 🟡 **Important** | [Product 21 Radiance Serum images](./SESSION_CHANGES_2026-07-28_PRODUCT_21_RADIANCE_SERUM_IMAGES.md) | New `radiance_serum/` main + s1–s5; DB/gallery/training/order emails/SEO; removed `RADS.jpg` + `rd_big.jpg`. |
| 🟡 **Important** | [Product 21 Radiance Serum video](./SESSION_CHANGES_2026-07-27_PRODUCT_21_RADIANCE_SERUM_VIDEO.md) | Compressed `radiance_serum.mp4` (13.9 MB → 491 KB); replaced `rserum.mp4`; DB + config + products.ts. |
| 🟡 **Important** | [Montaji product registration PDF](./SESSION_CHANGES_2026-07-27_MONTAJI_PRODUCT_REGISTRATION_PDF.md) | Refreshed 4-page Montaji list; About/Contact/footer/chatbot → `Genosys_Product_Registration_Montaji.pdf`. |
| 🟡 **Important** | [Trade license renewal PDF](./SESSION_CHANGES_2026-07-27_GENOSYS_LICENSE_RENEWAL.md) | New `Genosys_License.pdf` (5023192, VUET0209 Al Hulaila); About/Contact/chatbot links + address sync. |
| 🟡 **Important** | [Product 31 Radiance Cream images](./SESSION_CHANGES_2026-07-26_PRODUCT_31_RADIANCE_IMAGES.md) | New `radiance/` main + s1–s6; DB/gallery/training/order emails; removed `RAA.jpg` + `radiance_both.jpg`. |
| 🟡 **Important** | [Multi Vita Cream MELAZERO copy fix](./SESSION_CHANGES_2026-07-26_MULTI_VITA_CREAM_MELAZERO_BUGFIX.md) | Cream 31 must not claim MELAZERO; AR/RU kit + `pc21Benefit1Text` corrected (EN PDP already live in DB). |
| 🟡 **Important** | [Product 31 Radiance Cream video](./SESSION_CHANGES_2026-07-26_PRODUCT_31_RADIANCE_VIDEO.md) | Compressed `radiance.mp4` (32 MB → 721 KB); DB + productConfig + products.ts set `videoUrl`. |
| 🟢 **Admin UX** | [Credit paid badge in order STATUS](./SESSION_CHANGES_2026-07-26_ADMIN_CREDIT_PAID_STATUS_BADGE.md) | STATUS column stacks fulfillment + Credit paid/open/overdue (no order.status change). |
| 🟡 **Important** | [SWS unlock / back in stock](./SESSION_CHANGES_2026-07-26_SWS_UNLOCK_RESTOCK.md) | POWER SOLUTION SWS (`id: 8`) `inStock: true`; removed “Available in 14 days” restock note. |
| 🟡 **Important** | [Product 20 Problem Control Serum images V2](./SESSION_CHANGES_2026-08-03_PRODUCT_20_PROBLEM_SERUM_IMAGES_V2.md) | Cache-safe `problems_serum/` main + s1–s6 gallery; DB/config/training/order fallbacks updated; 17 historical order images repointed; old image set removed safely. |
| 🟡 **Important** | [Product 29 Hyaluron Cream images](./SESSION_CHANGES_2026-07-26_PRODUCT_29_HYALURON_IMAGES.md) | New `hyaluron/main` + s1–s6 gallery; 33 order items repointed; old `HER.jpg` / `hyabig.jpg` deleted. |
| 🟡 **Important** | [Product 29 Hyaluron Cream video](./SESSION_CHANGES_2026-07-26_PRODUCT_29_HYALURON_VIDEO.md) | New compressed `hyaluron.mp4` (17 MB → 1.3 MB); DB + productConfig + products.ts updated; old `hyal_cream.mp4` deleted. |
...
| 🟡 **Important** | [Product 41 BB Cushion video](./SESSION_CHANGES_2026-07-23_PRODUCT_41_CUSHION_VIDEO.md) | New compressed `cushion.mp4` (24 MB → 727 KB); DB + productConfig + products.ts set to `/videos/cushion.mp4`. |
