...
/**
 * Warehouse write-off @ buyPrice (2026-07-08):
 *   00001 Standard Detachable Manual Roller 0.25mm ×1
 *   54466 Bio-Ferment Age Defying Powder Mask 300g ×1
 *   54470 BIO-MESO PDRN Expert Ampoule 60000 ×3
 *   54475 BIO-MESO PDRN Homecare Ampoule 5000 ×1
 *   00012 Peptide Gel Mask 39g ×10
 *   00020 Power Solution SWS 1 Vial 2ml ×10
 *   00015 Skin Renewal Peeling System SRS 1 Vial 2ml ×20
 *
 *   node --import dotenv/config scripts/moysklad-create-mixed-promo-writeoff-20260708.js
 *   node --import dotenv/config scripts/moysklad-create-mixed-promo-writeoff-20260708.js --commit
 */
...
const MARKER = `MIXED-WRITE-OFF-${uaeToday()}`

const LINES = [
  ['00001', 1, 'Standard Detachable Manual Roller 0.25mm'],
  ['54466', 1, 'Bio-Ferment Age Defying Powder Mask 300g'],
  ['54470', 3, 'BIO-MESO PDRN Expert Ampoule 60000 (3mlx4)'],
  ['54475', 1, 'BIO-MESO PDRN Homecare Ampoule 5000'],
  ['00012', 10, 'Peptide Gel Mask 39g'],
  ['00020', 10, 'Power Solution SWS 1 Vial 2ml'],
  ['00015', 20, 'Skin Renewal Peeling System SRS 1 Vial 2ml'],
]
...
async function main() {
  console.log('====================================================================')
  console.log('  Warehouse write-off — roller, masks, PDRN, SWS, SRS')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00001 roller 0.25mm x1, 54466 bio ferment x1, 54470 PDRN Expert 60000 x3, 54475 PDRN Homecare 5000 x1, 00012 peptide mask x10, 00020 SWS vials x10, 00015 SRS vials x20.',
    ].join(' | '),
