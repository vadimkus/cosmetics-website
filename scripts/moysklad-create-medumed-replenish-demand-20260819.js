 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-medumed-replenish-demand-20260819.js
 *   node --import dotenv/config scripts/moysklad-create-medumed-replenish-demand-20260819.js --commit
 */
...
const MARKER = `MEDUMED-REPLENISH-CREAMS-CERA-HAIR-${uaeToday()}`
...
const EXPECTED_SUM_MINOR = 191500
...
async function main() {
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      'Replenishment: 54484 x2, 00052 x1, 54458 x1, 00195 x2, 00190 x2, 00037 x2, 54464 x1 @ clinic list.',
    ].join('\n'),
    positions,
  })
