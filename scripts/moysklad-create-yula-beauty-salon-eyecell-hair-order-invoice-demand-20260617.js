...
/**
 * Yula Beauty Salon LLC — SO → invoice → shipment @ clinic salePrice.
 *
 *   EyeCell Eye Zone Care Kit (00059) ×1
 *   HR³ Matrix Hair Solution Professional Box (00048) ×1
 *   Genosys Stamp 0.25mm (00074) ×2
 *
 *   node --import dotenv/config scripts/moysklad-create-yula-beauty-salon-eyecell-hair-order-invoice-demand-20260617.js
 *   node --import dotenv/config scripts/moysklad-create-yula-beauty-salon-eyecell-hair-order-invoice-demand-20260617.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}4821`,
  moment: uaeMomentNow(),
  marker: `Yula Beauty Salon EyeCell hair solution stamp ${uaeToday()}`,
}
...
function ordersPdfPath(invoiceName) {
  ...
  return path.join(ordersDir, `GENOSYS_Yula_Beauty_Salon_${safe}.pdf`)
}

async function main() {
  console.log('====================================================================')
  console.log('  Yula Beauty Salon LLC — SO → invoice → shipment')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '00059 EyeCell kit x1; 00048 hair solution pro box x1; 00074 stamp 0.25mm x2 @ clinic price.',
