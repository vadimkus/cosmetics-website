  ...
  return (
    <a
      ...
      className="
        ...
        focus:shadow-lg focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600
        focus:outline-none
        transition-all duration-200
      "
      // Ensure the link works even if translations haven't loaded
