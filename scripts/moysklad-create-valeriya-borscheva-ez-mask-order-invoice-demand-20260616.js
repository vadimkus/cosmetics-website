...
/**
 * Dr. Valeria Borscheva (Valeriya Borsheva) — SO → invoice → shipment @ clinic salePrice.
 *
 *   EZ CO₂ MASK Professional Box (00011) ×1
 *   Excellent Delivery Dubai ×1 @ 45 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-ez-mask-order-invoice-demand-20260616.js
 *   node --import dotenv/config scripts/moysklad-create-valeriya-borscheva-ez-mask-order-invoice-demand-20260616.js --commit
 */
...
const ORDER = {
  ...
  moment: uaeMomentNow(),
  marker: `Valeriya Borscheva EZ CO2 mask clinic delivery ${uaeToday()}`,
}

const PRODUCT_LINES = [['00011', 1]] // EZ CO₂ MASK Professional Box
...
async function main() {
  console.log('====================================================================')
  console.log('  Valeriya Borscheva — SO → invoice → shipment')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      'EZ CO2 mask 00011 x1 @ clinic price; Excellent Delivery Dubai 45 AED.',
