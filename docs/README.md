...
| File | Description |
|------|-------------|
| [SESSION_CHANGES_2026-02-13.md](./SESSION_CHANGES_2026-02-13.md) | **NEW** Native app productConfig fix, category pill badges, email duplicate discount fix, product 27 video, native app video sound fix |
