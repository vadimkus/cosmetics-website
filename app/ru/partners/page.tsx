      ...
      <div className={`cera-page genosys-page ${ceraSerif.variable} min-h-screen`}>
        ...
        <div className="container mx-auto px-3 md:px-4 py-4 md:py-12">
          <div className="max-w-6xl mx-auto">
            <Link href="/ru" className="inline-flex items-center gap-1 text-xs md:text-sm text-[var(--cera-body)] hover:text-[var(--cera-ink)] mb-6 md:mb-10">
            ...
            <section className="relative overflow-hidden rounded-2xl md:rounded-3xl border border-[var(--cera-ink)] bg-[var(--cera-ink)] text-white">
              ...
              <div className="relative grid gap-6 px-6 py-8 md:grid-cols-[1.4fr_1fr] md:items-center md:gap-10 md:px-12 md:py-14">
                ...
                <div className="flex flex-col gap-3 md:items-start">
                  <Link
                    href="/ru/contact"
                    className="group inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[var(--cera-ink)] transition-all hover:bg-[var(--cera-blush)] hover:text-[var(--cera-rose-ink)]"
                  >
