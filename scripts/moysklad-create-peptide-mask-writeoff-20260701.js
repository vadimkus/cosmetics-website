...
/**
 * Warehouse write-off @ buyPrice — Peptide Gel Mask 39g ×5.
 *
 *   node --import dotenv/config scripts/moysklad-create-peptide-mask-writeoff-20260701.js
 *   node --import dotenv/config scripts/moysklad-create-peptide-mask-writeoff-20260701.js --commit
 */
...
const MARKER = `PEPTIDE-MASK-WRITE-OFF-${uaeToday()}`

const LINES = [['00012', 5, 'Peptide Gel Mask 39g (single pcs)']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Warehouse write-off — Peptide Gel Mask 00012 ×5')
  console.log('====================================================================')
