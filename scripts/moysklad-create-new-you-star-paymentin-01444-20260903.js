...
/**
 * NEW YOU STAR — paymentin for commissioner report 01444 (2,990 AED) + mark Paid.
 *
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-paymentin-01444-20260903.js
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-paymentin-01444-20260903.js --commit
 */
...
const REPORT_ID = '1c4dd504-a1f8-11f1-0a80-1a7100624673'
const REPORT_NAME = '01444'
...
async function main() {
  console.log('====================================================================')
  console.log('  NEW YOU STAR — paymentin @ consignment report 01444 (2,990)')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'NEW YOU STAR — consignment sales 2,990 AED — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
