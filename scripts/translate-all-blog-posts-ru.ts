/**
 * Script to translate all blog posts to Russian
 * This script fetches all published blog posts and translates them using manual translations
 */
