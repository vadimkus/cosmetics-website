    ...
    <div className={`cera-page hr3-page min-h-[100dvh]`} dir={dir}>
      ...
      <section className="mx-auto max-w-[900px] px-4 pt-14 sm:px-6 lg:pt-20">
        <CeraReveal className="hr3-alert p-6 md:p-9">
          ...
          <p className="mt-5 text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.notGentle.body}</p>
          ...
          <p className="mt-5 text-[15px] leading-relaxed text-[var(--cera-body)]">{copy.notGentle.detail}</p>
        </CeraReveal>
      </section>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="mx-auto max-w-[1000px] px-4 sm:px-6">
              ...
              <tbody>
                {copy.cooling.rows.map(row => (
                  ...
                  >
                    ...
                    <td dir="ltr" className="hidden whitespace-nowrap px-5 py-4 text-end align-middle text-[13px] text-[var(--cera-muted)] sm:table-cell">
                      {row.note}
                    </td>
                  </tr>
                ))}
          ...
          <CeraReveal>
            <p className="mt-7 text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.cooling.body}</p>
          </CeraReveal>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-[1040px] px-4 sm:px-6">
          ...
          <CeraReveal>
            <p className="mt-7 text-[15px] leading-relaxed text-[var(--cera-body)]">{copy.labelClaims.footnote}</p>
          </CeraReveal>
        </div>
      </section>
