...
export const SEO_LANDING_PAGES: SeoLandingPage[] = [
  {
    ...
    featuredProducts: [
      ...
      { name: 'Ultra Shield Sun Cream SPF 50+', href: '/products/39', image: '/images/ultra/main-v3.jpeg', imageAlt: 'GENOSYS Ultra Shield Sun Cream SPF 50+', description: 'High UV protection for use when the treating professional says sunscreen can resume.' },
    ],
    sections: [
      {
