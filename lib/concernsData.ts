...
export const CONCERN_PAGES: ConcernPage[] = [
  ...
  // ─── ACNE TREATMENT ──────────────────────────────────────────
  {
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              detail: 'ضعي كريم Problem Control بطبقة خفيفة. إذا شعرتِ البشرة بالجفاف أو الشد، ربّتي قطرة أو قطرتين من سيروم الهيالورون أولاً، ثم ضعي الكريم فوقه.',
              products: [
                { name: 'INTENSIVE PROBLEM CONTROL CREAM', url: '/products/30', price: '290 AED' },
                { name: 'MOISTURE REPLENISHING HYALURON SERUM', url: '/products/18', price: '330 AED' },
              ],
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              detail: 'Нанесите крем Problem Control тонким слоем. Если кожа ощущает сухость или стянутость, сначала мягко вбейте одну-две капли гиалуроновой сыворотки, затем нанесите крем поверх.',
              products: [
                { name: 'INTENSIVE PROBLEM CONTROL CREAM', url: '/products/30', price: '290 AED' },
                { name: 'MOISTURE REPLENISHING HYALURON SERUM', url: '/products/18', price: '330 AED' },
              ],
    ...
    faq: {
      ...
      ar: [
        ...
        { question: 'هل تحتاج البشرة الدهنية إلى كريم؟', answer: 'نعم، فالبشرة الدهنية قد تكون ناقصة الترطيب أيضاً. يُوضع السيروم أولاً ثم طبقة خفيفة من الكريم، ويُختتم الروتين الصباحي بواقي الشمس.' },
      ],
      ru: [
        { question: 'Кому подходит уход Intensive Problem Control?', answer: 'Жирной, комбинированной и склонной к высыпаниям коже. Цинк PCA 0,05% в сыворотке помогает регулировать избыток себума, а увлажняющие компоненты поддерживают комфорт.' },
        ...
        { question: 'Нужен ли жирной коже крем?', answer: 'Да, жирная кожа тоже может быть обезвоженной. Нанесите сыворотку, затем тонкий слой крема, а утром завершите уход SPF.' },
      ],
    },
  },
  ...
  // ─── PIGMENTATION ──────────────────────────────────────────
  {
    ...
    why: {
      ...
      ar: {
        ...
        items: [
          ...
          { icon: '🧪', label: 'نياسيناميد 2% + فيتامين C ثابت', detail: 'يجمع سيروم Multi Vita Radiance النياسيناميد 2% وفيتامين C الثابت 0.1% مع MELAZERO® للعناية المستهدفة بعدم تجانس اللون.' },
      ...
      ru: {
        ...
        items: [
          ...
          { icon: '🧪', label: 'Ниацинамид 2% + стабильный витамин C', detail: 'Сыворотка Multi Vita Radiance сочетает ниацинамид 2%, стабильный витамин C 0,1% и MELAZERO® для целенаправленного ухода за неровным тоном.' },
    ...
    seo: {
      ...
      ar: {
        ...
        intro: 'قد يجعل التعرض القوي للشمس طوال العام في الإمارات البقع الداكنة وعدم تجانس اللون أكثر وضوحاً. يجمع خط GENOSYS Multi Vita Radiance بين النياسيناميد وفيتامين C الثابت ومكونات داعمة للإشراق ضمن روتين صباحي ومسائي يكتمل بواقي الشمس.',
      ...
      ru: {
        ...
        intro: 'Интенсивное солнце в ОАЭ круглый год может делать тёмные пятна и неровный тон заметнее. Линия GENOSYS Multi Vita Radiance сочетает ниацинамид, стабильный витамин C и компоненты для сияния в утреннем и вечернем уходе, который обязательно дополняют защитой от солнца.',
  ...
  // ─── ANTI-AGING ──────────────────────────────────────────
  {
    ...
    seo: {
      ...
      ar: {
        ...
        description: 'عناية كورية احترافية بمظهر الخطوط في الإمارات، مع سيرومات وكريمات GENOSYS للترطيب والنعومة والتماسك. توصيل مجاني للطلبات فوق 1000 درهم.',
        h1: 'العناية بمظهر الخطوط والتجاعيد',
        heroShort: 'سيرومات وكريمات كورية احترافية تمنح البشرة الترطيب وتدعم نعومة الملمس ومظهر التماسك.',
        intro: 'يتطلب مناخ الإمارات توازناً بين الترطيب اليومي والحماية من الشمس والعناية المنتظمة بالملمس. تجمع تشكيلة GENOSYS بين مرطبات غنية ومكونات مثل النياسيناميد والأدينوزين والباكوتشيول لروتين صباحي ومسائي واضح.',
      ...
      ru: {
        ...
        description: 'Профессиональный корейский уход за линиями в ОАЭ: сыворотки и кремы GENOSYS для увлажнения, гладкости и упругого вида кожи. Бесплатная доставка от 1000 AED.',
        h1: 'Уход за линиями и морщинами',
        heroShort: 'Профессиональные корейские сыворотки и кремы для увлажнения, более гладкой текстуры и упругого вида кожи.',
        intro: 'В климате ОАЭ особенно важен баланс ежедневного увлажнения, защиты от солнца и регулярного ухода за текстурой. Линия GENOSYS сочетает насыщенные увлажнители с ниацинамидом, аденозином и бакучиолом для понятного утреннего и вечернего ритуала.',
      ...
      ar: [
        {
          ...
          steps: [
            ...
            {
              step: 4, title: 'كريم الوجه والرقبة', duration: '30 ثانية',
              summary: 'اختاري قواماً خفيفاً للوجه وعناية أغنى للرقبة وأعلى الصدر.',
              detail: 'ضعي Multi Functional Anti-Wrinkle Cream على الوجه، ثم وزعي ND Cell على الرقبة وأعلى الصدر. يوفر السكوالان 5% والأدينوزين 0.04% عناية غنية لهذه المنطقة الرقيقة.',
              products: [
                { name: 'MULTI FUNCTIONAL ANTI-WRINKLE CREAM', url: '/products/32', price: '290 AED' },
                { name: 'ND Cell ANTI-WRINKLE CREAM', url: '/products/23', price: '370 AED' },
              ],
      ...
      ru: [
        {
          ...
          steps: [
            ...
            {
              step: 4, title: 'Крем для лица и шеи', duration: '30 сек',
              summary: 'Выберите лёгкую текстуру для лица и более насыщенный уход для шеи и декольте.',
              detail: 'Нанесите Multi Functional Anti-Wrinkle Cream на лицо, а ND Cell распределите по шее и декольте. Сквалан 5% и аденозин 0,04% обеспечивают насыщенный уход за этой тонкой зоной.',
              products: [
                { name: 'MULTI FUNCTIONAL ANTI-WRINKLE CREAM', url: '/products/32', price: '290 AED' },
                { name: 'ND Cell ANTI-WRINKLE CREAM', url: '/products/23', price: '370 AED' },
              ],
    ...
    faq: {
      ...
      ar: [
        ...
        { question: 'ما الفرق بين كريم ND Cell وكريم Multi Functional المضاد للتجاعيد؟', answer: 'Multi Functional Anti-Wrinkle Cream أخف ومخصص للوجه، مع غليسرين 8% وقاعدة ملطفة متوازنة. أما ND Cell فهو كريم أغنى للرقبة وأعلى الصدر، يحتوي على السكوالان 5% وغليسرين 0.70% ويمنح لمسة واقية تساعد على حبس الرطوبة.' },
      ...
      ru: [
        ...
        { question: 'В чём разница между кремом ND Cell и Multi Functional Anti-Wrinkle?', answer: 'Multi Functional Anti-Wrinkle Cream — более лёгкий крем для лица с глицерином 8% и сбалансированной смягчающей основой. ND Cell — насыщенный крем для шеи и декольте со скваланом 5% и глицерином 0,70%; он создаёт более защитный финиш и помогает удерживать влагу.' },
      ],
    },
  },
  ...
  // ─── HYDRATION ──────────────────────────────────────────
  {
    ...
    why: {
      ...
      ar: {
        ...
        items: [
          ...
          { icon: '💧', label: 'حمض الهيالورونيك المتحلل 2,000 جزء في المليون', detail: 'يساعد الشكل الهيالوروني الرئيسي في السيروم على تعويض الرطوبة سريعاً، ويكمله PENTAVITIN بنسبة 0.615% لدعم الاحتفاظ بها' },
          ...
          { icon: '⏱️', label: 'طبقات مريحة', detail: 'يُستخدم التونر ثم السيروم ثم الكريم بحسب حاجة البشرة، مع قوامات يسهل تنسيقها صباحاً ومساءً' },
        ],
      },
      ru: {
        ...
        items: [
          ...
          { icon: '💧', label: 'Гидролизованная гиалуроновая кислота 2 000 ppm', detail: 'Главная гиалуроновая форма сыворотки помогает быстро восполнить влагу, а PENTAVITIN 0,615% поддерживает её удержание' },
          ...
          { icon: '⏱️', label: 'Комфортные слои', detail: 'Тоник, сыворотка и крем наслаиваются по потребности кожи и легко встраиваются в утренний и вечерний уход' },
        ],
      },
    },
    routine: {
      ...
      ru: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              summary: 'Лёгкая сыворотка восполняет влагу и помогает коже её удерживать.',
    ...
    faq: {
      ...
      ar: [
        { question: 'لماذا تشعر البشرة بالجفاف مع التكييف؟', answer: 'قد يزيد الهواء المكيف فقدان الماء من سطح البشرة، لذلك يفيد روتين بسيط من سيروم مائي ثم كريم يساعد على الاحتفاظ بالرطوبة.' },
      ...
      ru: [
        { question: 'Почему кондиционер усиливает сухость кожи?', answer: 'Кондиционированный воздух может усиливать потерю воды с поверхности кожи, поэтому помогает простой уход: лёгкая водная сыворотка, затем крем для удержания влаги.' },
