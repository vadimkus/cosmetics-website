...
/**
 * Warehouse write-off @ buyPrice — Revita Glow BB #01 Bright 50g ×2.
 *
 *   node --import dotenv/config scripts/moysklad-create-revita-glow-bright-writeoff-20260701.js
 *   node --import dotenv/config scripts/moysklad-create-revita-glow-bright-writeoff-20260701.js --commit
 */
...
const MARKER = `REVITA-GLOW-BRIGHT-WRITE-OFF-${uaeToday()}`

const LINES = [['54472', 2, 'Revita Glow BB Cream #01 Bright 50g']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Warehouse write-off — Revita Glow BB Bright 54472 ×2')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '54472 Revita Glow BB Cream #01 Bright 50g x2.',
    ].join(' | '),
