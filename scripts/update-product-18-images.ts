/**
 * Update product 18 (MOISTURE REPLENISHING HYALURON SERUM) to the new
 * public/images/hyaluron_serum/ set (main + s1–s6).
 *
 * Dry run:
 *   npx tsx --env-file=.env.local scripts/update-product-18-images.ts
 * Apply:
...
const NEW_MAIN = '/images/hyaluron_serum/main.jpeg'
const NEW_GALLERY = [
...
const OLD_IMAGES = [
  '/images/HRS.jpg',
  'https://genosys.ae/images/HRS.jpg',
  'https://www.genosys.ae/images/HRS.jpg',
  '/images/Second/hyalserum1.jpg',
  'https://genosys.ae/images/Second/hyalserum1.jpg',
  'https://www.genosys.ae/images/Second/hyalserum1.jpg',
]
...
async function main() {
  const p = await prisma.product.findFirst({
    where: { OR: [{ id: '18' }, { productNumber: '18' }] },
  ...
  if (dryRun) {
    ...
    console.log('orderItems for product 18 total:', byProduct)
    ...
    const hit = blogs.filter((b) =>
      [b.featuredImage, b.content, b.contentAr, b.contentRu].some((c) =>
        Boolean(c && (c.includes('HRS.jpg') || c.includes('hyalserum1'))),
      ),
    )
    console.log(
