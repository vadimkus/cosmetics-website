...
/**
 * Create MoySklad documents for Volna Beauty Salon L.L.C:
 * - received commissioner report for sold items
 * - shipment with the same items and quantities
 *
 * Usage:
 *   set -a; source .env; set +a
 *   node scripts/moysklad-create-volna-sales-20260502.js
 *   node scripts/moysklad-create-volna-sales-20260502.js --commit
 */
...
const REPORT = {
  moment: '2026-05-02 17:25:00',
  stateNotPaidId: '3203736c-c43b-11eb-0a80-093a002b59a6',
  marker: 'Volna Beauty Salon sales report 2026-05-02',
}

const DEMAND = {
  moment: '2026-05-02 17:28:00',
  stateShippedId: '50d70717-4582-11ea-0a80-05e3001273a2',
  marker: 'Volna Beauty Salon shipment 2026-05-02',
}
...
async function createReport(resolved) {
  const payload = {
    ...
    rewardPercent: 0,
    description: [REPORT.marker, 'Customer: Volna Beauty Salon L.L.C', 'Contract: 19'].join('\n'),
...
async function main() {
  console.log('====================================================================')
  console.log('  MoySklad Volna sales report + shipment')
  console.log('====================================================================')
