...
/**
 * CEIA CLINIC L.L.C — unpaid clinic SO → invoice → shipment.
 * Multi Functional Anti-Wrinkle Cream 250g ×1 @ 210
 * + Scalp Peeling ×1 @ 145
 * + Hair Solution Professional ×1 @ 370
 * = 725 AED. No delivery. Legal_TAX PDF → ~/Desktop/orders/
 *
 *   node --import dotenv/config scripts/moysklad-create-ceia-clinic-order-invoice-demand-20260813.js
 *   node --import dotenv/config scripts/moysklad-create-ceia-clinic-order-invoice-demand-20260813.js --commit
 */
...
const ORDER = {
  ...
  moment: uaeMomentNow(),
  marker: `CEIA-CLINIC-IMFC250-SCALP-HAIRPRO-${uaeToday()}`,
}

/** [code, qty, clinicAed] */
const PRODUCT_LINES = [
  ['00034', 1, 210], // Multi Functional Anti-Wrinkle Cream 250g
  ['00050', 1, 145], // HR³ Matrix Scalp Peeling 100ml
  ['00048', 1, 370], // HR³ Matrix Hair Solution Professional Box (8pcs)
]
const EXPECTED_SUM_MINOR = 72500 // 210 + 145 + 370
...
async function main() {
  console.log('====================================================================')
  console.log('  CEIA CLINIC — IMFC 250g + scalp peeling + hair solution pro')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      'Clinic: 00034 Anti-Wrinkle Cream 250g x1 @210; 00050 Scalp Peeling x1 @145; 00048 Hair Solution Pro x1 @370. No delivery. Unpaid.',
