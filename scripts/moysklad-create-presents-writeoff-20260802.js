...
/**
 * Presents — warehouse write-off @ buyPrice (2026-08-02):
 *   54470 BIO-MESO PDRN Expert Ampoule 60000 ×3
 *   54475 BIO-MESO PDRN Homecare Ampoule 5000 ×3
 *   00063 Intensive Repair Collagen Mask ×5
 *   00140 Soothing Bomb Sea Algae Mask ×5
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260802.js
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260802.js --commit
 */
...
const MARKER = `PRESENTS-PDRN60000-PDRN5000-COLLAGEN-SEA-${uaeToday()}`

const LINES = [
  ['54470', 3, 'BIO-MESO PDRN Expert Ampoule 60000'],
...
async function main() {
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'PDRN 60000 x3, PDRN 5000 x3, collagen x5, sea algae x5.',
    ].join(' | '),
