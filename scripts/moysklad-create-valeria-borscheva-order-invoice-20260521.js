...
/**
 * Dr. Valeria Borscheva (Valeriya Borsheva) — retail order + invoice.
 *
 * Lines: BB cushion #2 Beige (00144) ×2, Ultra Shield SPF50 (54457) ×1,
 *        Excellent Delivery Dubai ×1.
 *
 *   node --import dotenv/config scripts/moysklad-create-valeria-borscheva-order-invoice-20260521.js
 *   node --import dotenv/config scripts/moysklad-create-valeria-borscheva-order-invoice-20260521.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}3847`,
  moment: uaeMomentNow(),
  marker: `Valeria Borscheva retail BB Beige x2 SPF50 x1 Dubai delivery ${uaeToday()}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Dr. Valeria Borscheva — order + invoice')
  console.log('====================================================================')
  ...
  const orderPayload = {
    ...
    description: [
      ORDER.marker,
      'Retail: BB cushion Beige (00144) x2, Ultra Shield SPF50 (54457) x1, Dubai delivery 45 AED',
    ].join(' | '),
