...
const AR: BeautyBoxCopy = {
  ...
  subheadline:
    'روتين كامل للبشرة الدهنية والمختلطة يبدأ بمنظف أكسجيني لا يحتاج إلى فرك، ثم تونر وسيروم وكريم بقوامات خفيفة، مع ثلاثة أقنعة بالطحالب البحرية للأمسيات التي تحتاج فيها البشرة إلى عناية إضافية. يساعد السيروم بزنك PCA بتركيز 0.05% على تنظيم فائض الزهم، بينما تدعم مكونات الترطيب راحة البشرة.',
  heroBullets: [
    'اللمعان والبثور والآثار التي تتركها وراءها، وهي عادةً الجزء الذي لا يعالجه أحد',
    'زنك PCA بتركيز 0.05% في السيروم للمساعدة على تنظيم فائض الزهم واللمعان',
  ...
  stats: [
    ...
    { value: '0.05%', label: 'زنك PCA في السيروم للمساعدة على تنظيم فائض الزهم واللمعان' },
  ...
  contents: {
    ...
    items: [
      ...
      },
      {
        ...
        body:
          'يختتم الروتين بطبقة هلامية خفيفة لا تثقل البشرة. يساعد التريهالوز 1.5% والزيليتول 0.5% على الاحتفاظ بالماء، بينما يواصل زنك \u2066PCA\u2069 بتركيز 0.05% العناية باللمعان. تخلو التركيبة من الزيوت النباتية والزبدات والشموع.',
  ...
  howTo: {
    ...
    note:
      'يحتوي التونر على حمض \u2066BHA\u2069، لذا استخدم واقي الشمس صباحاً. أما السيروم فليس مقشراً: لا يحتوي على حمض الساليسيليك أو أحماض \u2066AHA/BHA\u2069.',
  },
  evidence: {
    eyebrow: 'ما بداخله',
    title: 'الأرقام وراءه',
    intro:
      'يجمع الصندوق نتائج القياس المتوفرة مع تفاصيل التركيبة الدقيقة لكل خطوة. أما السيروم فنقدمه وفق تركيبته الموثقة، من دون نسب نتائج غير مثبتة.',
    cards: [
      {
        value: '50%',
  ...
  details: {
    ...
    rows: [
      ...
      { label: 'الأرقام الأساسية', value: 'التونر: دهون أقل بنحو 50% خلال أربعة أسابيع. السيروم: زنك PCA 0.05% وتريهالوز 1%. الكريم: دهون أقل 14% وآثار أقل 9% خلال أربعة أسابيع' },
...
const RU: BeautyBoxCopy = {
  ...
  subheadline:
    'Полный уход для жирной и комбинированной кожи: кислородный очиститель без интенсивного трения, затем тоник, сыворотка и крем с лёгкими текстурами, плюс три маски с морскими водорослями для дополнительного комфорта. Цинк PCA 0,05% в сыворотке помогает контролировать избыток себума, а увлажняющие компоненты поддерживают баланс кожи.',
  heroBullets: [
    'Блеск, высыпания и следы, которые они оставляют - обычно именно последнее никто не лечит',
    'Цинк PCA 0,05% в сыворотке помогает контролировать избыток себума и блеск',
  ...
  stats: [
    ...
    { value: '0,05%', label: 'цинка PCA в сыворотке для контроля избытка себума и блеска' },
  ...
  howTo: {
    ...
    note:
      'В тонике есть BHA, поэтому утром используйте SPF. Сыворотка не является кислотным эксфолиантом: салициловой кислоты и других AHA/BHA-кислот в её формуле нет.',
  },
  evidence: {
    eyebrow: 'Что внутри',
    title: 'Цифры, на которых всё держится',
    intro:
      'Здесь собраны доступные результаты измерений и точные сведения о формуле каждого этапа. Сыворотка представлена по подтверждённому составу, без неподкреплённых процентов результата.',
    cards: [
      {
        value: '50%',
  ...
  details: {
    ...
    rows: [
      ...
      { label: 'Ключевые цифры', value: 'Тоник: примерно на 50% меньше себума за четыре недели. Сыворотка: цинк PCA 0,05% и трегалоза 1%. Крем: на 14% меньше себума и на 9% меньше следов за четыре недели' },
