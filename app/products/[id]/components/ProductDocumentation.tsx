          ...
          <div key={index} className="flex items-center gap-4">
            ...
            {doc.type === 'pdf' ? (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--cera-cta)] text-white rounded-lg hover:bg-[var(--cera-rose-ink)] transition-colors text-sm font-medium"
              >
