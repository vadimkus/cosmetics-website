...
/**
 * SHINE MEDICAL CENTER LLC OPC (Dibba) — clinic SO → invoice → shipment + PDF.
 *
 *   54467 Skin Reboot PDRN Mask Pack ×1 @ 200
 *   00013 Hydro Cool Modeling Mask 1kg ×1 @ 300
 *   00015 SRS 1 Vial 2ml ×10 @ 40.50
 *   00065 Power Solution PCS ×10 @ 29
 *   (SWS 00020 skipped — out of stock)
 *   Total: 1,195 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-shine-medical-center-order-invoice-demand-20260716.js
...
const AGENT_ID = '51c7851a-37da-11f1-0a80-148900411927' // SHINE MEDICAL CENTER LLC OPC
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}5371`,
  marker: `SHINE-MEDICAL-DIBBA-MASKS-PEELING-${uaeToday()}`,
}
...
const EXPECTED_SUM_MINOR = 119500
...
async function exportInvoicePdf(invoiceId, invoiceName) {
  ...
  const outPath = path.join(ordersDir, `GENOSYS_Shine_Medical_Center_${safe}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  SHINE MEDICAL CENTER — SO → invoice → shipment + PDF')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      '54467 PDRN mask pack x1; 00013 Hydro Cool x1; 00015 SRS x10; 00065 PCS x10 @ clinic list. SWS skipped (OOS).',
