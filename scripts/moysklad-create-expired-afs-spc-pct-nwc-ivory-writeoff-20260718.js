...
/**
 * Warehouse write-off @ buyPrice — expired units (2026-07-18):
 *   00030 All For Sensitive Serum 30ml ×2
 *   00037 Skin Barrier Protecting Cream 100g ×1
 *   00145 Problem Control Toner 200ml ×1
 *   00044 ND Cell Anti-Wrinkle Cream 50ml ×1
 *   00143 Cushion #1 Ivory ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-expired-afs-spc-pct-nwc-ivory-writeoff-20260718.js
 *   node --import dotenv/config scripts/moysklad-create-expired-afs-spc-pct-nwc-ivory-writeoff-20260718.js --commit
 */
...
const MARKER = `EXPIRED-AFS-SPC-PCT-NWC-IVORY-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Write-off — expired AFS/SPC/PCT/NWC/Ivory @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Expired warehouse write-off at buyPrice.',
      '00030 AFS x2; 00037 SPC x1; 00145 PCT 200ml x1; 00044 ND Cell cream x1; 00143 Ivory cushion x1.',
    ].join(' | '),
