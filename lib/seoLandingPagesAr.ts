...
export const SEO_LANDING_PAGES_AR: SeoLandingPage[] = [
  ...
  },
  {
    ...
    title: 'واقي شمس كوري للإمارات | كيف تختار Sunscreen كوري لمناخ دبي',
    description: 'أفضل واقي شمس كوري لدبي والإمارات: كيف تختار sunscreen كوري بحماية واسعة الطيف وSPF 50+، وكم مرة تجدده في الحر، وهل يكفي كوشن SPF، مع منتجات GENOSYS المسجلة.',
    h1: 'واقي شمس كوري لمناخ دبي والإمارات',
    eyebrow: 'حماية يومية من الشمس لدبي والإمارات',
    intro: 'تبحث عن واقي شمس كوري (sunscreen كوري) يصمد في حر الإمارات؟ الواقي المفيد لدبي هو الذي يوفر حماية واسعة الطيف ويمكنك وضعه بكمية كافية وإعادة تطبيقه عند البقاء في الخارج. القوام مهم لأن الراحة والتغطية والمكياج والعرق والعادات تحدد الاستخدام الفعلي.',
    takeaways: [
    ...
    faq: [
      { question: 'ما الفرق بين sunscreen كوري وsun block كوري؟', answer: 'التسميتان تُستخدمان في الإمارات للمنتج نفسه: واقي شمس. ما يهم فعلاً هو التصنيف على العبوة (SPF وPA)، وأن يكون واسع الطيف، وأن تضعه بكمية كافية وتجدده. GENOSYS ULTRA SHIELD SUN CREAM مسجل بتصنيف SPF 50+ PA++++، وكوشن وBB كريم GENOSYS يحملان SPF لدعم التجديد فوق المكياج.' },
      { question: 'ما أفضل واقي شمس كوري لدبي والإمارات؟', answer: 'اختاري واقياً واسع الطيف SPF 30 أو أعلى، ويفضل كثيرون SPF 50+ للتعرض القوي. تعتمد النتيجة أيضاً على الكمية والتجديد والنشاط ومقاومة الماء.' },
    ...
    keywords: ['واقي شمس كوري', 'واقي الشمس الكوري', 'sunscreen كوري', 'sun block كوري', 'واقي شمس كوري الإمارات', 'واقي شمس دبي', 'SPF الإمارات'],
  },
  {
