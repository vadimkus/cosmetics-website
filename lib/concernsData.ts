  ...
  // ─── PIGMENTATION ──────────────────────────────────────────
  {
    ...
    faq: {
      ...
      ru: [
        ...
        { question: 'Безопасны ли корейские осветляющие средства для тёмной кожи?', answer: 'Да, осветляющие продукты GENOSYS безопасны для всех тонов кожи, включая фототипы IV–VI по Фитцпатрику, распространённые на Ближнем Востоке. Они работают за счёт регулирования выработки меланина через ингибирование тирозиназы, а не отбеливания, что делает их безопаснее и эффективнее при длительном использовании. Все продукты дерматологически протестированы и не содержат гидрохинон.' },
  ...
  // ─── SCARS TREATMENT ──────────────────────────────────────────
  {
    ...
    why: {
      en: {
        ...
        items: [
          ...
          { icon: '🔬', label: 'EGF Technology', detail: 'Epidermal Growth Factor (EGF) accelerates skin cell turnover and repair. GENOSYS Soothing Repair Postcream and EGF Oxymask deliver concentrated EGF directly to scar tissue for faster regeneration' },
      ...
      ru: {
        ...
        items: [
          ...
          { icon: '🔬', label: 'Технология EGF', detail: 'Эпидермальный фактор роста (EGF) ускоряет обновление и восстановление клеток кожи. Крем GENOSYS Soothing Repair Postcream и маска EGF Oxymask доставляют концентрированный EGF непосредственно в рубцовую ткань' },
          { icon: '🪡', label: 'Синергия с микронидлингом', detail: 'Профессиональные устройства GENOSYS для микронидлинга создают тысячи микроканалов, запускающих каскад заживления — в сочетании с восстанавливающими сыворотками EGF результаты значительно усиливаются' },
          { icon: '☀️', label: 'УФ-защита критична', detail: 'Солнце навсегда затемняет рубцы, стимулируя избыточный меланин в повреждённых тканях. Ежедневный SPF 50+ обязателен при любом протоколе лечения рубцов' },
        ],
      },
    },
    seo: {
      ...
      en: [
        ...
        },
        {
          ...
          steps: [
            ...
            {
              step: 3, title: 'EGF Oxymask', duration: '1 min',
              summary: 'Intensive overnight EGF repair — concentrated growth factors work while you sleep.',
              detail: 'Apply a generous layer of EGF Repair Oxymask Cream as a sleeping mask. The concentrated EGF formula works overnight to stimulate collagen remodelling and cell renewal in scar tissue. Leave on until morning for maximum absorption.',
              products: [{ name: 'EGF REPAIR OXYMASK CREAM', url: '/products/26', price: '290 AED' }],
            },
            {
              step: 4, title: 'Barrier Cream', duration: '30 sec',
              summary: 'Seal in repair actives and protect the skin barrier overnight.',
              detail: 'Apply SKIN BARRIER PROTECTING CREAM over the Oxymask to lock in EGF and prevent transepidermal water loss while you sleep. A strong barrier is essential for scar healing — compromised barriers slow collagen production.',
      ...
      ar: [
        ...
        },
        {
          ...
          steps: [
            ...
            {
              step: 3, title: 'قناع EGF', duration: 'دقيقة واحدة',
              summary: 'إصلاح ليلي مكثف بعوامل النمو — يعمل أثناء النوم.',
              detail: 'ضعي طبقة سخية من قناع EGF Repair Oxymask كقناع ليلي. تركيبة EGF المركزة تعمل طوال الليل لتحفيز إعادة بناء الكولاجين وتجديد الخلايا في أنسجة الندبات. اتركيه حتى الصباح.',
              products: [{ name: 'EGF REPAIR OXYMASK CREAM', url: '/products/26', price: '290 AED' }],
            },
            {
              step: 4, title: 'كريم الحاجز', duration: '30 ثانية',
              summary: 'حبس المكونات الإصلاحية وحماية حاجز البشرة طوال الليل.',
              detail: 'ضعي كريم حماية حاجز البشرة فوق القناع لقفل EGF ومنع فقدان الماء أثناء النوم. حاجز قوي ضروري لالتئام الندبات.',
              products: [{ name: 'SKIN BARRIER PROTECTING CREAM', url: '/products/27', price: '450 AED' }],
            },
          ],
        },
      ...
      ru: [
        ...
        },
        {
          ...
          steps: [
            ...
            {
              step: 3, title: 'EGF-маска', duration: '1 мин',
              summary: 'Интенсивное ночное восстановление с факторами роста — работает, пока вы спите.',
              detail: 'Нанесите щедрый слой EGF Repair Oxymask как ночную маску. Концентрированная формула EGF работает всю ночь, стимулируя ремоделирование коллагена и обновление клеток в рубцовой ткани. Оставьте до утра.',
              products: [{ name: 'EGF REPAIR OXYMASK CREAM', url: '/products/26', price: '290 AED' }],
            },
            {
              step: 4, title: 'Барьерный крем', duration: '30 сек',
              summary: 'Запечатайте восстанавливающие активы и защитите барьер кожи на ночь.',
              detail: 'Нанесите SKIN BARRIER PROTECTING CREAM поверх маски для фиксации EGF и предотвращения трансэпидермальной потери воды. Крепкий барьер необходим для заживления рубцов.',
              products: [{ name: 'SKIN BARRIER PROTECTING CREAM', url: '/products/27', price: '450 AED' }],
            },
          ],
        },
    ...
    faq: {
      en: [
        ...
        { question: 'What GENOSYS products are best for scar treatment at home?', answer: 'For home scar treatment, we recommend the GENOSYS Microneedle Roller combined with the Soothing Repair Postcream (204 AED) and EGF Repair Oxymask Cream (290 AED). The roller creates micro-channels for better product absorption, while the repair creams contain EGF (Epidermal Growth Factor) that promotes skin cell regeneration. Pair with Hyaluron Serum (330 AED) for hydration and ULTRA SHIELD SPF 50+ (250 AED) to prevent scar darkening.' },
        { question: 'How long does it take to see improvement in scars?', answer: 'Results depend on scar type and severity. Surface-level post-acne marks may start fading within 4–6 weeks of consistent EGF use. Deeper atrophic (pitted) scars typically show noticeable improvement after 8–12 weeks with a combined routine of daily EGF Postcream, twice-weekly exfoliation, and the EGF Oxymask overnight. Professional microneedling can accelerate results — most patients see 40–60% improvement after 3 sessions spaced 4 weeks apart.' },
        { question: 'Can I treat old scars that are several years old?', answer: 'Yes, even mature scars respond to treatment — though they require more patience. Old scars have settled collagen structures, but EGF (Epidermal Growth Factor) can still stimulate new cell turnover and gradual remodelling. The Soothing Repair Postcream and EGF Oxymask work over time to soften rigid scar tissue and improve texture. Microneedling is especially effective for old scars because it forces the skin to restart the wound-healing cascade. Expect 3–6 months of consistent use for visible improvement on scars older than 2 years.' },
        ...
        { question: 'What is the difference between EGF Oxymask and Soothing Postcream?', answer: 'Both contain EGF (Epidermal Growth Factor), but they serve different roles. The Soothing Repair Postcream (204 AED) is a lightweight daily cream designed for morning and daytime use — it absorbs quickly, calms inflammation, and provides continuous low-dose EGF repair throughout the day. The EGF Repair Oxymask Cream (290 AED) is a richer, intensive overnight treatment with a higher concentration of EGF and oxygen-infusion technology. Use the Postcream every morning and the Oxymask every evening for a 24-hour EGF repair cycle.' },
      ],
      ar: [
        ...
        { question: 'ما الفرق بين قناع EGF Oxymask وكريم الإصلاح المهدئ؟', answer: 'كلاهما يحتوي على عامل نمو البشرة (EGF) لكن بأدوار مختلفة. كريم الإصلاح المهدئ (204 درهم) كريم يومي خفيف للاستخدام الصباحي — يُمتص بسرعة ويوفر إصلاح EGF مستمر طوال اليوم. قناع EGF Repair Oxymask (290 درهم) علاج ليلي مكثف بتركيز أعلى من EGF وتقنية ضخ الأكسجين. استخدمي الكريم كل صباح والقناع كل مساء لدورة إصلاح EGF على مدار 24 ساعة.' },
      ],
      ru: [
        ...
        { question: 'Чем отличается EGF Oxymask от Soothing Postcream?', answer: 'Оба содержат EGF (эпидермальный фактор роста), но выполняют разные роли. Soothing Repair Postcream (204 дирхама) — лёгкий дневной крем для утреннего использования: быстро впитывается, успокаивает воспаление и обеспечивает непрерывное восстановление EGF в течение дня. EGF Repair Oxymask (290 дирхамов) — интенсивный ночной уход с более высокой концентрацией EGF и технологией кислородного насыщения. Используйте крем утром, а маску вечером для 24-часового цикла восстановления.' },
      ],
    },
  },
      ...
      en: [
        ...
        },
        {
          ...
          steps: [
            ...
            {
              step: 4, title: 'EGF Repair or Night Cream', duration: '30 sec',
              summary: 'Intensive overnight repair — EGF accelerates cell turnover and collagen synthesis.',
              detail: 'Choose by goal: EGF Repair OxyMask Cream for intensive renewal and radiance boost, or ND Cell Anti-Wrinkle Cream for deep wrinkle targeting and maximum growth factor delivery.',
              products: [
                { name: 'EGF REPAIR OXYMASK CREAM', url: '/products/26', price: '290 AED' },
                { name: 'ND Cell ANTI-WRINKLE CREAM', url: '/products/23', price: '370 AED' },
              ],
            },
            {
      ...
      ar: [
        ...
        },
        {
          ...
          steps: [
            ...
            {
              step: 4, title: 'كريم إصلاح EGF أو كريم ليلي', duration: '30 ثانية',
              summary: 'إصلاح مكثف ليلي — EGF يسرّع تجديد الخلايا وتخليق الكولاجين.',
              detail: 'اختاري حسب الهدف: كريم EGF Repair OxyMask للتجديد المكثف، أو كريم ND Cell لاستهداف التجاعيد العميقة.',
              products: [
                { name: 'EGF REPAIR OXYMASK CREAM', url: '/products/26', price: '290 AED' },
                { name: 'ND Cell ANTI-WRINKLE CREAM', url: '/products/23', price: '370 AED' },
              ],
      ...
      ru: [
        ...
        },
        {
          ...
          steps: [
            ...
            {
              step: 4, title: 'EGF-крем или ночной крем', duration: '30 сек',
              summary: 'Интенсивное ночное восстановление — EGF ускоряет обновление клеток и синтез коллагена.',
              detail: 'Выберите по цели: EGF Repair OxyMask Cream для интенсивного обновления, или ND Cell Anti-Wrinkle Cream для воздействия на глубокие морщины.',
              products: [
                { name: 'EGF REPAIR OXYMASK CREAM', url: '/products/26', price: '290 AED' },
                { name: 'ND Cell ANTI-WRINKLE CREAM', url: '/products/23', price: '370 AED' },
              ],
