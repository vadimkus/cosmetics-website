 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-ladies-mist-commission-report-payment-20260722.js
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-ladies-mist-commission-report-payment-20260722.js --commit
 */
...
/** code, qty */
const LINES = [['00188', 2]]
const EXPECTED_SUM_MINOR = 16000
...
async function main() {
  ...
  if (totalMinor !== EXPECTED_SUM_MINOR) {
    throw new Error(`Expected total ${money(EXPECTED_SUM_MINOR)} AED, got ${money(totalMinor)}`)
  }
