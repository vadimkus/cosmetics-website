...
/**
 * Sales bonus payout to Vadim Sagatdinov — 10,000.00 AED (August 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-10000-20260809.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-10000-20260809.js --commit
 */
...
const SUM_MINOR = 1000000 // 10,000.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-AUG-10000-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (August 2026) — 10,000 AED')
  console.log('====================================================================')
