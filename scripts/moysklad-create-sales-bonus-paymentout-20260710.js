...
/**
 * Sales bonus payout to Vadim Sagatdinov — 2,000.00 AED (2026-07-10).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-20260710.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-20260710.js --commit
 */
...
const MARKER = `SALES-BONUS-SAGATDINOV-2000-${uaeToday()}`
