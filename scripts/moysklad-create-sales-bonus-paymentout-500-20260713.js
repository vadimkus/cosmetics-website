...
/**
 * Sales bonus payout to Vadim Sagatdinov — 500.00 AED (2026-07-13).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-500-20260713.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-500-20260713.js --commit
 */
...
const SUM_MINOR = 50000 // 500.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-500-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov')
  console.log('====================================================================')
