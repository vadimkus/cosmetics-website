...
/**
 * FAMILY CLASS POLY CLINIC L.L.C — paymentin @ shipment 06815 / invoice 05027.
 * 1,175 AED. Order GENCardM260905FCMX → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-family-class-paymentin-05027-20260905.js
 *   node --import dotenv/config scripts/moysklad-create-family-class-paymentin-05027-20260905.js --commit
 */
...
const MARKER = `FAMILY-CLASS-PAYMENTIN-05027-${uaeToday()}`

const PAYMENT = {
  amountMinor: 117500,
  invoiceName: '05027',
  invoiceId: '9dfe1052-a8fe-11f1-0a80-143f008c3300',
  shipmentName: '06815',
  shipmentId: '9eae207e-a8fe-11f1-0a80-19ad0090eb11',
  orderName: 'GENCardM260905FCMX',
  orderId: '9db215e5-a8fe-11f1-0a80-143f008c32d3',
}
...
function paymentMomentAfter(demandMoment) {
...
async function main() {
  console.log('====================================================================')
  console.log('  Family Class Polyclinic — paymentin @ 05027 / 06815')
  console.log('====================================================================')
  ...
  if (!/FAMILY CLASS POLY CLINIC/i.test(order.agent?.name || '')) {
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      `Order ${PAYMENT.orderName} — 1,175 AED.`,
    ].join(' | '),
    operations: [
      {
        meta: {
