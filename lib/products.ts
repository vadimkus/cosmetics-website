...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 580,
    description: '2ml x 10ea. Anti-blemish ampoule for microneedling treatment. Dermatologically tested. Efficacy test on improving excessive sebum production. Features: It is an anti-blemish ampoule specially formulated for microneedling treatment that controls excessive oil and sebum production and helps prevent skin breakout with sh-polypeptide-7 (IGF-1-analog peptide), with hazel leaf extract and houttuynia cordata extract. Skin-Friendly Formulation: Not containing harmful additives considering the increased skin permeability by microneedling (no-paraben, ethanol, artificial fragrance, artificial pigment, sulfate). Key Ingredients: sh-Polypeptide-7, Acetyl Hexapeptide-8, Palmitoyl Hexapeptide-12, Palmitoyl Tripeptide-1, Hamamelis Virginiana (Witch Hazel) Leaf Extract, Vitis Vinifera (Grape) Callus Culture Extract, Rosa Damascena Callus Culture Extract, Pinus Radiata Bark Extract, Houttuynia Cordata Extract. Manufactured in South Korea.',
  ...
  },
  {
    ...
    price: 580,
    description: '2ml x 10ea. Anti-aging ampoule for microneedling treatment. Dermatologically tested. Efficacy test on improving wrinkles. Features: It is an anti-aging ampoule specially formulated for microneedling treatment that helps reduce the appearance of wrinkles and improve skin firmness with sh-polypeptide-7 (IGF-1-analog peptide), firming peptide complex and adenosine. Skin-Friendly Formulation: Not containing harmful additives considering the increased skin permeability by microneedling (no-paraben, ethanol, artificial fragrance, artificial pigment, sulfate). Key Ingredients: sh-polypeptide-7, Acetyl Hexapeptide-8, Palmitoyl Tripeptide-1, Ceramide, Allantoin, Adenosine, Vitis Vinifera (Grape) Callus Culture Extract, Rosa Damascena Callus Culture Extract, Copper Tripeptide-1. Manufactured in South Korea.',
  ...
  },
  {
    ...
    image: '/images/problem_serum/main.jpeg',
    images: JSON.stringify([
  ...
  },
  {
    ...
    images: JSON.stringify(['/images/EZE.jpg', '/images/Second/ez.jpg']),
    category: 'Mask',
    inStock: true,
  },
  {
  ...
  },
  {
    ...
    image: '/images/cushion/main.jpeg',
    images: JSON.stringify([
  ...
  },
  {
    ...
    price: 740,
    description: '4ml. Premium anti-hair loss ampoule for microneedling treatment. It is the premium anti-hair loss product supplying nutrients that fight against the factors causing hair loss. Special applicator with microneedles promotes nutrition delivery into scalp and helps build the right environment for healthy scalp. Components: Professional Kit - HAIR SOLUTION α 4ml(8ea), Dropper(2ea). Homecare Kit - HAIR SOLUTION α 4ml(8ea), microneedle applicator(1ea), Cleansing Brush(1ea), Disinfecting(1ea). Key ingredients: sh-Polypeptide-9 (VEGF), sh-Polypeptide-7 (IGF-1-analog), sh-Oligopeptide-1 (EGF), sh-Polypeptide-71 (VIP), Copper Tripeptide-1, Serenoa Serrulata Fruit Extract (Saw Palmetto), Biosaccharide Gum-4, Panthenol, Menthol, Black Complex, Brassica Oleracea Italica (Broccoli) Extract. Dermatologically tested. Research papers on the improvement of hair loss.',
