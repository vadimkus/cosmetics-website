...
/**
 * Sales bonus payout to Vadim Sagatdinov — 6,000.00 AED (August 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-6000-20260826.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-aug-6000-20260826.js --commit
 */
...
const SUM_MINOR = 600000 // 6,000.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-AUG-600000-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (August 2026) — 6,000.00 AED')
  console.log('====================================================================')
