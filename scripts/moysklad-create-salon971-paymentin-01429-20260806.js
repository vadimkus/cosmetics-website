...
/**
 * Salon 971 — paymentin for commissioner report 01429 (540 AED) + mark Paid.
 *
 *   node --import dotenv/config scripts/moysklad-create-salon971-paymentin-01429-20260806.js
 *   node --import dotenv/config scripts/moysklad-create-salon971-paymentin-01429-20260806.js --commit
 */
...
const REPORT_ID = '44afd3ba-9098-11f1-0a80-09df000fd95b'
const REPORT_NAME = '01429'
const EXPECTED_SUM_MINOR = 54000 // 540.00
const STATE_REPORT_PAID_ID = 'fd15289c-c3c4-11eb-0a80-065200268290'
const MARKER = `SALON971-CONSIGNMENT-PAYMENT-${REPORT_NAME}-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Salon 971 — paymentin @ consignment report 01429 (540)')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Salon 971 — consignment sales 540 AED — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
