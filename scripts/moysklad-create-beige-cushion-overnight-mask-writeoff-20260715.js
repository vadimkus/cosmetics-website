 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-beige-cushion-overnight-mask-writeoff-20260715.js
 *   node --import dotenv/config scripts/moysklad-create-beige-cushion-overnight-mask-writeoff-20260715.js --commit
 */
...
const MARKER = `BEIGE-CUSHION-OVERNIGHT-MASK-WRITE-OFF-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Write-off — beige cushion + overnight mask @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00144 Cushion #2 Beige x1; 00189 Overnight Cream Mask 100g x1.',
    ].join(' | '),
