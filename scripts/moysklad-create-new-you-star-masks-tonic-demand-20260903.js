...
/**
 * NEW YOU STAR — consignment replenishment into agreement 37.
 *   00063 Collagen mask ×15 @ 18
 *   00140 Sea algae mask ×15 @ 18
 *   00051 Hair tonic 70ml ×3 @ 145
 *   Total: 975 AED / 33 pcs
 *
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-masks-tonic-demand-20260903.js
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-masks-tonic-demand-20260903.js --commit
 */
...
const MARKER = `NEW-YOU-STAR-COLLAGEN15-SEA15-TONIC3-${uaeToday()}`
const LINES = [
  ['00063', 15, 18],
  ['00140', 15, 18],
  ['00051', 3, 145],
]
const EXPECTED_SUM_MINOR = 97500
...
async function exportStockNotePdf(demandId, demandName) {
  ...
  const out = path.join(ORDERS_DIR, `GENOSYS_NEW_YOU_STAR_${demandName}_Consignment_Stock_Note.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  NEW YOU STAR — collagen 15 + sea algae 15 + tonic 3 into agr. 37')
  console.log('====================================================================')
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      ...
      'Replenishment: 00063 Collagen x15 @18; 00140 Sea algae x15 @18; 00051 Tonic x3 @145 clinic.',
    ].join('\n'),
    positions,
  })
