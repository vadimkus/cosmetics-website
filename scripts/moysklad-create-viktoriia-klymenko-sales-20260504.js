...
/**
 * Create MoySklad documents for Viktoriia Klymenko:
 *
 ...
 *   node scripts/moysklad-create-viktoriia-klymenko-sales-20260504.js
 *
 * Commit:
 *   node scripts/moysklad-create-viktoriia-klymenko-sales-20260504.js --commit
 */
...
const REPORT = {
  moment: '2026-05-04 13:20:00',
  stateNotPaidId: '3203736c-c43b-11eb-0a80-093a002b59a6',
  marker: 'Viktoriia Klymenko consignment sales 2026-05-04',
}

const DEMAND = {
  moment: '2026-05-04 13:23:00',
  stateShippedId: '50d70717-4582-11ea-0a80-05e3001273a2',
  marker: 'Viktoriia Klymenko shipment 2026-05-04',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  MoySklad Viktoriia Klymenko sales report + shipment')
  console.log('====================================================================')
