...
/**
 * Presents — warehouse write-off @ buyPrice (2026-07-24):
 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260724.js
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-20260724.js --commit
 */
...
const MARKER = `PRESENTS-BB-SRS-COLLAGEN-SEA-PEPTIDE-${uaeToday()}`
...
async function main() {
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'Revita BB Bright x1, SRS x20, collagen x10, sea algae x10, peptide gel mask x10.',
    ].join(' | '),
