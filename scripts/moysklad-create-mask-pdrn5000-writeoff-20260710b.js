 ...
 *   54475 BIO-MESO PDRN Homecare Ampoule 5000 ×5
 *
 *   node --import dotenv/config scripts/moysklad-create-mask-pdrn5000-writeoff-20260710b.js --commit
 */
...
async function main() {
  console.log('====================================================================')
  console.log('  Warehouse write-off — collagen, peptide, sea algae, PDRN 5000')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00063 collagen mask x10, 00012 peptide mask x5, 00140 sea algae mask x10, 54475 PDRN homecare 5000 x5.',
    ].join(' | '),
