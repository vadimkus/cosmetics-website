...
/**
 * Present to Abeer Mekki — warehouse write-off @ buyPrice (2026-07-22):
 *   54484 CERABARRIER 200ml ×1
 *   00021 Snow O₂ Cleanser 180ml ×1
 *   00015 SRS peeling vial ×10
 *   00018 Power Solution AWS vial ×10
 *   54465 Soothing Repair Post Cream 100g ×1
 *   00063 Collagen mask ×3
 *   00140 Sea Algae mask ×3
 *   00012 Peptide Gel Mask ×2
 *   54470 BIO-MESO PDRN Expert 60000 ×1
 *   54475 BIO-MESO PDRN Homecare 5000 ×1
 *   00022 Snow Booster Toner 200ml ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-abeer-present-writeoff-20260722.js
 *   node --import dotenv/config scripts/moysklad-create-abeer-present-writeoff-20260722.js --commit
 */
...
async function main() {
  console.log('====================================================================')
  console.log('  Present to Abeer — write-off @ buyPrice')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Presents for Abeer Mekki — warehouse write-off at buyPrice.',
      'Cerabarrier 200, Snow O2 180, SRS x10, AWS x10, Postcream 100g, collagen x3, sea algae x3, peptide x2, PDRN 60000/5000, Snow Booster 200.',
    ].join(' | '),
