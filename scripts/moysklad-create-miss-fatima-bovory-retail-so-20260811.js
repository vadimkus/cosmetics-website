...
/**
 * Miss Fatima Bovory — retail SO only (no invoice/shipment).
 *
 *   00021 Snow O₂ Cleanser 180ml ×1 @ 330
 *   00030 All For Sensitive Serum 30ml ×1 @ 330
 *   54465 Soothing Repair Post Cream 100g ×1 @ 440
 *   Delivery Dubai ×1 @ 45
 *   Total: 1,145 AED
 *
 *   Phone: +971 55 169 5956 (WhatsApp: Fatima Genosys Bovory)
 *
 *   node --import dotenv/config scripts/moysklad-create-miss-fatima-bovory-retail-so-20260811.js
 *   node --import dotenv/config scripts/moysklad-create-miss-fatima-bovory-retail-so-20260811.js --commit
 */
...
const AGENT_ID = '11aec0e2-92df-11f1-0a80-0eea0031d857' // Fatima Bovory
const ORDERS_DIR = path.join(os.homedir(), 'Desktop', 'orders')

const CUSTOMER = {
  name: 'Miss Fatima Bovory',
  phone: '+971551695956',
  city: 'Dubai',
  street: 'Dubai, UAE',
}

const ORDER_NAME = `GENCardM${uaeShortDate()}5956`
const MARKER = `MISS-FATIMA-BOVORY-CLEANSER-AFS-POSTCREAM-${uaeToday()}`

/** [code, qty, retailAed, discountPct] */
const PRODUCT_LINES = [
  ['00021', 1, 330, 0], // Snow O₂ Cleanser 180ml
  ['00030', 1, 330, 0], // All For Sensitive Serum 30ml
  ['54465', 1, 440, 0], // Soothing Repair Post Cream 100g
]
const DELIVERY_AED = 45
const DELIVERY_DISCOUNT = 0
const EXPECTED_SUM_MINOR = 114500 // 330+330+440+45
...
async function exportOrderPdf(orderId, orderName) {
  ...
  const out = path.join(ORDERS_DIR, `GENOSYS_Miss_Fatima_Bovory_${orderName}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Fatima Bovory — retail SO only')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      MARKER,
      'Retail SO only — no invoice/shipment yet.',
      '00021 cleanser 180 @330; 00030 All For Sensitive Serum @330; 54465 Postcream 100g @440; delivery 45.',
