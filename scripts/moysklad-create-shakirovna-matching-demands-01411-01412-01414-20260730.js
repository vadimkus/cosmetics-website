 ...
 *   Elite 01411 (agreement 21)
 *   Clinic 01412 (agreement 26)
 *   Salon/Marina 01414 (agreement 00030)
 *
 * Same SKUs / qty / prices as each commission report. PDF → ~/Desktop/orders/
 *
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-matching-demands-01411-01412-01414-20260730.js
 *   node --import dotenv/config scripts/moysklad-create-shakirovna-matching-demands-01411-01412-01414-20260730.js --commit
 */
...
const MARKER = `SHAKIROVNA-MATCHING-DEMANDS-01411-01412-01414-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Shakirovna — matching demands for 01411 / 01412 / 01414')
  console.log('====================================================================')
