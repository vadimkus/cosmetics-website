...
/**
 * MOFA — invoices attestation paymentout (304.41 AED).
 *
 * Paid 2026-06-21 for June 16/06 Korea import (DM GME 260616 / CPIP-160626-081300).
 *
 *   node --import dotenv/config scripts/moysklad-create-mofa-attestation-paymentout-20260621.js
 *   node --import dotenv/config scripts/moysklad-create-mofa-attestation-paymentout-20260621.js --commit
 */
...
const SUM_MINOR = 30441 // 304.41 AED
const MARKER = 'MOFA-ATTEST-260616-30441'
const DESCRIPTION =
  'MOFA invoices attestation 304.41 AED — DM GME 260616 / CPIP-160626-081300 (Jun 16/06 import)'
...
async function ensureNoDuplicate() {
  ...
  const bySearch = await api('GET', `/entity/paymentout?search=${encodeURIComponent(MARKER)}&limit=5`)
  const hit = (bySearch.rows || []).find((r) => (r.description || '').includes('260616') && r.sum === SUM_MINOR)
  if (hit) throw new Error(`Duplicate: ${hit.name} already books MOFA 304.41 for 260616 import`)
}
...
async function main() {
  ...
  console.log(`  Ref  : DM GME 260616 / CPIP-160626-081300`)
