...
/**
 * Miss Marina (JLT) — paid retail SO → invoice → shipment → paymentin + landscape print.
 *
 *   00144 Beige cushion ×1 @ 300
 *   Delivery Dubai ×1 @ 30
 *   Total: 330 AED
 *
 *   Address: JLT, Cluster S, Green Lake Towers S2, Apt 1206
 *
 *   node --import dotenv/config scripts/moysklad-create-miss-marina-beige-order-20260802.js
 *   node --import dotenv/config scripts/moysklad-create-miss-marina-beige-order-20260802.js --commit
 *   node --import dotenv/config scripts/moysklad-create-miss-marina-beige-order-20260802.js --commit --no-print
 */
...
const AGENT_ID = 'e9fd9eab-85f3-11ed-0a80-014000752258' // Miss Marina (JLT)
...
const CUSTOMER = {
  ...
  phone: '+971559145339',
  city: 'Dubai',
  street: 'JLT, Cluster S, Green Lake Towers S2, Apt 1206',
}

const ORDER = {
  name: `GENCardM${uaeShortDate()}5339`,
  moment: uaeMomentNow(),
  marker: `MISS-MARINA-BEIGE-DELIVERY30-${uaeToday()}`,
}
...
async function exportInvoicePdf(invoiceId, invoiceName) {
  ...
  const outPath = path.join(ORDERS_DIR, `GENOSYS_Miss_Marina_${invoiceName}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Miss Marina — beige + delivery 30 (paid) + landscape print')
  console.log('====================================================================')
