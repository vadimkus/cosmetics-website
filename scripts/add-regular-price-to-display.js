...
async function addRegularPriceToDisplay() {
  try {
    console.log('🚀 Adding regular price to Problem Skin Care Beauty Box pricing display...')
    ...
    // Replace the pricing line to include regular price
    const updatedDescription = currentDescription.replace(
      /Bundle price: [\d,]+\.?\d*\s+AED\s+\|\s+Save 15% \([-\d.]+ AED\)/,
