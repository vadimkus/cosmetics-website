...
| 🟡 **Important** | [SESSION_CHANGES_2026-05-17_KBEAUTY_BLOG_IMAGE_FIX.md](./SESSION_CHANGES_2026-05-17_KBEAUTY_BLOG_IMAGE_FIX.md) | **K-beauty blog image fix** — moved the hero image out of conflicting `/public/blog`, added a compatibility image route for the existing DB URL, and verified both direct and Next-optimized image URLs locally. |
