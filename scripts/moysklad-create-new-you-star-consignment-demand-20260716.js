...
/**
 * NEW YOU STAR BEAUTY HEALTH CLINIC L.L.C — consignment replenishment (agreement 37).
 *   00059 EyeCell Eye Zone Care Kit (box) ×1
 *   00021 Snow O₂ Cleanser 180ml ×1
 *   54464 Cushion #3 Camel ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-consignment-demand-20260716.js
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-consignment-demand-20260716.js --commit
 */
...
const MARKER = `NEW-YOU-STAR-CONSIGNMENT-EYE-SNOW-CAMEL-${uaeToday()}`
const EXPECTED_SUM_MINOR = 80500
...
async function main() {
  console.log('====================================================================')
  console.log('  NEW YOU STAR — consignment replenishment (eye kit + snow + camel)')
  console.log('====================================================================')
  ...
  const demand = await api('POST', '/entity/demand', {
    ...
    description: [
      MARKER,
      'Consignment replenishment — EyeCell kit x1, Snow O2 cleanser 180ml x1, Camel cushion x1.',
