...
/**
 * Sales bonus payout to Vadim Sagatdinov — 3,500.00 AED (July 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-3500-20260720.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-3500-20260720.js --commit
 */
...
const SUM_MINOR = 350000 // 3,500.00 AED
const MARKER = `SALES-BONUS-SAGATDINOV-JULY-3500-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (July 2026)')
  console.log('====================================================================')
