 ...
 *
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-mist-masks-20260803.js
 *   node --import dotenv/config scripts/moysklad-create-presents-writeoff-mist-masks-20260803.js --commit
 */
...
const MARKER = `PRESENTS-MIST-COLLAGEN-SEA-${uaeToday()}`
...
async function main() {
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      'Mist x1, collagen x4, sea algae x4.',
    ].join(' | '),
