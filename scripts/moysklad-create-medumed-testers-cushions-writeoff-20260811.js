...
/**
 * MEDYUMED MEDICAL CLINIC — testers write-off @ buyPrice (2026-08-11):
 *   54464 BB Cushion #3 Camel ×1
 *   00144 BB Cushion #2 Beige ×1
 *   00143 BB Cushion #1 Ivory ×1
 *
 *   node --import dotenv/config scripts/moysklad-create-medumed-testers-cushions-writeoff-20260811.js
 *   node --import dotenv/config scripts/moysklad-create-medumed-testers-cushions-writeoff-20260811.js --commit
 */
...
const MARKER = `MEDUMED-TESTERS-CAMEL-BEIGE-IVORY-${uaeToday()}`

const LINES = [
  ['54464', 1, 'BB Cushion #3 Camel'],
  ['00144', 1, 'BB Cushion #2 Beige'],
  ['00143', 1, 'BB Cushion #1 Ivory'],
]
...
async function main() {
  console.log('====================================================================')
  console.log('  MEDYUMED — testers write-off (camel / beige / ivory)')
  console.log('====================================================================')
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      MARKER,
      'Testers to new clinic: MEDYUMED MEDICAL CLINIC L.L.C — warehouse write-off at buyPrice.',
      'Camel cushion x1, Beige cushion x1, Ivory cushion x1.',
    ].join(' | '),
