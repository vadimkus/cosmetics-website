...
/**
 * Melanta Poly Clinic — paymentin for commissioner report 01450 (1,647 AED) + mark Paid.
 *
 *   node --import dotenv/config scripts/moysklad-create-melanta-paymentin-01450-20260901.js
 *   node --import dotenv/config scripts/moysklad-create-melanta-paymentin-01450-20260901.js --commit
 */
...
const REPORT_ID = '8d5ddcaa-a607-11f1-0a80-0899004019a3'
const REPORT_NAME = '01450'
...
async function main() {
  console.log('====================================================================')
  console.log('  Melanta — paymentin @ consignment report 01450 (1647)')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'Melanta Poly Clinic — August consignment sales 1,647 AED — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
