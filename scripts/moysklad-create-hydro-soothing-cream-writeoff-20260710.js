 ...
 *   00031 Intensive Hydro Soothing Cream 50g ×4
 *
 *   node --import dotenv/config scripts/moysklad-create-hydro-soothing-cream-writeoff-20260710.js --commit
 */
...
const MARKER = `HYDRO-SOOTHING-50G-WRITE-OFF-${uaeToday()}`

const LINES = [['00031', 4, 'Intensive Hydro Soothing Cream 50g']]
...
async function main() {
  console.log('====================================================================')
  console.log('  Warehouse write-off — Hydro Soothing Cream 50g ×4')
  console.log('====================================================================')
  ...
  console.log(`\n  Total buy cost: ${money(totalMinor)} AED | 4 pcs`)
  ...
  const created = await api('POST', '/entity/loss', {
    ...
    description: [
      ...
      '00031 Intensive Hydro Soothing Cream 50g x4.',
    ].join(' | '),
