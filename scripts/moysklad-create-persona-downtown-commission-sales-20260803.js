...
/**
 * Persona Downtown — July 2026 consignment sales report (agreement 00077) + PDF.
 *
 *   00053 EyeCell Eye Peptide Gel Patch (box) ×1 @ clinic
 *   00129 EPI Turnover Boosting Peeling Gel 100g ×1 @ clinic
 *   Total: 315 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-persona-downtown-commission-sales-20260803.js
 *   node --import dotenv/config scripts/moysklad-create-persona-downtown-commission-sales-20260803.js --commit
 */
...
const AGENT_ID = '19f661fb-b43b-11ee-0a80-0d3b00075ace' // First Person Ladies Salon (Downtown)
const CONTRACT_ID = '2092d415-b43b-11ee-0a80-095a000715c8' // Agreement 00077
...
const MARKER = `Persona Downtown consignment sold July 2026 ${uaeToday()}`
const EXPECTED_SUM_MINOR = 31500 // 190 + 125
...
async function exportSalesPdf(reportId, reportName) {
  ...
  const out = path.join(ORDERS_DIR, `GENOSYS_Persona_Downtown_Consignment_Sales_${reportName}.pdf`)
...
async function main() {
  console.log('====================================================================')
  console.log('  Persona Downtown — July consignment sales (00077)')
  console.log('====================================================================')
  ...
  const report = await api('POST', '/entity/commissionreportin', {
    ...
    description: [
      MARKER,
      'First Person Ladies Salon (Downtown) / Persona Downtown | Agreement 00077.',
      'July 2026: Eye Peptide Gel Patch ×1; EPI Peeling Gel ×1.',
