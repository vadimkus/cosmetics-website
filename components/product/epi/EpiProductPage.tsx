...
/** Tube packshot for the engine section. Gallery s1 still carries the old
 *  "without irritation" slide copy, so the engine figure stays on the main. */
...
export default function EpiProductPage({
  ...
  return (
    <div className={`cera-page epi-page ${ceraSerif.variable} min-h-[100dvh]`} dir={dir}>
      {/* ───────────────────────────── Hero ─────────────────────────────── */}
        ...
        <div>
          ...
          {product.videoUrl ? (
            <CeraReveal className="mt-10">
              ...
              <div className="epi-video relative mt-4 aspect-square overflow-hidden rounded-[28px] sm:aspect-video">
                <video
