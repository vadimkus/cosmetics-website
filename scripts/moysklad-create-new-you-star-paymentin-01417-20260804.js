...
/**
 * NEW YOU STAR — paymentin for commissioner report 01417 (2,112 AED) + mark Paid.
 *
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-paymentin-01417-20260804.js
 *   node --import dotenv/config scripts/moysklad-create-new-you-star-paymentin-01417-20260804.js --commit
 */
...
const CONTRACT_ID = '6a2aabf3-7fa4-11f1-0a80-0283002585c9' // Agreement 37
const BANK_ACCOUNT_ID = 'e1852e1c-33c5-11ea-0a80-043f000b2739'
const REPORT_ID = '97fda558-8ccf-11f1-0a80-194000179a17'
const REPORT_NAME = '01417'
const EXPECTED_SUM_MINOR = 211200 // 2,112.00
const STATE_REPORT_PAID_ID = 'fd15289c-c3c4-11eb-0a80-065200268290'
const MARKER = `NEW-YOU-STAR-CONSIGNMENT-PAYMENT-${REPORT_NAME}-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  NEW YOU STAR — paymentin @ consignment report 01417 (2,112)')
  console.log('====================================================================')
  ...
  const paymentIn = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'NEW YOU STAR — consignment sales 2,112 AED — paid in full.',
    ].join(' | '),
    sum: openMinor,
    operations: [
      {
