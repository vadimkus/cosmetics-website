...
/**
 * Admin Shakirovna Salon — order → invoice → shipment + PDF (retail print template).
 *
 *   BB Cushion #2 Beige (00144) ×1 @ 150 AED
 *   Excellent Delivery Dubai ×1 @ 15 AED
 *
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-beige-cushion-order-invoice-demand-20260628.js
 *   node --import dotenv/config scripts/moysklad-create-admin-shakirovna-beige-cushion-order-invoice-demand-20260628.js --commit
 */
...
const ORDER = {
  name: `GENCardM${uaeShortDate()}SHKB`,
  moment: uaeMomentNow(),
  marker: `ADMIN-SHAKIROVNA-BEIGE-CUSHION-${uaeToday()}`,
}
...
async function main() {
  console.log('====================================================================')
  console.log('  Admin Shakirovna Salon — beige cushion + delivery')
  console.log('====================================================================')
  ...
  const order = await api('POST', '/entity/customerorder', {
    ...
    description: [
      ORDER.marker,
      'Beige cushion 00144 x1 @ 150 AED; delivery 15 AED.',
