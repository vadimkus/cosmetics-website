...
export default function NdCellProductPage({ product, unitsSold = 0, routineProducts = [] }: Props) {
  ...
  return (
    <div className={`cera-page ndc-page min-h-[100dvh]`} dir={dir}>
      {/* ───────────────────────────── Hero ─────────────────────────────── */}
      ...
      <section className="mx-auto max-w-[900px] px-4 pt-14 sm:px-6 lg:pt-20">
        <CeraReveal className="ndc-alert p-6 md:p-9">
          ...
          <p className="mt-5 text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.peanut.body}</p>
          <p className="mt-4 text-[16px] font-medium leading-relaxed text-[var(--cera-ink)]">
            {copy.peanut.detail}
          </p>
        </CeraReveal>
      </section>
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:mt-14 lg:grid-cols-3 lg:gap-6">
            {copy.working.items.map((item, i) => (
              <CeraReveal key={item.name} delay={i * 70} as="article" className="cera-card cera-card-hover flex flex-col p-6">
                ...
                <p dir="ltr" className="cera-serif cera-numeral ndc-figure mt-2 text-[27px] leading-none text-[var(--cera-rose)]">
                  {item.dose}
                </p>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="mx-auto max-w-[1040px] px-4 sm:px-6">
          ...
          <CeraReveal>
            <p className="mt-7 text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.occlusive.body}</p>
          </CeraReveal>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1040px] px-4 py-16 sm:px-6 lg:py-24">
            ...
            <tbody>
              {copy.peptides.rows.map(row => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-start align-top text-[14px] leading-snug text-[var(--cera-muted)]">
                    {row.note}
                  </td>
                </tr>
              ))}
        ...
        <CeraReveal>
          <p className="mt-7 text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.peptides.body}</p>
        </CeraReveal>
      </section>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="mx-auto max-w-[1040px] px-4 sm:px-6">
            ...
            {copy.vitamins.rows.map((row, i) => (
              <CeraReveal key={row.name} delay={i * 70} className="cera-card flex gap-4 p-6">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p dir="ltr" className="cera-serif cera-numeral ndc-figure mt-1.5 text-[24px] leading-none text-[var(--cera-rose)]">
                    {row.value}
                  </p>
          ...
          <CeraReveal>
            <p className="mt-7 text-[16px] leading-relaxed text-[var(--cera-body)]">{copy.vitamins.body}</p>
          </CeraReveal>
        </div>
      </section>
