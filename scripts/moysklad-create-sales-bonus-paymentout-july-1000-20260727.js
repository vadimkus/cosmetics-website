...
/**
 * Sales bonus payout to Vadim Sagatdinov — 1,000.00 AED (July 2026).
 *
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-1000-20260727.js
 *   node --import dotenv/config scripts/moysklad-create-sales-bonus-paymentout-july-1000-20260727.js --commit
 */
...
const MARKER = `SALES-BONUS-SAGATDINOV-JULY-1000-${uaeToday()}`
...
async function main() {
  console.log('====================================================================')
  console.log('  Sales bonus → Vadim Sagatdinov (July 2026) — 1,000 AED')
  console.log('====================================================================')
