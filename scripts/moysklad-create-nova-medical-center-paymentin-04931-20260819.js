...
/**
 * NOVA MEDICAL CENTER — paymentin @ shipment 06687 / invoice 04931.
 * FAB cheque 248360 / 2,700 AED. Order GENCardM260812NOVA → Доставлен.
 *
 *   node --import dotenv/config scripts/moysklad-create-nova-medical-center-paymentin-04931-20260819.js
 *   node --import dotenv/config scripts/moysklad-create-nova-medical-center-paymentin-04931-20260819.js --commit
 */
...
const MARKER = 'NOVA-PAYMENTIN-04931-CHEQUE-248360-2026-08-19'

const PAYMENT = {
  amountMinor: 270000,
  invoiceName: '04931',
  invoiceId: '76c37ff2-98a2-11f1-0a80-021400284f32',
  shipmentName: '06687',
  shipmentId: '771c82c0-9945-11f1-0a80-09f0002f5101',
  orderName: 'GENCardM260812NOVA',
  orderId: 'fac75f34-963f-11f1-0a80-09e90027dd2f',
}
...
async function main() {
  console.log('====================================================================')
  console.log('  NOVA MEDICAL CENTER — paymentin @ 04931 / 06687')
  console.log('====================================================================')
  ...
  if (!COMMIT) {
    ...
    console.log('  FAB cheque 248360 · 17/08/2026')
  ...
  const created = await api('POST', '/entity/paymentin', {
    ...
    description: [
      ...
      'FAB cheque 248360 dated 17/08/2026 — 2,700.00 AED A/C Payee, Al Ain New.',
    ].join(' | '),
    operations: [
      {
        meta: {
