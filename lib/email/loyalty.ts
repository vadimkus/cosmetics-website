  ...
  const inner = `
    ...
    <tr>
      <td style="font-family: ${FONT_TEXT}; font-size: 15px; line-height: 1.6; color: #1d1d1f; padding-bottom: 20px;">
        ...
        Earn 1 point for every 1 AED you spend. 100 points = AED 5 off a future order. Point redemption at checkout is coming in the next few weeks — your balance is already growing.
      </td>
    </tr>
    <tr>
